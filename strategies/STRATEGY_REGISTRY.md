...
- **✅ 15m + TRAIL-after-3R VALIDATED + OOS-ROBUST (2026-07-03):** deployed edge is the **15m** variant (not 1m) with a **trail-after-3R** exit — reproducible PF **4.46** / net **$23,489** / **672 trades** / **WR 52.2%** / **avgR +2.26** (full-sample 2022-2026, committed `backtest_orb_15m_trail_oos.py`). **Per-year 2022-2026: PF 4.37 / 3.81 / 4.63 / 4.76 / 5.14** (2026 partial; WR 50-56%, positive net EVERY year). **2022-2023 are genuine OOS** (variant built only on 2024-2026); **2022 Nasdaq bear holds (PF 4.37, +$5,223).** _SUPERSEDED: 6.04/69% from uncommitted orb_oos.py run, not reproducible; corrected to committed backtest_orb_15m_trail_oos.py, 2026-07-03._ The paper's *"ORB rides a 2024-only regime"* warning is **REFUTED** for the 15m-trail variant. OOS data: `data/nq_1m_2022_2023_front.parquet` (707,510 bars, continuous front-month, uncommitted alongside mes/rty parquets).
