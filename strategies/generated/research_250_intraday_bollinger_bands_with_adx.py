#!/usr/bin/env python3
"""
Intraday Bollinger Bands with ADX
=================================
Research ID: 250
Category: scalping
Confidence: 90%

Use intraday Bollinger Bands (20-period) for fast trend identification coupled with ADX (14-period) for strength confirmation.
...
class Research250IntradayBollingerBandsWithAdx(BaseStrategy):
    name = "research_250_intraday_bollinger_bands_with_adx"
    version = "0.1"
    ...
    def on_candle(self, candle: CandleData) -> Signal:
        ...
        # Entry condition
        if (candle.close > bb_mid) and adx_proxy > self.get_param('adx_threshold'):
            ...
            tag = "research_250_intraday_bollinger_bands_with_adx_bull" if direction == 1 else "research_250_intraday_bollinger_bands_with_adx_bear"
            return Signal(
                direction=direction,
