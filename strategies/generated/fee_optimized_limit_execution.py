#!/usr/bin/env python3
"""
Fee-Optimized Limit Execution
=============================
Auto-generated from: ngl gng quit trading manually after this one vid frfr
Category: scalping
Confidence: 80%

Using automated bots to enter and exit exclusively with limit orders rather than market orders to reduce fees by approximately 3x (66% reduction), effectively improving profitability by minimizing transaction costs on high-frequency trades.
...
class FeeOptimizedLimitExecution(BaseStrategy):
    name = "fee_optimized_limit_execution"
    version = "0.1"
    ...
    def on_candle(self, candle: CandleData) -> Signal:
        ...
        if cascade_active:
            ...
            return Signal(
                ...
                tag=f"fee_optimized_limit_execution_{'bull' if direction == 1 else 'bear'}",
            )
