#!/usr/bin/env python3
"""
Order Book Volume-Enhanced Exit
===============================
Auto-generated from: Trading Bots with Python - 7 Bots Full Course (Step By Step Tutorial)
Category: scalping
Confidence: 80%

An enhancement to trend-following strategies that uses real-time order book data to optimize exit timing. Instead of exiting immediately at profit target, it analyzes bid/ask volume ratio over 1-minute periods to determine if market momentum favors staying in the position longer.
...
class OrderBookVolumeEnhancedExit(BaseStrategy):
    name = "order_book_volume_enhanced_exit"
    version = "0.1"
    ...
    def on_candle(self, candle: CandleData) -> Signal:
        ...
        if cascade_active:
            ...
            return Signal(
                ...
                tag=f"order_book_volume_enhanced_exit_{'bull' if direction == 1 else 'bear'}",
            )
