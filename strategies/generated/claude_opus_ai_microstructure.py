#!/usr/bin/env python3
"""
Claude Opus AI Microstructure
=============================
Auto-generated from: Claude Opus Found a Polymarket Edge No One Is Talking About
Category: other
Confidence: 70%

An AI-powered strategy using Claude Opus 4.6 to analyze high-frequency data for 5-minute market predictions. Aggregates 30 minutes of tick data into 5-second OHLCV candles combined with liquidation data, funding rates, and open interest for directional bias.
...
class ClaudeOpusAiMicrostructure(BaseStrategy):
    name = "claude_opus_ai_microstructure"
    version = "0.1"
    ...
    def on_candle(self, candle: CandleData) -> Signal:
        ...
        if cascade_active:
            ...
            return Signal(
                ...
                tag=f"claude_opus_ai_microstructure_{'bull' if direction == 1 else 'bear'}",
            )
