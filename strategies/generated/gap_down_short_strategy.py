#!/usr/bin/env python3
"""
Gap Down Short Strategy
=======================
Auto-generated from: ai coded 72 trade bot tests and found some gems (58,109% ROI)
Category: momentum
Confidence: 70%

Inverse strategy that shorts gap downs during regular hours. Performed poorly in testing with negative expectancy (-0.91) due to bull market conditions.
    ...
    def on_candle(self, candle: CandleData) -> Signal:
        ...
        if cascade_active:
            ...
            return Signal(
                ...
                tag=f"gap_down_short_strategy_{'bull' if direction == 1 else 'bear'}",
            )
