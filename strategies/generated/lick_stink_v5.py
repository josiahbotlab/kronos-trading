#!/usr/bin/env python3
"""
Lick Stink V5 (Mean Reversion/Capitulation)
===========================================
Auto-generated from: Claude Opus Found a Polymarket Edge No One Is Talking About
Category: mean_reversion
Confidence: 85%

A mean reversion strategy that waits for high liquidation volumes (capitulation) before entering contrary to the liquidation direction. Specifically designed for 5-minute markets where the forced exit at expiration avoids the typical problem of price revisiting the liquidation low later.
...
class LickStinkV5(BaseStrategy):
    name = "lick_stink_v5"
    version = "0.1"
    ...
    def on_candle(self, candle: CandleData) -> Signal:
        ...
        if cascade_active and rsi_ready and (current_rsi > 70 or current_rsi < 30):
            ...
            return Signal(
                ...
                tag=f"lick_stink_v5_{'bull' if direction == 1 else 'bear'}",
            )
