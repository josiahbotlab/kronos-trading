...
Systematic approach to strategy deployment: Research ideas, backtest on historical data (BTC/ETH 10-year daily, 4-hour, 1-hour), then incubate with 'tiny size' forward testing before scaling.
...
class RbiFramework(BaseStrategy):
    name = "rbi_framework"
    version = "0.1"
    ...
    def on_candle(self, candle: CandleData) -> Signal:
        ...
        if ma_ready:
            ...
            return Signal(
                ...
                tag=f"rbi_framework_{'bull' if direction == 1 else 'bear'}",
            )
