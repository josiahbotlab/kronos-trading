#!/usr/bin/env python3
"""
RSI-Moving Average Confluence
=============================
Research ID: 245
Category: momentum
Confidence: 90%

Combine RSI with moving average crossovers to improve trend following. Requires both trend direction (MAs) and momentum (RSI) confirmation.
...
class Research245RsiMovingAverageConfluence(BaseStrategy):
    name = "research_245_rsi_moving_average_confluence"
    version = "0.1"
    ...
    def on_candle(self, candle: CandleData) -> Signal:
        ...
        if (40 < current_rsi < 70) and True:
            ...
            tag = "research_245_rsi_moving_average_confluence_bull" if direction == 1 else "research_245_rsi_moving_average_confluence_bear"
            return Signal(
                direction=direction,
