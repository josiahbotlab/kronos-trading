...
Use Donchian Channels with a 20-day lookback period to identify breakout points indicating strong uptrends or downtrends.
...
class Research244DonchianChannelBreakout(BaseStrategy):
    name = "research_244_donchian_channel_breakout"
    version = "0.1"
    ...
    def on_candle(self, candle: CandleData) -> Signal:
        ...
        if True:
            ...
            tag = "research_244_donchian_channel_breakout_bull" if direction == 1 else "research_244_donchian_channel_breakout_bear"
            return Signal(
                direction=direction,
