#!/usr/bin/env python3
"""
NBA First Half Stink Bid Bot
============================
Auto-generated from: Claude Code Built Me 4 Trading Bots in One Day — I'm Done Hand Trading
Category: mean_reversion
Confidence: 90%

Mean reversion strategy for NBA games on prediction markets. Places lowball bids 30% below market on the favorite during the first half (Q1 and Q2) to capture panic selling if the favorite falls behind early. Cancels all orders at halftime.
...
class NbaFirstHalfStinkBidBot(BaseStrategy):
    name = "nba_first_half_stink_bid_bot"
    version = "0.1"
    ...
    def on_candle(self, candle: CandleData) -> Signal:
        ...
        if rsi_ready and (current_rsi > 70 or current_rsi < 30):
            ...
            return Signal(
                ...
                tag=f"nba_first_half_stink_bid_bot_{'bull' if direction == 1 else 'bear'}",
            )
