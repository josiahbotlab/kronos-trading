#!/usr/bin/env python3
"""
Cross-Exchange Liquidation Arbitrage
====================================
Auto-generated from: Claude Chrome Built My WW3 Trading Bot
Category: scalping
Confidence: 80%

During geopolitical shocks, liquidation cascades occur sequentially across exchanges rather than simultaneously. Monitor liquidation feeds across Binance, Bybit, and OKX. When Binance liquidates first, position for the subsequent cascade on other exchanges within a 10-minute window.
...
class CrossExchangeLiquidationArbitrage(BaseStrategy):
    name = "cross_exchange_liquidation_arbitrage"
    version = "0.1"
    ...
    def on_candle(self, candle: CandleData) -> Signal:
        ...
        if cascade_active:
            ...
            return Signal(
                ...
                tag=f"cross_exchange_liquidation_arbitrage_{'bull' if direction == 1 else 'bear'}",
            )
