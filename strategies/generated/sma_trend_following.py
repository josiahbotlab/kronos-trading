#!/usr/bin/env python3
"""
SMA Trend Following (15-Minute)
===============================
Auto-generated from: Trading Bots with Python - 7 Bots Full Course (Step By Step Tutorial)
Category: momentum
Confidence: 90%

A trend-following strategy that trades Bitcoin based on the 20-period Simple Moving Average on the 15-minute chart. Goes long when price is above the SMA and short when below, placing staggered limit orders around the SMA level to enter positions.
    ...
    def on_candle(self, candle: CandleData) -> Signal:
        ...
        if ma_ready:
            ...
            return Signal(
                ...
                tag=f"sma_trend_following_{'bull' if direction == 1 else 'bear'}",
            )
