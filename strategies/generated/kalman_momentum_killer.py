...
Trend reversal strategy that detects when uptrend momentum is dying by calculating the slope/rate of change of the Kalman-filtered trend. Catches trend reversals early before they become obvious.
...
class KalmanMomentumKiller(BaseStrategy):
    name = "kalman_momentum_killer"
    version = "0.1"
    ...
    def on_candle(self, candle: CandleData) -> Signal:
        ...
        if cascade_active:
            ...
            return Signal(
                ...
                tag=f"kalman_momentum_killer_{'bull' if direction == 1 else 'bear'}",
            )
