#!/usr/bin/env python3
"""
SMA-Fibonacci Confluence Long
=============================
Auto-generated from: Asterdex AI Agents For Trading (WIN $50,000)
Category: momentum
Confidence: 90%

Enter long positions when price crosses above the 20-period Simple Moving Average (SMA) while simultaneously touching the 61.8% Fibonacci retracement level. This strategy combines trend following with key support level confirmation.
...
class SmaFibonacciConfluenceLong(BaseStrategy):
    name = "sma_fibonacci_confluence_long"
    version = "0.1"
    ...
    def on_candle(self, candle: CandleData) -> Signal:
        ...
        if ma_ready:
            ...
            return Signal(
                ...
                tag=f"sma_fibonacci_confluence_long_{'bull' if direction == 1 else 'bear'}",
            )
