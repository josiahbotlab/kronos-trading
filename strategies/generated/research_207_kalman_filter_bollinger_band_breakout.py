#!/usr/bin/env python3
"""
Kalman Filter Bollinger Band Breakout
=====================================
Research ID: 207
Category: breakout
Confidence: 90%

Uses Kalman filter for dynamic price smoothing as the center line instead of SMA, trading breakouts above the upper band (long) and breakdowns below the lower band (short). Tests standard deviations between 2.0 and 4.0 to find optimal volatility thresholds.
...
class Research207KalmanFilterBollingerBandBreakout(BaseStrategy):
    name = "research_207_kalman_filter_bollinger_band_breakout"
    version = "0.1"
    ...
    def on_candle(self, candle: CandleData) -> Signal:
        ...
        if True:
            ...
            tag = "research_207_kalman_filter_bollinger_band_breakout_bull" if direction == 1 else "research_207_kalman_filter_bollinger_band_breakout_bear"
            return Signal(
                direction=direction,
