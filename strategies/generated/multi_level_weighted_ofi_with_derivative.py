#!/usr/bin/env python3
"""
Multi-Level Weighted OFI with Derivatives
=========================================
Auto-generated from: Claude Code Made High Frequency Trading Possible For Retail
Category: momentum
Confidence: 95%

High-frequency strategy analyzing 15 levels of order book depth to calculate weighted Order Flow Imbalance (OFI) with velocity and acceleration derivatives. Uses Z-score regime detection to identify extreme statistical deviations and enters positions within a 5-minute window using pure maker orders only.
...
class MultiLevelWeightedOfiWithDerivative(BaseStrategy):
    name = "multi_level_weighted_ofi_with_derivative"
    version = "0.1"
    ...
    def on_candle(self, candle: CandleData) -> Signal:
        ...
        if cascade_active:
            ...
            return Signal(
                ...
                tag=f"multi_level_weighted_ofi_with_derivative_{'bull' if direction == 1 else 'bear'}",
            )
