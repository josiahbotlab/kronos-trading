#!/usr/bin/env python3
"""
Short-Term MA Crossover (Fast Trend)
====================================
Research ID: 249
Category: scalping
Confidence: 90%

Use shorter-term moving averages (10-day and 30-day) combined with ADX to quickly capture trends with tighter risk management.
...
class Research249ShortTermMaCrossover(BaseStrategy):
    name = "research_249_short_term_ma_crossover"
    version = "0.1"
    ...
    def on_candle(self, candle: CandleData) -> Signal:
        ...
        # Entry condition
        if True and adx_proxy > self.get_param('adx_threshold'):
            ...
            tag = "research_249_short_term_ma_crossover_bull" if direction == 1 else "research_249_short_term_ma_crossover_bear"
            return Signal(
                direction=direction,
