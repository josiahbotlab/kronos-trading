...
class HlpZscoreReversal(BaseStrategy):
    ...
    def default_params(self) -> dict:
        return {
            ...
            "zscore_lookback": 15,         # shortened further for more signals
            "zscore_long_threshold": 0.8,   # further loosened
            "zscore_short_threshold": -0.8, # further loosened
            "min_history": 20,

            # Liquidation quality filter
            "min_liq_usd": 1,            # very low — just needs nonzero direction
            "ratio_smoothing": 3,          # EMA(5) ≈ 4-6h window on 1h candles
