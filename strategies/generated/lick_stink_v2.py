#!/usr/bin/env python3
"""
Lick Stink V2 (Late Entry Filter)
=================================
Auto-generated from: Claude Opus Found a Polymarket Edge No One Is Talking About
Category: momentum
Confidence: 95%

A variation of the Lick Stink strategy that implements a timing filter to avoid entering positions in the final two minutes of the 5-minute market window. If pending orders exist in the last two minutes, they are cancelled to avoid rushed entries.
...
class LickStinkV2(BaseStrategy):
    name = "lick_stink_v2"
    version = "0.1"
    ...
    def on_candle(self, candle: CandleData) -> Signal:
        ...
        if cascade_active:
            ...
            return Signal(
                ...
                tag=f"lick_stink_v2_{'bull' if direction == 1 else 'bear'}",
            )
