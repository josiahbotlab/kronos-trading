#!/usr/bin/env python3
"""
Solana New Launch Sniper
========================
Auto-generated from: How to Make a Solana Meme Coin Bot (in Python)
Category: momentum
Confidence: 85%

Automated strategy that scans the Solana blockchain for newly launched meme coins under $20k market cap. Filters tokens by detecting null/empty 24-hour price change data to identify tokens launched within the last 24 hours. Further validates candidates through trade activity analysis and liquidity checks before entering with minimal position sizes due to high rug-pull probability.
...
class SolanaNewLaunchSniper(BaseStrategy):
    name = "solana_new_launch_sniper"
    version = "0.1"
    ...
    def default_params(self) -> dict:
        return {
            ...
            "entry_strength": 0.8,
            "liq_percentile": 85,
            "market_cap_initial_target": 50000,
    ...
    def on_candle(self, candle: CandleData) -> Signal:
        ...
        if cascade_active:
            ...
            return Signal(
                ...
                tag=f"solana_new_launch_sniper_{'bull' if direction == 1 else 'bear'}",
            )
