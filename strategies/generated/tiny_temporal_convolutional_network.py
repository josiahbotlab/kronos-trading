...
Deep learning model using 3 causal dilated convolutional layers to identify temporal patterns in OFI data for 10-second forward return prediction. Captures OFI bursts, fades, and reversals through temporal sequences rather than point-in-time data. Optimized for sub-millisecond inference speed suitable for live HFT deployment.
...
class TinyTemporalConvolutionalNetwork(BaseStrategy):
    name = "tiny_temporal_convolutional_network"
    version = "0.1"
    ...
    def on_candle(self, candle: CandleData) -> Signal:
        ...
        if cascade_active:
            ...
            return Signal(
                ...
                tag=f"tiny_temporal_convolutional_network_{'bull' if direction == 1 else 'bear'}",
            )
