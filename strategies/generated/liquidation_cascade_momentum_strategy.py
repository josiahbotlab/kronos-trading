#!/usr/bin/env python3
"""
Liquidation Cascade Momentum Strategy
=====================================
Auto-generated from: GPT 5.4 Trading Bot That Removes Emotion Completely
Category: momentum
Confidence: 80%

A momentum strategy for Hyperliquid HIP 3 markets that combines hourly trend direction with liquidation data. When an asset trends on the hourly timeframe, the bot scans for a concentration of opposing positions within 2.5% of their liquidation price, entering trades to capture the momentum from forced liquidations when price moves toward those levels.
...
class LiquidationCascadeMomentumStrategy(BaseStrategy):
    name = "liquidation_cascade_momentum_strategy"
    version = "0.1"
    ...
    def on_candle(self, candle: CandleData) -> Signal:
        ...
        if cascade_active:
            ...
            return Signal(
                ...
                tag=f"liquidation_cascade_momentum_strategy_{'bull' if direction == 1 else 'bear'}",
            )
