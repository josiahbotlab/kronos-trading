#!/usr/bin/env python3
"""
No-Liquidation OFI Bot
======================
Auto-generated from: how to actually use machine learning in trading bots
Category: scalping
Confidence: 75%

Risk-managed variant of the TCN strategy designed to prevent liquidations ('no licks'). Implements stop-loss mechanisms and position sizing rules to avoid account liquidation while executing the 10-second OFI predictions.
...
class NoLiquidationOfiBot(BaseStrategy):
    name = "no_liquidation_ofi_bot"
    version = "0.1"
    ...
    def on_candle(self, candle: CandleData) -> Signal:
        ...
        if cascade_active:
            ...
            return Signal(
                ...
                tag=f"no_liquidation_ofi_bot_{'bull' if direction == 1 else 'bear'}",
            )
