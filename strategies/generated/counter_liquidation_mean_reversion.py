#!/usr/bin/env python3
"""
Counter-Liquidation Mean Reversion
==================================
Auto-generated from: Quant App Explained: Risk & Liquidation Trading App
Category: mean_reversion
Confidence: 85%

Enter long positions when large-scale long liquidations occur (buying into forced selling) and enter short positions when large short liquidations occur (selling into forced buying). Instead of predicting price direction, the trader takes the opposite side of traders being liquidated at 40x leverage, viewing liquidations as potential reversal points.
...
class CounterLiquidationMeanReversion(BaseStrategy):
    name = "counter_liquidation_mean_reversion"
    version = "0.1"
    ...
    def on_candle(self, candle: CandleData) -> Signal:
        ...
        if cascade_active:
            ...
            return Signal(
                ...
                tag=f"counter_liquidation_mean_reversion_{'bull' if direction == 1 else 'bear'}",
            )
