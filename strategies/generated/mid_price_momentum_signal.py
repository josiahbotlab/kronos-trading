#!/usr/bin/env python3
"""
Mid-Price Momentum Signal
=========================
Auto-generated from: Copying The $8 Billion Fund's Trading Bot (Hudson River Trading)
Category: momentum
Confidence: 75%

A predictive signal derived from historical mid-price returns calculated over event-based lookback periods. The strategy computes returns as (current_mid - previous_mid) / previous_mid to capture momentum, using the previous 100+ events as a feature to predict future price direction.
...
class MidPriceMomentumSignal(BaseStrategy):
    name = "mid_price_momentum_signal"
    version = "0.1"
    ...
    def on_candle(self, candle: CandleData) -> Signal:
        ...
        if cascade_active:
            ...
            return Signal(
                ...
                tag=f"mid_price_momentum_signal_{'bull' if direction == 1 else 'bear'}",
            )
