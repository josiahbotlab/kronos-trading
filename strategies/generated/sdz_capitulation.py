#!/usr/bin/env python3
"""
SDZ Capitulation (Volume Spike Demand Zone)
===========================================
Auto-generated from: Official Process To Automate your Trading (A-Z from ZERO)
Category: mean_reversion
Confidence: 85%

A long-only mean reversion strategy that enters long positions when abnormal volume spikes (indicating liquidation/capitulation) occur within or below a 6-hour demand zone. The thesis is that volume spikes represent irrational price action where market selling creates buying opportunities in established support areas.
...
class SdzCapitulation(BaseStrategy):
    name = "sdz_capitulation"
    version = "0.1"
    ...
    def on_candle(self, candle: CandleData) -> Signal:
        ...
        # Entry condition
        if cascade_active and rsi_ready and (current_rsi > 70 or current_rsi < 30) and ma_ready:
            ...
            return Signal(
                ...
                tag=f"sdz_capitulation_{'bull' if direction == 1 else 'bear'}",
            )
