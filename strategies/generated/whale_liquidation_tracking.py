...
Monitor large positions (whales) for impending liquidations and position accordingly. Trade against or with large liquidation points.
...
class WhaleLiquidationTracking(BaseStrategy):
    name = "whale_liquidation_tracking"
    version = "0.1"
    ...
    def on_candle(self, candle: CandleData) -> Signal:
        ...
        if cascade_active:
            ...
            return Signal(
                ...
                tag=f"whale_liquidation_tracking_{'bull' if direction == 1 else 'bear'}",
            )
