...
Combines the Dynamic Swing indicator with MFI (Money Flow Index) to identify high-probability entry points. This variation showed particularly strong risk-adjusted returns with high Sharpe ratios across the 25-dataset backtest.
...
class DynamicSwingMfi(BaseStrategy):
    name = "dynamic_swing_mfi"
    version = "0.1"
    ...
    def on_candle(self, candle: CandleData) -> Signal:
        ...
        if cascade_active:
            ...
            return Signal(
                ...
                tag=f"dynamic_swing_mfi_{'bull' if direction == 1 else 'bear'}",
            )
