#!/usr/bin/env python3
"""
ATR Distance Scaling
====================
Auto-generated from: Claude Code For Aster Trading Bots
Category: mean_reversion
Confidence: 80%

Volatility-adjusted DCA entry system that uses Average True Range (ATR) instead of fixed percentages to determine bid placement levels, allowing for wider entries during high volatility and tighter entries during low volatility regimes.
...
class AtrDistanceScaling(BaseStrategy):
    name = "atr_distance_scaling"
    version = "0.1"
    ...
    def on_candle(self, candle: CandleData) -> Signal:
        ...
        if cascade_active:
            ...
            return Signal(
                ...
                tag=f"atr_distance_scaling_{'bull' if direction == 1 else 'bear'}",
            )
