#!/usr/bin/env python3
"""
End-of-Period Close Bot
=======================
Auto-generated from: I Ran 3 Claude Bots on Polymarket | Here's What They Are
Category: scalping
Confidence: 75%

Provides liquidity by purchasing positions at high conviction prices (88c-99c range) near the close of 5-minute markets, effectively buying nearly-certain binary outcomes for small but reliable returns.
...
class EndOfPeriodCloseBot(BaseStrategy):
    name = "end_of_period_close_bot"
    version = "0.1"
    ...
    def on_candle(self, candle: CandleData) -> Signal:
        ...
        if ma_ready:
            ...
            return Signal(
                ...
                tag=f"end_of_period_close_bot_{'bull' if direction == 1 else 'bear'}",
            )
