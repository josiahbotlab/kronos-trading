#!/usr/bin/env python3
"""
Liquidation-Based Mean Reversion
================================
Research ID: 106
Category: mean_reversion
Confidence: 60%

Monitor large whale positions (e.g., $19M-$20M) approaching liquidation levels on Hyperliquid. When a large position is forcibly liquidated (liquidation cascade), enter a counter-trend trade to 'buy the liquidation' or 'sell the squeeze,' expecting price to revert after forced exit pressure subsides.
...
class Research106LiquidationBasedMeanReversion(BaseStrategy):
    name = "research_106_liquidation_based_mean_reversion"
    version = "0.1"
    ...
    def on_candle(self, candle: CandleData) -> Signal:
        ...
        if cascade_active:
            ...
            tag = "research_106_liquidation_based_mean_reversion_bull" if direction == 1 else "research_106_liquidation_based_mean_reversion_bear"
            return Signal(
                direction=direction,
