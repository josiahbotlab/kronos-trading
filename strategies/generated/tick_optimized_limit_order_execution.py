#!/usr/bin/env python3
"""
Tick-Optimized Limit Order Execution
====================================
Auto-generated from: Everyone wants to Trade with 40x Leverage So i Automated it
Category: scalping
Confidence: 90%

Use limit orders on specific order book ticks to minimize fees and improve entry prices. Avoid market orders which cost 3x more in fees.
...
class TickOptimizedLimitOrderExecution(BaseStrategy):
    name = "tick_optimized_limit_order_execution"
    version = "0.1"
    ...
    def on_candle(self, candle: CandleData) -> Signal:
        ...
        if cascade_active:
            ...
            return Signal(
                ...
                tag=f"tick_optimized_limit_order_execution_{'bull' if direction == 1 else 'bear'}",
            )
