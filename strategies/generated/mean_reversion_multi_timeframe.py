#!/usr/bin/env python3
"""
Mean Reversion Multi-Timeframe
==============================
Auto-generated from: From ZERO to ALGO TRADER in 2024 - Step By Step (FULL COURSE)
Category: mean_reversion
Confidence: 90%

A mean reversion strategy that trades price deviations from the 20-period SMA on the 15-minute chart, filtered by the trend direction on the 4-hour chart. Only takes long positions when 4-hour trend is bullish (price above 4h SMA) and short positions when bearish (price below 4h SMA). Uses random symbol selection from a portfolio of 75+ altcoins.
...
class MeanReversionMultiTimeframe(BaseStrategy):
    ...
    def on_candle(self, candle: CandleData) -> Signal:
        ...
        if rsi_ready and (current_rsi > 70 or current_rsi < 30) and ma_ready:
            ...
            return Signal(
                ...
                tag=f"mean_reversion_multi_timeframe_{'bull' if direction == 1 else 'bear'}",
            )
