#!/usr/bin/env python3
"""
Liquidation Hunter (Quant App)
==============================
Auto-generated from: I Built 3 Trading Bots That Run 24/7 (Here's What They Made While I Slept)
Category: other
Confidence: 80%

Strategy that does not predict price direction but instead predicts and trades around liquidation levels. Monitors liquidation cascades across Hyperliquid, Binance, and OKX to enter positions when traders are forcibly liquidated, essentially taking over their positions.
    ...
    def on_candle(self, candle: CandleData) -> Signal:
        ...
        if cascade_active:
            ...
            return Signal(
                ...
                tag=f"liquidation_hunter_{'bull' if direction == 1 else 'bear'}",
            )
