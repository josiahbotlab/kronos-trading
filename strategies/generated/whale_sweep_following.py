#!/usr/bin/env python3
"""
Whale Sweep Following
=====================
Auto-generated from: Polymarket Trading Agents (Humans Cant Trade Better)
Category: momentum
Confidence: 80%

Track large trades ('sweeps') of $3,000 or more on Polymarket, specifically looking for multiple concurrent sweeps on the same market. The strategy follows 'smart money' positioning by monitoring when multiple large traders are buying the same outcome simultaneously.
...
class WhaleSweepFollowing(BaseStrategy):
    name = "whale_sweep_following"
    version = "0.1"
    ...
    def on_candle(self, candle: CandleData) -> Signal:
        ...
        if ma_ready:
            ...
            return Signal(
                ...
                tag=f"whale_sweep_following_{'bull' if direction == 1 else 'bear'}",
            )
