...
Trading based on RSI extreme values (overbought/oversold conditions). Offers lower exposure time compared to other strategies while maintaining profitability.
    ...
    def on_candle(self, candle: CandleData) -> Signal:
        ...
        if rsi_ready and (current_rsi > 70 or current_rsi < 30):
            ...
            return Signal(
                ...
                tag=f"rsi_extremes_{'bull' if direction == 1 else 'bear'}",
            )
