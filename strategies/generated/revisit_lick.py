#!/usr/bin/env python3
"""
Revisit Lick (Liquidation Retest)
=================================
Auto-generated from: I Found a Strategy That Makes Buy & Hold Look Like a Joke (14x Better)
Category: mean_reversion
Confidence: 85%

A mean-reversion strategy that waits for a major liquidation event, records the lowest price (pico bottom) of that liquidation candle, and places a limit order below that level expecting a retest within 24-48 hours rather than buying the initial dip.
...
class RevisitLick(BaseStrategy):
    name = "revisit_lick"
    version = "0.1"
    ...
    def on_candle(self, candle: CandleData) -> Signal:
        ...
        if cascade_active and rsi_ready and (current_rsi > 70 or current_rsi < 30):
            ...
            return Signal(
                ...
                tag=f"revisit_lick_{'bull' if direction == 1 else 'bear'}",
            )
