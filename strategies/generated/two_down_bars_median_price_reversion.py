#!/usr/bin/env python3
"""
Two Down Bars + Median Price Reversion
======================================
Auto-generated from: ai agents that actually trade live (+$1,156 pnl)
Category: mean_reversion
Confidence: 90%

A long-only mean reversion strategy that waits for two consecutive bearish 5-minute candles (down bars) while price is trading below the median price of the last few hours. The AI swarm acts as a filter on top of these technical conditions to approve or reject the entry.
...
class TwoDownBarsMedianPriceReversion(BaseStrategy):
    name = "two_down_bars_median_price_reversion"
    version = "0.1"
    ...
    def on_candle(self, candle: CandleData) -> Signal:
        ...
        if rsi_ready and (current_rsi > 70 or current_rsi < 30):
            ...
            return Signal(
                ...
                tag=f"two_down_bars_median_price_reversion_{'bull' if direction == 1 else 'bear'}",
            )
