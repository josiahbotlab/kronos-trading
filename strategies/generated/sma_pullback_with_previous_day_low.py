#!/usr/bin/env python3
"""
SMA Pullback with Previous Day Low
==================================
Auto-generated from: How to Backtest ANY Trading Strategy with Backtesting.py (TRADERS CHEAT CODE)
Category: momentum
Confidence: 90%

A daily trend-following strategy that enters long when price closes above the 20-period SMA. Uses the previous day's low as the stop loss level and targets a 1.5x risk-reward ratio for take profit.
...
class SmaPullbackWithPreviousDayLow(BaseStrategy):
    name = "sma_pullback_with_previous_day_low"
    version = "0.1"
    ...
    def on_candle(self, candle: CandleData) -> Signal:
        ...
        if ma_ready:
            ...
            return Signal(
                ...
                tag=f"sma_pullback_with_previous_day_low_{'bull' if direction == 1 else 'bear'}",
            )
