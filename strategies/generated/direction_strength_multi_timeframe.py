#!/usr/bin/env python3
"""
Direction Strength Multi-Timeframe
==================================
Auto-generated from: $20 Billion Liquidated So I Built Some HFT Trading Bots
Category: momentum
Confidence: 75%

Momentum-based HFT strategy using directional strength indicators across multiple timeframes (5, 7, 15 minutes) with velocity acceleration z-score gating. Uses websocket data for real-time bid/ask monitoring and implements continuous position checking for P&L management.
...
class DirectionStrengthMultiTimeframe(BaseStrategy):
    name = "direction_strength_multi_timeframe"
    version = "0.1"
    ...
    def on_candle(self, candle: CandleData) -> Signal:
        ...
        if cascade_active:
            ...
            return Signal(
                ...
                tag=f"direction_strength_multi_timeframe_{'bull' if direction == 1 else 'bear'}",
            )
