#!/usr/bin/env python3
"""
OFI Advanced No-Licks (Liquidation Filter)
==========================================
Auto-generated from: $20 Billion Liquidated So I Built Some HFT Trading Bots
Category: scalping
Confidence: 80%

Order flow strategy that only activates when market liquidations are below 250,000 threshold to avoid high volatility regimes. Uses multi-level OFI with harmonic or exponential weights by tick distance, normalizing by total depth and recent tick volume.
...
class OfiAdvancedNoLicks(BaseStrategy):
    name = "ofi_advanced_no_licks"
    version = "0.1"
    ...
    def on_candle(self, candle: CandleData) -> Signal:
        ...
        if cascade_active:
            ...
            return Signal(
                ...
                tag=f"ofi_advanced_no_licks_{'bull' if direction == 1 else 'bear'}",
            )
