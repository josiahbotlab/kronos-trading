#!/usr/bin/env python3
"""
MACD 3-15-3 5-Minute Momentum
=============================
Auto-generated from: Claude + Polymarket = Free Money? (Full Bot Tutorial)
Category: momentum
Confidence: 70%

Uses MACD indicator with specific parameters (3, 15, 3) on 5-minute Polymarket markets. Backtest showed approximately 60% win rate with positive edge. Designed to capture momentum moves in high-leverage binary options markets.
...
class Macd31535MinuteMomentum(BaseStrategy):
    name = "macd_3_15_3_5_minute_momentum"
    version = "0.1"
    ...
    def on_candle(self, candle: CandleData) -> Signal:
        ...
        if cascade_active:
            ...
            return Signal(
                ...
                tag=f"macd_3_15_3_5_minute_momentum_{'bull' if direction == 1 else 'bear'}",
            )
