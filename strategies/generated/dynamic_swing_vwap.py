...
Dynamic Swing VWAP
==================
Auto-generated from: i cracked tradingview only using claude code agents
Category: momentum
Confidence: 70%

Combines the Dynamic Swing indicator with VWAP (Volume Weighted Average Price) to generate trading signals. The strategy is backtested across multiple datasets with emphasis on trend identification using Dynamic Swing combined with volume-weighted price levels.
...
class DynamicSwingVwap(BaseStrategy):
    name = "dynamic_swing_vwap"
    version = "0.1"
    ...
    def on_candle(self, candle: CandleData) -> Signal:
        ...
        if cascade_active:
            ...
            return Signal(
                ...
                tag=f"dynamic_swing_vwap_{'bull' if direction == 1 else 'bear'}",
            )
