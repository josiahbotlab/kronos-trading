#!/usr/bin/env python3
"""
20/40 SMA Crossover with 5-Day Hold
===================================
Research ID: 135
Category: momentum
Confidence: 85%

A trend-following strategy that buys Bitcoin when the price crosses above the 20-period Simple Moving Average (SMA), holds the position for a minimum of 5 days, and sells when the price drops below the 40-period SMA. The strategy uses daily timeframe data and executes market orders.
...
class Research1352040SmaCrossoverWith5DayHold(BaseStrategy):
    name = "research_135_20_40_sma_crossover_with_5_day_hold"
    version = "0.1"
    ...
    def on_candle(self, candle: CandleData) -> Signal:
        ...
        if True:
            ...
            tag = "research_135_20_40_sma_crossover_with_5_day_hold_bull" if direction == 1 else "research_135_20_40_sma_crossover_with_5_day_hold_bear"
            return Signal(
                direction=direction,
