#!/usr/bin/env python3
"""
Zero-Fee Limit Order Execution (Tick Strategy)
==============================================
Auto-generated from: Quant App Full Step By Step Training
Category: scalping
Confidence: 90%

Eliminates market order fees by using limit orders placed at specific 'ticks' in the order book. Using the 15th tick for entry and exit effectively offsets trading fees (saving ~66% per trade compared to market orders), extending account survival from ~31 days to ~717 days under high-frequency trading assumptions.
...
class ZeroFeeLimitOrderExecution(BaseStrategy):
    name = "zero_fee_limit_order_execution"
    version = "0.1"
    ...
    def on_candle(self, candle: CandleData) -> Signal:
        ...
        if cascade_active:
            ...
            return Signal(
                ...
                tag=f"zero_fee_limit_order_execution_{'bull' if direction == 1 else 'bear'}",
            )
