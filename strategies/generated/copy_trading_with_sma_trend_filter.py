#!/usr/bin/env python3
"""
Copy Trading with SMA Trend Filter
==================================
Auto-generated from: Solana Onchain Trading Bot Course (Step by Step in 2025)
Category: momentum
Confidence: 90%

The bot monitors a curated list of 'top trader' wallets for recent buy transactions (last 15-60 minutes), aggregates these into a 'pool' of potential tokens, then filters them to only enter positions where the token price is trading above the 4-hour 20-period Simple Moving Average (SMA). This avoids blindly copying 'trash traders' by requiring a technical confirmation of trend.
...
class CopyTradingWithSmaTrendFilter(BaseStrategy):
    name = "copy_trading_with_sma_trend_filter"
    version = "0.1"
    ...
    def on_candle(self, candle: CandleData) -> Signal:
        ...
        if ma_ready:
            ...
            return Signal(
                ...
                tag=f"copy_trading_with_sma_trend_filter_{'bull' if direction == 1 else 'bear'}",
            )
