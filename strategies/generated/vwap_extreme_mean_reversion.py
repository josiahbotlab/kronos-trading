#!/usr/bin/env python3
"""
VWAP Extreme Mean Reversion
===========================
Auto-generated from: Clawbot Trading Bot That Did 7,547%… What's the Catch?
Category: mean_reversion
Confidence: 85%

A mean reversion strategy centered on VWAP (Volume Weighted Average Price) combined with double stochastic indicators and volume/accumulation pattern confirmation. The system identifies oversold bounces around the VWAP level.
...
class VwapExtremeMeanReversion(BaseStrategy):
    name = "vwap_extreme_mean_reversion"
    version = "0.1"
    ...
    def on_candle(self, candle: CandleData) -> Signal:
        ...
        if rsi_ready and (current_rsi > 70 or current_rsi < 30):
            ...
            return Signal(
                ...
                tag=f"vwap_extreme_mean_reversion_{'bull' if direction == 1 else 'bear'}",
            )
