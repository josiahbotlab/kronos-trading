...
=======================
Auto-generated from: TradingView Glitch That Made My Bots Print Money (Nobody Talks About This)
Category: reversal
Confidence: 70%

Detects island reversal formations characterized by price gaps in one direction followed by a consolidation period, then a gap back in the opposite direction. Identifies bullish island reversals (gap up, consolidation, gap down) and bearish island reversals (gap down, consolidation) to signal potential trend reversals.
...
class IslandReversalPattern(BaseStrategy):
    name = "island_reversal_pattern"
    version = "0.1"
    ...
    def on_candle(self, candle: CandleData) -> Signal:
        ...
        if cascade_active:
            ...
            return Signal(
                ...
                tag=f"island_reversal_pattern_{'bull' if direction == 1 else 'bear'}",
            )
