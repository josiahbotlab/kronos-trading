#!/usr/bin/env python3
"""
Multi-Timeframe Mean Reversion (SMA)
====================================
Auto-generated from: The $700,000,000 Automated Trading Bot
Category: mean_reversion
Confidence: 90%

A mean reversion strategy using multiple timeframes to identify trends and entry points. Uses higher timeframe SMA to determine trend direction and lower timeframe SMA as the mean to revert to, with confirmation candles for entry timing.
...
class MultiTimeframeMeanReversion(BaseStrategy):
    name = "multi_timeframe_mean_reversion"
    version = "0.1"
    ...
    def on_candle(self, candle: CandleData) -> Signal:
        ...
        if rsi_ready and (current_rsi > 70 or current_rsi < 30) and ma_ready:
            ...
            return Signal(
                ...
                tag=f"multi_timeframe_mean_reversion_{'bull' if direction == 1 else 'bear'}",
            )
