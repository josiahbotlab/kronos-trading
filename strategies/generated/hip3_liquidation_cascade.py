#!/usr/bin/env python3
"""
HIP3 Liquidation Cascade (Commodity Squeeze)
============================================
Auto-generated from: Claude Chrome Built My WW3 Trading Bot
Category: momentum
Confidence: 90%

Monitor Hyperliquid HIP3 liquidation data for oil (CL), gold, and natural gas to identify when price approaches liquidation clusters. Enter long positions when price nears short liquidation zones to capitalize on cascade effects as shorts are forced to cover. Currently 72% of HIP3 traders are short oil and 63% short nat gas with zero liquidations in 24 hours, suggesting a coiled spring setup.
...
class Hip3LiquidationCascade(BaseStrategy):
    name = "hip3_liquidation_cascade"
    version = "0.1"
    ...
    def on_candle(self, candle: CandleData) -> Signal:
        ...
        if cascade_active:
            ...
            return Signal(
                ...
                tag=f"hip3_liquidation_cascade_{'bull' if direction == 1 else 'bear'}",
            )
