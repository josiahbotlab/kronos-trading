#!/usr/bin/env python3
"""
1-Minute Supply and Demand Zones
================================
Auto-generated from: Aster Trading Bot With a 83% Win Rate
Category: mean_reversion
Confidence: 90%

Mean reversion strategy that buys at 1-minute demand zones and sells at 1-minute supply zones. Uses lookback periods to identify zones with optimized buffer thresholds.
...
class 1MinuteSupplyAndDemandZones(BaseStrategy):
    name = "1_minute_supply_and_demand_zones"
    version = "0.1"
    ...
    def on_candle(self, candle: CandleData) -> Signal:
        ...
        if rsi_ready and (current_rsi > 70 or current_rsi < 30) and ma_ready:
            ...
            return Signal(
                ...
                tag=f"1_minute_supply_and_demand_zones_{'bull' if direction == 1 else 'bear'}",
            )
