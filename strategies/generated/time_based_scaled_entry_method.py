#!/usr/bin/env python3
"""
Time-Based Scaled Entry Method
==============================
Auto-generated from: I Found 5 Strategies Nobody's Talking About (514%)
Category: other
Confidence: 75%

A position sizing execution method applied to liquidation triggers where instead of entering fully at the signal, the strategy scales into the position evenly across multiple hourly intervals (1h, 2h, 3h, 4h) after the initial trigger to average the entry price.
...
class TimeBasedScaledEntryMethod(BaseStrategy):
    name = "time_based_scaled_entry_method"
    version = "0.1"
    ...
    def on_candle(self, candle: CandleData) -> Signal:
        ...
        if cascade_active:
            ...
            return Signal(
                ...
                tag=f"time_based_scaled_entry_method_{'bull' if direction == 1 else 'bear'}",
            )
