...
Momentum strategy combining ADX (Average Directional Index) rising trend strength with MACD signals. Part of the top-performing strategy cluster alongside EMA crosses.
...
class AdxRisingMacd(BaseStrategy):
    name = "adx_rising_macd"
    version = "0.1"
    ...
    def on_candle(self, candle: CandleData) -> Signal:
        ...
        if ma_ready:
            ...
            return Signal(
                ...
                tag=f"adx_rising_macd_{'bull' if direction == 1 else 'bear'}",
            )
