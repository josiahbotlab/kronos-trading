#!/usr/bin/env python3
"""
Extended Micro Price OFI Scalper
================================
Auto-generated from: $20 Billion Liquidated So I Built Some HFT Trading Bots
Category: scalping
Confidence: 85%

High-frequency scalping strategy using micro price (depth-weighted mid) combined with Order Flow Imbalance (OFI) calculations to predict short-term price direction. Strategy employs a minimum hold time after entry to prevent immediate flip-flopping and uses liquidation volume as a safety kill switch.
...
class ExtendedMicroPriceOfiScalper(BaseStrategy):
    name = "extended_micro_price_ofi_scalper"
    version = "0.1"
    ...
    def default_params(self) -> dict:
        return {
            ...
            "liquidation_threshold_shutdown": 250000,
            "lookback_bars": 300,
            "max_history": 300,
            "max_hold_bars": 20,
            "minimum_hold_time_seconds": 120,
            "take_profit_pct": 5.0,
    ...
    def on_candle(self, candle: CandleData) -> Signal:
        ...
        if cascade_active:
            ...
            return Signal(
                ...
                tag=f"extended_micro_price_ofi_scalper_{'bull' if direction == 1 else 'bear'}",
            )
...
PARAM_RANGES = {
    "liquidation_threshold_shutdown": [
        125000,
        250000,
        500000
    ],
