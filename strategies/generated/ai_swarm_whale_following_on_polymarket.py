#!/usr/bin/env python3
"""
AI Swarm Whale Following on Polymarket
======================================
Auto-generated from: Claude Opus 4.5 For Polymarket Is a Cheat Code
Category: other
Confidence: 75%

A prediction market strategy that tracks real-time 'smart money' activity by monitoring trades over $500 via WebSocket, then uses a swarm of 7 AI models (including Claude Opus 4.5) to reach consensus on binary outcomes. The system filters out crypto, sports, and near-resolved markets (probability close to 0 or 1), then selects the top 5 markets with strongest AI agreement for directional bets.
...
class AiSwarmWhaleFollowingOnPolymarket(BaseStrategy):
    name = "ai_swarm_whale_following_on_polymarket"
    version = "0.1"
    ...
    def on_candle(self, candle: CandleData) -> Signal:
        ...
        if ma_ready:
            ...
            return Signal(
                ...
                tag=f"ai_swarm_whale_following_on_polymarket_{'bull' if direction == 1 else 'bear'}",
            )
