#!/usr/bin/env python3
"""
Cricket IPL/PSL Stink Bid Bot
=============================
Auto-generated from: Claude Code Built Me 4 Trading Bots in One Day — I'm Done Hand Trading
Category: mean_reversion
Confidence: 90%

Mean reversion strategy targeting panic selling in T20 cricket matches (Indian Premier League and Pakistan Super League). Places stink bids at 30% discount on the favorite during the first innings only, when uncertainty is highest. Cancels all orders once the second innings (chase) begins.
...
class CricketIplPslStinkBidBot(BaseStrategy):
    name = "cricket_ipl_psl_stink_bid_bot"
    version = "0.1"
    ...
    def on_candle(self, candle: CandleData) -> Signal:
        ...
        if rsi_ready and (current_rsi > 70 or current_rsi < 30):
            ...
            return Signal(
                ...
                tag=f"cricket_ipl_psl_stink_bid_bot_{'bull' if direction == 1 else 'bear'}",
            )
