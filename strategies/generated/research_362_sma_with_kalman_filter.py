#!/usr/bin/env python3
"""
SMA with Kalman Filter
======================
Research ID: 362
Category: momentum
Confidence: 70%

Uses a Kalman Filter applied to SMA data to reduce noise and create smoother signals for entry and exit decisions.
...
class Research362SmaWithKalmanFilter(BaseStrategy):
    name = "research_362_sma_with_kalman_filter"
    version = "0.1"
    ...
    def on_candle(self, candle: CandleData) -> Signal:
        ...
        if True:
            ...
            tag = "research_362_sma_with_kalman_filter_bull" if direction == 1 else "research_362_sma_with_kalman_filter_bear"
            return Signal(
                direction=direction,
