#!/usr/bin/env python3
"""
Mean Reversion Algorithm with Fixed Risk Parameters
===================================================
Auto-generated from: ChatGPT Tutorial: Can AI Really Replace Human Traders?
Category: mean_reversion
Confidence: 85%

A mean reversion strategy that enters positions when Bitcoin price deviates 2% from the average price, using 5x leverage with fixed exit thresholds at 5% profit or 3% loss.
...
class MeanReversionAlgorithmWithFixedRisk(BaseStrategy):
    name = "mean_reversion_algorithm_with_fixed_risk"
    version = "0.1"
    ...
    def on_candle(self, candle: CandleData) -> Signal:
        ...
        if rsi_ready and (current_rsi > 70 or current_rsi < 30):
            ...
            return Signal(
                ...
                tag=f"mean_reversion_algorithm_with_fixed_risk_{'bull' if direction == 1 else 'bear'}",
            )
