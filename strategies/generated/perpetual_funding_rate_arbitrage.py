...
================================
Auto-generated from: How I Know When the Market Is About to Flip
Category: mean_reversion
Confidence: 70%

Exploits extreme funding rate discrepancies by taking a long position on perpetual contracts with highly negative funding rates (receiving funding payments) while hedging with an opposing short position on another exchange or spot market to capture the premium risk-free.
...
class PerpetualFundingRateArbitrage(BaseStrategy):
    name = "perpetual_funding_rate_arbitrage"
    version = "0.1"
    ...
    def on_candle(self, candle: CandleData) -> Signal:
        ...
        if cascade_active:
            ...
            return Signal(
                ...
                tag=f"perpetual_funding_rate_arbitrage_{'bull' if direction == 1 else 'bear'}",
            )
