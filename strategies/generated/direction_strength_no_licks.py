#!/usr/bin/env python3
"""
Direction Strength No Licks (57/15M)
====================================
Auto-generated from: High Frequency Trading with OFI & Liquidations
Category: momentum
Confidence: 75%

Directional strength/momentum strategy with liquidation filtering. Two variants tested: one with standard parameters, and one with 7% stop loss, 5% take profit (57), and 15-minute maximum position time. Includes the standard liquidation threshold check.
...
class DirectionStrengthNoLicks(BaseStrategy):
    name = "direction_strength_no_licks"
    version = "0.1"
    ...
    def default_params(self) -> dict:
        return {
            ...
            "liquidation_check_interval_seconds": 30,
            "liquidation_lookback_minutes": 10,
            "liquidation_threshold_usd": 250000,
            "lookback_bars": 300,
            "max_history": 300,
            "max_hold_bars": 20,
            "max_position_time_minutes": 15,
            "stop_loss_percent": 7,
            "take_profit_pct": 5.0,
    ...
    def on_candle(self, candle: CandleData) -> Signal:
        ...
        if cascade_active:
            ...
            return Signal(
                ...
                tag=f"direction_strength_no_licks_{'bull' if direction == 1 else 'bear'}",
            )
...
PARAM_RANGES = {
    ...
    "liquidation_check_interval_seconds": [
        15,
        30,
        60
    ],
