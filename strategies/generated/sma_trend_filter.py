...
SMA Trend Filter
================
Auto-generated from: How to Delete emotions by Automating Your Trading
Category: momentum
Confidence: 70%

Uses a 20-period Simple Moving Average on higher timeframes (1-hour or 4-hour) as a filter to determine if price is in an uptrend. Strategy considers disabling this to allow buying capitulations (dips below SMA).
...
class SmaTrendFilter(BaseStrategy):
    name = "sma_trend_filter"
    version = "0.1"
    ...
    def on_candle(self, candle: CandleData) -> Signal:
        ...
        if ma_ready:
            ...
            return Signal(
                ...
                tag=f"sma_trend_filter_{'bull' if direction == 1 else 'bear'}",
            )
