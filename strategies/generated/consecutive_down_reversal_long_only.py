#!/usr/bin/env python3
"""
Consecutive Down Reversal Long Only
===================================
Auto-generated from: Claude Code Just Made Finding Winning Trading Strategies EASY
Category: reversal
Confidence: 90%

A long-only reversal strategy that enters a trade after identifying 4 consecutive downward bars. The strategy includes multiple variations using different technical indicators (ADX, MFI, VWAP, Kaufman filter) to filter entries and confirm reversal conditions.
...
class ConsecutiveDownReversalLongOnly(BaseStrategy):
    name = "consecutive_down_reversal_long_only"
    version = "0.1"
    ...
    def on_candle(self, candle: CandleData) -> Signal:
        ...
        if cascade_active:
            ...
            return Signal(
                ...
                tag=f"consecutive_down_reversal_long_only_{'bull' if direction == 1 else 'bear'}",
            )
