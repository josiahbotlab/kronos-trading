#!/usr/bin/env python3
"""
Flip-Flop Liquidation
=====================
Auto-generated from: I Found a Strategy That Makes Buy & Hold Look Like a Joke (14x Better)
Category: momentum
Confidence: 90%

A dual-trade strategy that enters long on large liquidation events, takes profit at a specific percentage gain, then immediately flips to a short position expecting a reversal. The short position uses a stop loss but no take profit, relying on the expectation that price will revisit liquidation levels.
...
class FlipFlopLiquidation(BaseStrategy):
    name = "flip_flop_liquidation"
    version = "0.1"
    ...
    def on_candle(self, candle: CandleData) -> Signal:
        ...
        if cascade_active:
            ...
            return Signal(
                ...
                tag=f"flip_flop_liquidation_{'bull' if direction == 1 else 'bear'}",
            )
