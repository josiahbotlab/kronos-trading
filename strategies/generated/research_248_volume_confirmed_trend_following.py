...
Incorporate volume analysis with moving average crossovers to confirm trend strength. Requires increasing volume to validate the trend.
...
class Research248VolumeConfirmedTrendFollowing(BaseStrategy):
    name = "research_248_volume_confirmed_trend_following"
    version = "0.1"
    ...
    def on_candle(self, candle: CandleData) -> Signal:
        ...
        if True and vol_ratio >= self.get_param('vol_mult'):
            ...
            tag = "research_248_volume_confirmed_trend_following_bull" if direction == 1 else "research_248_volume_confirmed_trend_following_bear"
            return Signal(
                direction=direction,
