#!/usr/bin/env python3
"""
Consecutive Down Closes Mean Reversion
======================================
Research ID: 344
Category: mean_reversion
Confidence: 60%

Identifies oversold conditions by tracking sequences of consecutive bearish closes, potentially combined with volatility contraction or volume divergence.
...
class Research344ConsecutiveDownClosesMeanReversion(BaseStrategy):
    name = "research_344_consecutive_down_closes_mean_reversion"
    version = "0.1"
    ...
    def on_candle(self, candle: CandleData) -> Signal:
        ...
        # Entry condition
        if (current_rsi > self.get_param('rsi_ob') or current_rsi < self.get_param('rsi_os')) and vol_ratio >= self.get_param('vol_mult'):
            ...
            tag = "research_344_consecutive_down_closes_mean_reversion_bull" if direction == 1 else "research_344_consecutive_down_closes_mean_reversion_bear"
            return Signal(
                direction=direction,
