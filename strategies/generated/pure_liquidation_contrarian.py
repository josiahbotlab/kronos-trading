#!/usr/bin/env python3
"""
Pure Liquidation Contrarian (Mean Reversion)
============================================
Auto-generated from: $1.7 Billion Liquidated So I'm Building A Liquidation Bot
Category: mean_reversion
Confidence: 80%

Fade liquidation cascades - buy when large short liquidations occur (price pushed down) and sell when large long liquidations occur (price pushed up), betting on mean reversion after forced liquidations.
...
class PureLiquidationContrarian(BaseStrategy):
    name = "pure_liquidation_contrarian"
    version = "0.1"
    ...
    def on_candle(self, candle: CandleData) -> Signal:
        ...
        if cascade_active and rsi_ready and (current_rsi > 70 or current_rsi < 30):
            ...
            return Signal(
                ...
                tag=f"pure_liquidation_contrarian_{'bull' if direction == 1 else 'bear'}",
            )
