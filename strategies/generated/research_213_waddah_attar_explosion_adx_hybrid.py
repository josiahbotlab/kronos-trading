#!/usr/bin/env python3
"""
Waddah Attar Explosion + ADX Hybrid
===================================
Research ID: 213
Category: momentum
Confidence: 60%

Combines the Waddah Attar Explosion (WAE) volatility indicator with ADX trend strength filtering. Strategy is generated by extracting Pine Script source code from TradingView Community and converting to Python for multi-asset backtesting to avoid repainting issues.
...
class Research213WaddahAttarExplosionAdxHybrid(BaseStrategy):
    name = "research_213_waddah_attar_explosion_adx_hybrid"
    version = "0.1"
    ...
    def on_candle(self, candle: CandleData) -> Signal:
        ...
        # Entry condition
        if adx_proxy > self.get_param('adx_threshold'):
            ...
            tag = "research_213_waddah_attar_explosion_adx_hybrid_bull" if direction == 1 else "research_213_waddah_attar_explosion_adx_hybrid_bear"
            return Signal(
                direction=direction,
