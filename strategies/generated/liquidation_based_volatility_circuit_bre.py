#!/usr/bin/env python3
"""
Liquidation-Based Volatility Circuit Breaker
============================================
Auto-generated from: everything a new algo trader wish they knew
Category: other
Confidence: 90%

Standalone risk management filter used as a circuit breaker. Disables new trade entries when aggregate liquidations exceed $500,000 over a 10-minute period, indicating excessive market volatility. Acts as a safety mechanism to prevent trading during potential liquidation cascades.
...
class LiquidationBasedVolatilityCircuitBre(BaseStrategy):
    name = "liquidation_based_volatility_circuit_bre"
    version = "0.1"
    ...
    def on_candle(self, candle: CandleData) -> Signal:
        ...
        if cascade_active:
            ...
            return Signal(
                ...
                tag=f"liquidation_based_volatility_circuit_bre_{'bull' if direction == 1 else 'bear'}",
            )
