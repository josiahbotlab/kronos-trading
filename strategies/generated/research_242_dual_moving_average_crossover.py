...
Classic trend following strategy using 50-day and 200-day simple moving averages. Enter long positions when the 50-day crosses above the 200-day (Golden Cross) and short when it crosses below (Death Cross).
...
class Research242DualMovingAverageCrossover(BaseStrategy):
    name = "research_242_dual_moving_average_crossover"
    version = "0.1"
    ...
    def on_candle(self, candle: CandleData) -> Signal:
        ...
        if True:
            ...
            tag = "research_242_dual_moving_average_crossover_bull" if direction == 1 else "research_242_dual_moving_average_crossover_bear"
            return Signal(
                direction=direction,
