#!/usr/bin/env python3
"""
MMO2 Liquidation Hunting Bot
============================
Auto-generated from: Binance's AsterDex Trading Bot & API Tutorial (step by step documentation)
Category: scalping
Confidence: 75%

A scalping strategy that combines real-time liquidation data with order book imbalance analysis to trigger entries. The bot monitors liquidation cascades via Moondev API and analyzes bid/ask volumes to identify entry points, adapted from a previous Hyperliquid market-making framework.
...
class Mmo2LiquidationHuntingBot(BaseStrategy):
    name = "mmo2_liquidation_hunting_bot"
    version = "0.1"
    ...
    def default_params(self) -> dict:
        return {
            ...
            "liquidation_threshold_usd": 10,
            "lookback_bars": 300,
            "max_history": 300,
            "max_hold_bars": 20,
            "order_retry_delay_seconds": 20,
            "take_profit_pct": 5.0,
    ...
    def on_candle(self, candle: CandleData) -> Signal:
        ...
        if cascade_active:
            ...
            return Signal(
                ...
                tag=f"mmo2_liquidation_hunting_bot_{'bull' if direction == 1 else 'bear'}",
            )
