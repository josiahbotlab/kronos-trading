#!/usr/bin/env python3
"""
Time-Boxed Anti-Overtrading
===========================
Auto-generated from: Quant App As An Always On Risk Manager
Category: other
Confidence: 90%

Restricts manual trading to specific 8-hour windows to prevent overtrading and emotional decision-making. Blocks manual market orders outside windows to avoid fee erosion (noted that 7 trades/day with 40x leverage on $25k account leads to account death in 23 days from fees alone).
...
class TimeBoxedAntiOvertrading(BaseStrategy):
    name = "time_boxed_anti_overtrading"
    version = "0.1"
    ...
    def on_candle(self, candle: CandleData) -> Signal:
        ...
        if cascade_active:
            ...
            return Signal(
                ...
                tag=f"time_boxed_anti_overtrading_{'bull' if direction == 1 else 'bear'}",
            )
