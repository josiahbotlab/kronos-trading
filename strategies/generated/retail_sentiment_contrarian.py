...
Trade against Public's retail buy/sell ratio exposed on every stock page. Take contrarian positions when retail sentiment reaches extremes (e.g., SPY showing 30% buying/70% selling indicates retail is massively bearish, signaling a contrarian buy opportunity).
...
class RetailSentimentContrarian(BaseStrategy):
    name = "retail_sentiment_contrarian"
    version = "0.1"
    ...
    def on_candle(self, candle: CandleData) -> Signal:
        ...
        if cascade_active:
            ...
            return Signal(
                ...
                tag=f"retail_sentiment_contrarian_{'bull' if direction == 1 else 'bear'}",
            )
