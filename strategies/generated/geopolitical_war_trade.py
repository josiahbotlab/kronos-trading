#!/usr/bin/env python3
"""
Geopolitical War Trade (Oil/Gold Long)
======================================
Auto-generated from: Claude Chrome Built My WW3 Trading Bot
Category: momentum
Confidence: 90%

Classic 'buy the war, sell the news' dislocation play. Long oil and gold based on physical supply disruption (Strait of Hormuz closure) causing 20% of global oil supply to be stuck. Market pricing suggests 4-week resolution but structural factors (leadership vacuum in Iran) suggest 3-6 week minimum duration. Exit if diplomatic resolution signals appear.
...
class GeopoliticalWarTrade(BaseStrategy):
    name = "geopolitical_war_trade"
    version = "0.1"
    ...
    def on_candle(self, candle: CandleData) -> Signal:
        ...
        if cascade_active:
            ...
            return Signal(
                ...
                tag=f"geopolitical_war_trade_{'bull' if direction == 1 else 'bear'}",
            )
