#!/usr/bin/env python3
"""
Bollinger Band SMA Bounce
=========================
Auto-generated from: OpenAI Trading Bots (Full Course)
Category: mean_reversion
Confidence: 80%

Price action strategy that enters when price touches the 200-period SMA after entering the Bollinger Band from the top (long) or bottom (short), targeting the opposite band for exit.
...
class BollingerBandSmaBounce(BaseStrategy):
    name = "bollinger_band_sma_bounce"
    version = "0.1"
    ...
    def on_candle(self, candle: CandleData) -> Signal:
        ...
        if bb_ready and (candle.close > bb[0] or candle.close < bb[2]) and ma_ready:
            ...
            return Signal(
                ...
                tag=f"bollinger_band_sma_bounce_{'bull' if direction == 1 else 'bear'}",
            )
