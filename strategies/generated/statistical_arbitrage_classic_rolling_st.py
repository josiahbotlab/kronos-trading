#!/usr/bin/env python3
"""
Statistical Arbitrage - Classic Rolling Statistics
==================================================
Auto-generated from: Jan 15 Live: This is Why You CAN NOT trade by hand in 2026 ($4.5M trade)
Category: mean_reversion
Confidence: 85%

Market-neutral pairs trading strategy using rolling statistics to identify co-integrated trading pairs. Goes long one asset and short another when statistical thresholds are breached, minimizing directional market risk.
...
class StatisticalArbitrageClassicRollingSt(BaseStrategy):
    name = "statistical_arbitrage_classic_rolling_st"
    version = "0.1"
    ...
    def on_candle(self, candle: CandleData) -> Signal:
        ...
        if cascade_active:
            ...
            return Signal(
                ...
                tag=f"statistical_arbitrage_classic_rolling_st_{'bull' if direction == 1 else 'bear'}",
            )
