#!/usr/bin/env python3
"""
Fast MACD + ADX Scalping
========================
Auto-generated from: AI Agents For Finding Winning Trading Strategies
Category: scalping
Confidence: 70%

A faster timeframe variation of MACD + ADX designed for intraday scalping with quicker signal generation.
...
class FastMacdAdxScalping(BaseStrategy):
    name = "fast_macd_adx_scalping"
    version = "0.1"
    ...
    def on_candle(self, candle: CandleData) -> Signal:
        ...
        if cascade_active:
            ...
            return Signal(
                ...
                tag=f"fast_macd_adx_scalping_{'bull' if direction == 1 else 'bear'}",
            )
