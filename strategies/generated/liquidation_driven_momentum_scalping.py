#!/usr/bin/env python3
"""
Liquidation-Driven Momentum Scalping (Habachi)
==============================================
Auto-generated from: Airdrop points are the new food farms many 10x's
Category: scalping
Confidence: 85%

Uses liquidation data from Moon Dev API to determine directional bias and enters trades when liquidation volume exceeds a threshold. Bias is determined by comparing long vs short liquidations over a 5-minute lookback period.
...
class LiquidationDrivenMomentumScalping(BaseStrategy):
    name = "liquidation_driven_momentum_scalping"
    version = "0.1"
    ...
    def on_candle(self, candle: CandleData) -> Signal:
        ...
        if cascade_active:
            ...
            return Signal(
                ...
                tag=f"liquidation_driven_momentum_scalping_{'bull' if direction == 1 else 'bear'}",
            )
