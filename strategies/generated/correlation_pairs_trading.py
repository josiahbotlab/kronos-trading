...
Monitors a leading asset (Ethereum) for breakout moves and trades lagging correlated altcoins. When ETH breaks above resistance + true range or below support - true range, the strategy identifies the 'most lagging' altcoin (smallest percentage change) and enters in the same direction as ETH's move.
...
class CorrelationPairsTrading(BaseStrategy):
    name = "correlation_pairs_trading"
    version = "0.1"
    ...
    def on_candle(self, candle: CandleData) -> Signal:
        ...
        if ma_ready:
            ...
            return Signal(
                ...
                tag=f"correlation_pairs_trading_{'bull' if direction == 1 else 'bear'}",
            )
