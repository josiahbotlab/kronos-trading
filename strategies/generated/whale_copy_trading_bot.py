...
Automatically copies positions from pre-filtered high-performing whale addresses by monitoring their portfolios and replicating trades with smaller position sizes. Implements automated risk management based on profit and loss thresholds.
...
class WhaleCopyTradingBot(BaseStrategy):
    name = "whale_copy_trading_bot"
    version = "0.1"
    ...
    def on_candle(self, candle: CandleData) -> Signal:
        ...
        if ma_ready:
            ...
            return Signal(
                ...
                tag=f"whale_copy_trading_bot_{'bull' if direction == 1 else 'bear'}",
            )
