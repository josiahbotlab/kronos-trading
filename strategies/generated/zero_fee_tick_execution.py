#!/usr/bin/env python3
"""
Zero-Fee Tick Execution
=======================
Auto-generated from: Quant App Explained: Risk & Liquidation Trading App
Category: scalping
Confidence: 95%

Execute all entries and exits using limit orders at specific tick levels to minimize or eliminate trading fees. Using the 15th tick effectively creates zero-fee trades when accounting for maker rebates, compared to market orders that cost 3x more in fees.
...
class ZeroFeeTickExecution(BaseStrategy):
    name = "zero_fee_tick_execution"
    version = "0.1"
    ...
    def on_candle(self, candle: CandleData) -> Signal:
        ...
        if cascade_active:
            ...
            return Signal(
                ...
                tag=f"zero_fee_tick_execution_{'bull' if direction == 1 else 'bear'}",
            )
