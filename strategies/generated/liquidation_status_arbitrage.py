#!/usr/bin/env python3
"""
Liquidation Status Arbitrage
============================
Auto-generated from: Claude Code + Public's API: Short Borrow Rates, Retail Sentiment & Edges Nobody's Trading
Category: other
Confidence: 70%

Monitor instrument status transitions on Public's API. When the internal risk team flags a stock changing from 'buy and sell' to 'liquidation only', this proprietary risk signal leaks before the broader market prices it in. Trade the symbol on other exchanges where it remains available.
...
class LiquidationStatusArbitrage(BaseStrategy):
    name = "liquidation_status_arbitrage"
    version = "0.1"
    ...
    def on_candle(self, candle: CandleData) -> Signal:
        ...
        if cascade_active and ma_ready:
            ...
            return Signal(
                ...
                tag=f"liquidation_status_arbitrage_{'bull' if direction == 1 else 'bear'}",
            )
