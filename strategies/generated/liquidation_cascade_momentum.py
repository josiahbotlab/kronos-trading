#!/usr/bin/env python3
"""
Liquidation Cascade Momentum (P99)
==================================
Auto-generated from: Clawbot Trading Bot That Did 7,547%… What's the Catch?
Category: momentum
Confidence: 85%

Momentum strategy that rides liquidation cascades by entering on extreme liquidation events. Data shows that when shorts get liquidated, price continues upward, and vice versa. Strategy triggers only on the most extreme 1% of liquidation events to capture high-probability momentum moves.
...
class LiquidationCascadeMomentum(BaseStrategy):
    name = "liquidation_cascade_momentum"
    version = "0.1"
    ...
    def on_candle(self, candle: CandleData) -> Signal:
        ...
        if cascade_active:
            ...
            return Signal(
                ...
                tag=f"liquidation_cascade_momentum_{'bull' if direction == 1 else 'bear'}",
            )
