#!/usr/bin/env python3
"""
Capitulation Dip Buying
=======================
Research ID: 40
Category: mean_reversion
Confidence: 60%

Mean reversion approach that buys price dips and capitulations when price falls below the SMA on various timeframes (15-minute, 20-minute, or 8-hour), targeting oversold conditions rather than trend continuation.
...
class Research40CapitulationDipBuying(BaseStrategy):
    name = "research_40_capitulation_dip_buying"
    version = "0.1"
    ...
    def on_candle(self, candle: CandleData) -> Signal:
        ...
        # Entry condition
        if (current_rsi > self.get_param('rsi_ob') or current_rsi < self.get_param('rsi_os')) and True:
            ...
            tag = "research_40_capitulation_dip_buying_bull" if direction == 1 else "research_40_capitulation_dip_buying_bear"
            return Signal(
                direction=direction,
