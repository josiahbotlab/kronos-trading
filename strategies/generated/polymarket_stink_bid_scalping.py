#!/usr/bin/env python3
"""
Polymarket Stink Bid Scalping
=============================
Auto-generated from: opus 4.5 polymarket bot just returned 1,266% in 4 minutes
Category: scalping
Confidence: 75%

Places ultra-aggressive limit orders (stink bids) away from market price to capture volatility or price discrepancies on Polymarket, then exits by deliberately crossing the spread—pricing orders 5% through the market to ensure immediate fills. Strategy targets micro-holds of seconds to minutes with automated position closure verification.
...
class PolymarketStinkBidScalping(BaseStrategy):
    name = "polymarket_stink_bid_scalping"
    version = "0.1"
    ...
    def on_candle(self, candle: CandleData) -> Signal:
        ...
        if cascade_active:
            ...
            return Signal(
                ...
                tag=f"polymarket_stink_bid_scalping_{'bull' if direction == 1 else 'bear'}",
            )
