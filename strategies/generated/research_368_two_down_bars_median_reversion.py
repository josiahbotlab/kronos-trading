#!/usr/bin/env python3
"""
Two Down Bars Median Reversion
==============================
Research ID: 368
Category: mean_reversion
Confidence: 80%

A mean reversion strategy that enters long when price prints two consecutive down bars while trading below the median price of the last few hours. Uses simple price action and median levels to identify oversold conditions for dip buying.
...
class Research368TwoDownBarsMedianReversion(BaseStrategy):
    name = "research_368_two_down_bars_median_reversion"
    version = "0.1"
    ...
    def on_candle(self, candle: CandleData) -> Signal:
        ...
        # Entry condition
        if (current_rsi > self.get_param('rsi_ob') or current_rsi < self.get_param('rsi_os')):
            ...
            tag = "research_368_two_down_bars_median_reversion_bull" if direction == 1 else "research_368_two_down_bars_median_reversion_bear"
            return Signal(
                direction=direction,
