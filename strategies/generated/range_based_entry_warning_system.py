#!/usr/bin/env python3
"""
Range-Based Entry Warning System
================================
Auto-generated from: Everyone wants to Trade with 40x Leverage So i Automated it
Category: mean_reversion
Confidence: 85%

Analyze 2-hour price ranges (24 five-minute candles) divided into thirds to prevent entering at poor locations. Warn against counter-trend entries at range extremes.
...
class RangeBasedEntryWarningSystem(BaseStrategy):
    name = "range_based_entry_warning_system"
    version = "0.1"
    ...
    def on_candle(self, candle: CandleData) -> Signal:
        ...
        if cascade_active:
            ...
            return Signal(
                ...
                tag=f"range_based_entry_warning_system_{'bull' if direction == 1 else 'bear'}",
            )
