#!/usr/bin/env python3
"""
Time-Based Liquidation Exit
===========================
Auto-generated from: I Found a Strategy That Makes Buy & Hold Look Like a Joke (14x Better)
Category: momentum
Confidence: 70%

A simple momentum strategy that buys large liquidation events and exits purely based on time elapsed, with no technical indicators for exit. Tests various holding periods to optimize the time decay of liquidation bounces.
...
class TimeBasedLiquidationExit(BaseStrategy):
    name = "time_based_liquidation_exit"
    version = "0.1"
    ...
    def on_candle(self, candle: CandleData) -> Signal:
        ...
        if cascade_active:
            ...
            return Signal(
                ...
                tag=f"time_based_liquidation_exit_{'bull' if direction == 1 else 'bear'}",
            )
