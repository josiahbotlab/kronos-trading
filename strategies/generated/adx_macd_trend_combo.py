#!/usr/bin/env python3
"""
ADX MACD Trend Combo
====================
Auto-generated from: Clawbot Trading Bot That Did 7,547%… What's the Catch?
Category: momentum
Confidence: 80%

Trend-following strategy combining Average Directional Index (ADX) rising for trend strength with MACD confirmation for direction. Most robust across multiple timeframes according to backtests.
...
class AdxMacdTrendCombo(BaseStrategy):
    name = "adx_macd_trend_combo"
    version = "0.1"
    ...
    def on_candle(self, candle: CandleData) -> Signal:
        ...
        if cascade_active:
            ...
            return Signal(
                ...
                tag=f"adx_macd_trend_combo_{'bull' if direction == 1 else 'bear'}",
            )
