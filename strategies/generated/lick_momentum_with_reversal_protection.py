#!/usr/bin/env python3
"""
Lick Momentum with Reversal Protection
======================================
Auto-generated from: Clawbot Trading Bot That Did 7,547%… What's the Catch?
Category: momentum
Confidence: 70%

Momentum strategy specifically designed to trade liquidation events ('licks') with a reversal protection filter to avoid bad entries. Uses tight risk management after analysis showed average losses exceeding average wins.
...
class LickMomentumWithReversalProtection(BaseStrategy):
    name = "lick_momentum_with_reversal_protection"
    version = "0.1"
    ...
    def on_candle(self, candle: CandleData) -> Signal:
        ...
        if cascade_active:
            ...
            return Signal(
                ...
                tag=f"lick_momentum_with_reversal_protection_{'bull' if direction == 1 else 'bear'}",
            )
