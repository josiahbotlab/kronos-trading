#!/usr/bin/env python3
"""
AI Consensus Long-Only Range Entry
==================================
Research ID: 218
Category: momentum
Confidence: 85%

A long-only strategy for trending assets (specifically Zcash) that enters when price is in the bottom half of the range after consecutive down bars, subject to approval by a swarm of AI agents analyzing recent price action. Uses strict risk controls including leverage limits and automatic short position liquidation.
...
class Research218AiConsensusLongOnlyRangeEntry(BaseStrategy):
    name = "research_218_ai_consensus_long_only_range_entry"
    version = "0.1"
    ...
    def on_candle(self, candle: CandleData) -> Signal:
        ...
        if cascade_active:
            ...
            tag = "research_218_ai_consensus_long_only_range_entry_bull" if direction == 1 else "research_218_ai_consensus_long_only_range_entry_bear"
            return Signal(
                direction=direction,
