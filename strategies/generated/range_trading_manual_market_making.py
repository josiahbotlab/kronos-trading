#!/usr/bin/env python3
"""
Range Trading / Manual Market Making
====================================
Auto-generated from: How To Build a Trading Bot in 2026 (Even If You Can't Code)
Category: mean_reversion
Confidence: 90%

Act as a market maker by placing automated limit orders to buy below a specific support level and sell above a specific resistance level. The bot continuously monitors price and executes when the asset trades within the defined range.
...
class RangeTradingManualMarketMaking(BaseStrategy):
    name = "range_trading_manual_market_making"
    version = "0.1"
    ...
    def on_candle(self, candle: CandleData) -> Signal:
        ...
        if cascade_active:
            ...
            return Signal(
                ...
                tag=f"range_trading_manual_market_making_{'bull' if direction == 1 else 'bear'}",
            )
