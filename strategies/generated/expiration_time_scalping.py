#!/usr/bin/env python3
"""
Expiration Time Scalping
========================
Auto-generated from: Polymarket Trading Agents (Humans Cant Trade Better)
Category: scalping
Confidence: 85%

Focus on prediction markets expiring within 72 hours to capture volatility and potential pricing inefficiencies as markets approach resolution. These markets are filtered into a separate dashboard for time-sensitive opportunities.
...
class ExpirationTimeScalping(BaseStrategy):
    name = "expiration_time_scalping"
    version = "0.1"
    ...
    def default_params(self) -> dict:
        return {
            ...
            "max_history": 300,
            "max_hold_bars": 20,
            "max_hours_to_expiration": 72,
            "min_hours_to_expiration": 0,
            "take_profit_pct": 5.0,
    ...
    def on_candle(self, candle: CandleData) -> Signal:
        ...
        if cascade_active:
            ...
            return Signal(
                ...
                tag=f"expiration_time_scalping_{'bull' if direction == 1 else 'bear'}",
            )
