#!/usr/bin/env python3
"""
Binary Edge Market Selection
============================
Auto-generated from: Polymarket Trading Agents (Humans Cant Trade Better)
Category: mean_reversion
Confidence: 75%

Filter binary outcome markets to only trade those priced between 15-85 cents, avoiding markets too close to resolution (under 15 cents or over 85 cents). This targets markets with sufficient uncertainty and liquidity while avoiding 'slam dunk' resolutions.
...
class BinaryEdgeMarketSelection(BaseStrategy):
    name = "binary_edge_market_selection"
    version = "0.1"
    ...
    def on_candle(self, candle: CandleData) -> Signal:
        ...
        if cascade_active:
            ...
            return Signal(
                ...
                tag=f"binary_edge_market_selection_{'bull' if direction == 1 else 'bear'}",
            )
