#!/usr/bin/env python3
"""
Hyperliquid Volume Anomaly Runner Detection
===========================================
Auto-generated from: AI Agents That NEVER miss a Runner
Category: momentum
Confidence: 75%

An AI-driven momentum strategy that monitors the top 15 altcoins on Hyperliquid (excluding BTC, ETH, and SOL) for volume anomalies every 4 hours. The system calculates 4-hour and 24-hour volume changes to detect early accumulation before price moves, then uses a swarm of AI agents to reach consensus on the single best token to enter long based purely on volume metrics.
...
class HyperliquidVolumeAnomalyRunnerDetect(BaseStrategy):
    name = "hyperliquid_volume_anomaly_runner_detect"
    version = "0.1"
    ...
    def on_candle(self, candle: CandleData) -> Signal:
        ...
        if cascade_active:
            ...
            return Signal(
                ...
                tag=f"hyperliquid_volume_anomaly_runner_detect_{'bull' if direction == 1 else 'bear'}",
            )
