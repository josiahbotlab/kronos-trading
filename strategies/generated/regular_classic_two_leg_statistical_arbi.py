#!/usr/bin/env python3
"""
Regular Classic Two-Leg Statistical Arbitrage
=============================================
Auto-generated from: I Let 3x OpenAI Codex Build 4 Arbitrage Bots Live
Category: mean_reversion
Confidence: 85%

Baseline mean reversion engine that trades the spread between two cointegrated assets using rolling Z-score normalization. Scans for price dislocations between paired assets and enters when deviation is statistically significant, exiting on mean reversion or Z-score cross.
...
class RegularClassicTwoLegStatisticalArbi(BaseStrategy):
    name = "regular_classic_two_leg_statistical_arbi"
    version = "0.1"
    ...
    def on_candle(self, candle: CandleData) -> Signal:
        ...
        if rsi_ready and (current_rsi > 70 or current_rsi < 30):
            ...
            return Signal(
                ...
                tag=f"regular_classic_two_leg_statistical_arbi_{'bull' if direction == 1 else 'bear'}",
            )
