#!/usr/bin/env python3
"""
ATR Stop Hunt / Counter-Trade
=============================
Auto-generated from: From ZERO to ALGO TRADER in 2024 - Step By Step (FULL COURSE)
Category: scalping
Confidence: 80%

A scalping strategy that enters positions where other traders' stop losses are likely to be triggered (counter-trading the masses). During consolidation periods, places limit orders at 1.5x to 2x the ATR away from current price, betting on stop runs and reversions. Uses SMA trend filter to determine direction.
...
class AtrStopHuntCounterTrade(BaseStrategy):
    name = "atr_stop_hunt_counter_trade"
    version = "0.1"
    ...
    def on_candle(self, candle: CandleData) -> Signal:
        ...
        if rsi_ready and ma_ready:
            ...
            return Signal(
                ...
                tag=f"atr_stop_hunt_counter_trade_{'bull' if direction == 1 else 'bear'}",
            )
