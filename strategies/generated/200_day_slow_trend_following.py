#!/usr/bin/env python3
"""
200-Day Slow Trend Following
============================
Auto-generated from: AI Agents For Finding Winning Trading Strategies
Category: momentum
Confidence: 80%

Long-term trend following strategy utilizing the 200-day simple moving average for directional bias.
...
class 200DaySlowTrendFollowing(BaseStrategy):
    name = "200_day_slow_trend_following"
    version = "0.1"
    ...
    def on_candle(self, candle: CandleData) -> Signal:
        ...
        if ma_ready:
            ...
            return Signal(
                ...
                tag=f"200_day_slow_trend_following_{'bull' if direction == 1 else 'bear'}",
            )
