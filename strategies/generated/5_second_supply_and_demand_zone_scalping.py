#!/usr/bin/env python3
"""
5-Second Supply and Demand Zone Scalping
========================================
Auto-generated from: a trading bot to make sure you never lose again
Category: scalping
Confidence: 80%

Automated scalping strategy that monitors 5-second timeframe charts for supply and demand zone entries. Uses Binance websocket data to build real-time bars and includes cool down periods between trades to prevent overtrading. Two variants referenced as 'Pacifica' and 'Extended'.
...
class 5SecondSupplyAndDemandZoneScalping(BaseStrategy):
    name = "5_second_supply_and_demand_zone_scalping"
    version = "0.1"
    ...
    def on_candle(self, candle: CandleData) -> Signal:
        ...
        if ma_ready:
            ...
            return Signal(
                ...
                tag=f"5_second_supply_and_demand_zone_scalping_{'bull' if direction == 1 else 'bear'}",
            )
