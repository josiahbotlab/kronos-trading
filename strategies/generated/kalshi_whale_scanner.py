#!/usr/bin/env python3
"""
Kalshi Whale Scanner (Research Tool)
====================================
Auto-generated from: Claude Code Built Me 4 Trading Bots in One Day — I'm Done Hand Trading
Category: other
Confidence: 80%

Market scanning tool used for alpha generation and liquidity discovery. Monitors Kalshi prediction markets in real-time to identify large traders (whales) and liquid markets by filtering for significant trade sizes. Used to generate ideas for new bots by following smart money.
...
class KalshiWhaleScanner(BaseStrategy):
    name = "kalshi_whale_scanner"
    version = "0.1"
    ...
    def on_candle(self, candle: CandleData) -> Signal:
        ...
        if ma_ready:
            ...
            return Signal(
                ...
                tag=f"kalshi_whale_scanner_{'bull' if direction == 1 else 'bear'}",
            )
