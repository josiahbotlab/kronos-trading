...
Exploits emotional overreactions in prediction markets by detecting when token prices deviate significantly from their historical mean. When YES tokens are overpriced by 2+ standard deviations, the strategy buys NO tokens expecting mean reversion, and vice versa.
    ...
    def on_candle(self, candle: CandleData) -> Signal:
        ...
        if rsi_ready and (current_rsi > 70 or current_rsi < 30):
            ...
            return Signal(
                ...
                tag=f"mean_reversion_bot_{'bull' if direction == 1 else 'bear'}",
            )
