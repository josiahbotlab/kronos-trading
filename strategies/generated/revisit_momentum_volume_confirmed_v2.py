#!/usr/bin/env python3
"""
Revisit Momentum Volume Confirmed V2 (Liquidation Mean Reversion)
=================================================================
Auto-generated from: I Found 5 Strategies Nobody's Talking About (514%)
Category: mean_reversion
Confidence: 85%

Detects large liquidation events, records the price low at the time of liquidation, then enters a long position when price drops below that recorded low. Entry is confirmed by either RSI oversold conditions or MACD bullish divergence. Uses volume confirmation and targets liquidation cascades for mean reversion.
...
class RevisitMomentumVolumeConfirmedV2(BaseStrategy):
    name = "revisit_momentum_volume_confirmed_v2"
    version = "0.1"
    ...
    def on_candle(self, candle: CandleData) -> Signal:
        ...
        if cascade_active and rsi_ready and (current_rsi > 70 or current_rsi < 30):
            ...
            return Signal(
                ...
                tag=f"revisit_momentum_volume_confirmed_v2_{'bull' if direction == 1 else 'bear'}",
            )
