...
Feature selection strategy that prioritizes volume-based indicators. Volume change (percent change) consistently dominated feature importance at 94-97% across all tested models. Secondary features included Bollinger Band width, volatility, RSI, Linear Regression, MACD, True Range (ATR), ADX, and Donchian Channels. Models without volume change showed poorer performance.
...
class VolumeWeightedFeatureEngineering(BaseStrategy):
    name = "volume_weighted_feature_engineering"
    version = "0.1"
    ...
    def on_candle(self, candle: CandleData) -> Signal:
        ...
        # Entry condition
        if rsi_ready and bb_ready and (candle.close > bb[0] or candle.close < bb[2]):
            ...
            return Signal(
                ...
                tag=f"volume_weighted_feature_engineering_{'bull' if direction == 1 else 'bear'}",
            )
