#!/usr/bin/env python3
"""
Liquidation-Volume Exit Trigger
===============================
Auto-generated from: Quant App Explained: Risk & Liquidation Trading App
Category: other
Confidence: 80%

Close existing positions when opposite-side liquidations reach specific volume thresholds within a time window. For example, close a long position when $3M in short liquidations occur within 10 minutes, indicating potential reversal or exhaustion.
...
class LiquidationVolumeExitTrigger(BaseStrategy):
    name = "liquidation_volume_exit_trigger"
    version = "0.1"
    ...
    def on_candle(self, candle: CandleData) -> Signal:
        ...
        if cascade_active:
            ...
            return Signal(
                ...
                tag=f"liquidation_volume_exit_trigger_{'bull' if direction == 1 else 'bear'}",
            )
