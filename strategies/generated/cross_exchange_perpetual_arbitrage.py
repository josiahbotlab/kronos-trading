...
Arbitrages between perpetual DEXes (Habachi/Extended or Habachi/Pacifica) using liquidation data as entry signals. Uses 98% of available equity on the smaller-balance exchange, matched on the larger exchange.
...
class CrossExchangePerpetualArbitrage(BaseStrategy):
    name = "cross_exchange_perpetual_arbitrage"
    version = "0.1"
    ...
    def on_candle(self, candle: CandleData) -> Signal:
        ...
        if cascade_active and ma_ready:
            ...
            return Signal(
                ...
                tag=f"cross_exchange_perpetual_arbitrage_{'bull' if direction == 1 else 'bear'}",
            )
