#!/usr/bin/env python3
"""
Intraday Bollinger with ADX Confirmation
========================================
Auto-generated from: AI Agents For Finding Winning Trading Strategies
Category: scalping
Confidence: 80%

Intraday scalping strategy using Bollinger Bands for entry signals with ADX filtering to confirm trend strength before entry.
...
class IntradayBollingerWithAdxConfirmation(BaseStrategy):
    name = "intraday_bollinger_with_adx_confirmation"
    version = "0.1"
    ...
    def on_candle(self, candle: CandleData) -> Signal:
        ...
        if bb_ready and (candle.close > bb[0] or candle.close < bb[2]):
            ...
            return Signal(
                ...
                tag=f"intraday_bollinger_with_adx_confirmation_{'bull' if direction == 1 else 'bear'}",
            )
