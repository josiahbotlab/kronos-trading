#!/usr/bin/env python3
"""
Lick Stink V3 (High Threshold)
==============================
Auto-generated from: Claude Opus Found a Polymarket Edge No One Is Talking About
Category: momentum
Confidence: 95%

A filtered version of the liquidation strategy that only trades on large liquidation events. Increases the minimum liquidation threshold from 2K to 25K USD to focus only on significant capitulation events ('big lickies').
...
class LickStinkV3(BaseStrategy):
    name = "lick_stink_v3"
    version = "0.1"
    ...
    def on_candle(self, candle: CandleData) -> Signal:
        ...
        if cascade_active and rsi_ready:
            ...
            return Signal(
                ...
                tag=f"lick_stink_v3_{'bull' if direction == 1 else 'bear'}",
            )
