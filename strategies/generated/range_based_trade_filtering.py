#!/usr/bin/env python3
"""
Range-Based Trade Filtering
===========================
Auto-generated from: Quant App Full Step By Step Training
Category: other
Confidence: 70%

Prevents entries and warns against exits when price is in the middle of a recent trading range. The system blocks manual entries in the middle of a 2-hour price range and warns when attempting to close positions mid-range, encouraging traders to let winners run to range extremes.
...
class RangeBasedTradeFiltering(BaseStrategy):
    name = "range_based_trade_filtering"
    version = "0.1"
    ...
    def on_candle(self, candle: CandleData) -> Signal:
        ...
        if cascade_active:
            ...
            return Signal(
                ...
                tag=f"range_based_trade_filtering_{'bull' if direction == 1 else 'bear'}",
            )
