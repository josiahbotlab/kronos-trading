#!/usr/bin/env python3
"""
Donchian Channel Long Only
==========================
Auto-generated from: AI Agents For Finding Winning Trading Strategies
Category: breakout
Confidence: 70%

A trend-following strategy using Donchian Channels to identify breakout levels for long-only positions.
...
class DonchianChannelLongOnly(BaseStrategy):
    name = "donchian_channel_long_only"
    version = "0.1"
    ...
    def on_candle(self, candle: CandleData) -> Signal:
        ...
        if cascade_active:
            ...
            return Signal(
                ...
                tag=f"donchian_channel_long_only_{'bull' if direction == 1 else 'bear'}",
            )
