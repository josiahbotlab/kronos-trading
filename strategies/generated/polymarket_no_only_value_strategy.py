#!/usr/bin/env python3
"""
Polymarket 'No Only' Value Strategy
===================================
Auto-generated from: Prediction Market Trading Bot in Python (Polymarket API step by step)
Category: mean_reversion
Confidence: 70%

Simple directional strategy that buys 'No' shares when the implied probability (price) is low, betting against outcomes with unfavorable odds. Based on the observation that 'No' shares are often undervalued in certain prediction markets.
...
class PolymarketNoOnlyValueStrategy(BaseStrategy):
    name = "polymarket_no_only_value_strategy"
    version = "0.1"
    ...
    def on_candle(self, candle: CandleData) -> Signal:
        ...
        if cascade_active:
            ...
            return Signal(
                ...
                tag=f"polymarket_no_only_value_strategy_{'bull' if direction == 1 else 'bear'}",
            )
