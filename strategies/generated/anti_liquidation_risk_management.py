...
Use stop losses set before exchange liquidation levels to avoid liquidation fees and preserve capital.
...
class AntiLiquidationRiskManagement(BaseStrategy):
    name = "anti_liquidation_risk_management"
    version = "0.1"
    ...
    def on_candle(self, candle: CandleData) -> Signal:
        ...
        if cascade_active:
            ...
            return Signal(
                ...
                tag=f"anti_liquidation_risk_management_{'bull' if direction == 1 else 'bear'}",
            )
