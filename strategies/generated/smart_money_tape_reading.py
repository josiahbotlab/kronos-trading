#!/usr/bin/env python3
"""
Smart Money Tape Reading
========================
Auto-generated from: i gave ai $10,000 to trade for me...
Category: other
Confidence: 75%

Infrastructure strategy that captures and analyzes large block trades (whale activity) across Binance and Hyperliquid to identify support/resistance levels created by big trader entries.
...
class SmartMoneyTapeReading(BaseStrategy):
    name = "smart_money_tape_reading"
    version = "0.1"
    ...
    def on_candle(self, candle: CandleData) -> Signal:
        ...
        if cascade_active:
            ...
            return Signal(
                ...
                tag=f"smart_money_tape_reading_{'bull' if direction == 1 else 'bear'}",
            )
