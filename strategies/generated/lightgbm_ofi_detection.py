#!/usr/bin/env python3
"""
LightGBM OFI Detection
======================
Auto-generated from: how to actually use machine learning in trading bots
Category: scalping
Confidence: 70%

Gradient boosting model (LightGBM) for nonlinear pattern detection in OFI data. Tests showed approximately 53% win rate and was determined to be inferior to TCN approach, leading to discontinuation.
...
class LightgbmOfiDetection(BaseStrategy):
    name = "lightgbm_ofi_detection"
    version = "0.1"
    ...
    def on_candle(self, candle: CandleData) -> Signal:
        ...
        if cascade_active:
            ...
            return Signal(
                ...
                tag=f"lightgbm_ofi_detection_{'bull' if direction == 1 else 'bear'}",
            )
