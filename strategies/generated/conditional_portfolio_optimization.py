...
==================================
Auto-generated from: Dr. Ernest Chan: His Unheard Approach To AI in Trading
Category: other
Confidence: 85%

Machine learning-based capital allocation system that distributes capital across multiple strategies based on high-dimensional regime identification. Regimes are defined as points in a high-dimensional space (20-100+ axes) rather than discrete categories, allowing smooth transitions in allocation as market conditions evolve.
...
class ConditionalPortfolioOptimization(BaseStrategy):
    name = "conditional_portfolio_optimization"
    version = "0.1"

    def default_params(self) -> dict:
        return {
            "calmar_ratio_excellent": 3.0,
            "calmar_ratio_minimum": 1.0,
            "calmar_ratio_target": 2.0,
            "cooldown_bars": 5,
            "entry_strength": 0.8,
            "liq_percentile": 85,
            "max_history": 300,
    ...
    def on_candle(self, candle: CandleData) -> Signal:
        ...
        if cascade_active:
            ...
            return Signal(
                ...
                tag=f"conditional_portfolio_optimization_{'bull' if direction == 1 else 'bear'}",
            )
