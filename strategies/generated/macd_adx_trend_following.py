...
Trend following strategy using MACD for trend direction and ADX (Average Directional Index) for trend strength confirmation.
...
class MacdAdxTrendFollowing(BaseStrategy):
    name = "macd_adx_trend_following"
    version = "0.1"
    ...
    def on_candle(self, candle: CandleData) -> Signal:
        ...
        if cascade_active:
            ...
            return Signal(
                ...
                tag=f"macd_adx_trend_following_{'bull' if direction == 1 else 'bear'}",
            )
