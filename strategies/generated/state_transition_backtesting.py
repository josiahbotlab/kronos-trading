#!/usr/bin/env python3
"""
State Transition Backtesting
============================
Auto-generated from: how to actually use ai for trading
Category: breakout
Confidence: 85%

A backtesting framework that tests all permutations of buying and selling based on HMM-predicted state changes. The strategy optimizes which specific states to enter (buy) and exit (sell) by testing combinations like buying at State 0 and selling at State 2, buying at State 2 selling at State 4, etc. The best performing combination showed 23% return with only 11% market exposure time vs 35% buy-and-hold, effectively filtering out unfavorable market conditions.
...
class StateTransitionBacktesting(BaseStrategy):
    name = "state_transition_backtesting"
    version = "0.1"
    ...
    def on_candle(self, candle: CandleData) -> Signal:
        ...
        if cascade_active:
            ...
            return Signal(
                ...
                tag=f"state_transition_backtesting_{'bull' if direction == 1 else 'bear'}",
            )
