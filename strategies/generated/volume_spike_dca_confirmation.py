#!/usr/bin/env python3
"""
Volume Spike DCA Confirmation
=============================
Auto-generated from: Claude Code For Aster Trading Bots
Category: mean_reversion
Confidence: 75%

Entry confirmation strategy that only places DCA bids when a downside candle exhibits 2-3x the average volume, indicating potential capitulation or liquidity grabs before reversal.
...
class VolumeSpikeDcaConfirmation(BaseStrategy):
    name = "volume_spike_dca_confirmation"
    version = "0.1"
    ...
    def on_candle(self, candle: CandleData) -> Signal:
        ...
        if cascade_active:
            ...
            return Signal(
                ...
                tag=f"volume_spike_dca_confirmation_{'bull' if direction == 1 else 'bear'}",
            )
