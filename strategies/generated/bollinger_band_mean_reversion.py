...
A mean reversion strategy using Bollinger Bands to identify overbought/oversold conditions. The AI agent generates specific entry/exit rules based on price deviation from the bands.
    ...
    def on_candle(self, candle: CandleData) -> Signal:
        ...
        if rsi_ready and (current_rsi > 70 or current_rsi < 30) and bb_ready and (candle.close > bb[0] or candle.close < bb[2]):
            ...
            return Signal(
                ...
                tag=f"bollinger_band_mean_reversion_{'bull' if direction == 1 else 'bear'}",
            )
