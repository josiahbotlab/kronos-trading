#!/usr/bin/env python3
"""
Poly Market-Hyperliquid Statistical Arbitrage
=============================================
Auto-generated from: I Built 3 Trading Bots That Run 24/7 (Here's What They Made While I Slept)
Category: mean_reversion
Confidence: 85%

Delta-neutral strategy that copies a target whale wallet (K9 Commandant) trading 5-minute UP/DOWN binary markets on Poly Market, while hedging with an inverse position on Hyperliquid. Creates asymmetric payoff with capped downside on the binary leg.
...
class PolyMarketHyperliquidStatisticalArbi(BaseStrategy):
    name = "poly_market_hyperliquid_statistical_arbi"
    version = "0.1"
    ...
    def on_candle(self, candle: CandleData) -> Signal:
        ...
        if cascade_active:
            ...
            return Signal(
                ...
                tag=f"poly_market_hyperliquid_statistical_arbi_{'bull' if direction == 1 else 'bear'}",
            )
