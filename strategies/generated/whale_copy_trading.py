...
Whale Copy Trading
==================
Auto-generated from: Polymarket Dashboard to See Whale's Trades
Category: momentum
Confidence: 70%

Replicate positions of large traders ('whales') detected through sweep thresholds. Enter markets when individual trades exceed $5,000 (whales) or aggregate sweep activity exceeds $100, filtering out sports and crypto markets to focus on informational institutional flow.
...
class WhaleCopyTrading(BaseStrategy):
    ...
    def default_params(self) -> dict:
        return {
            ...
            "max_history": 300,
            "max_hold_bars": 20,
            "minimum_sweep_count": 1,
            "sweep_threshold_usd": 100,
            "take_profit_pct": 5.0,
    ...
    def on_candle(self, candle: CandleData) -> Signal:
        ...
        if cascade_active:
            ...
            return Signal(
                ...
                tag=f"whale_copy_trading_{'bull' if direction == 1 else 'bear'}",
            )
