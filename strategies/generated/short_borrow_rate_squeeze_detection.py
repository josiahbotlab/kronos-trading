#!/usr/bin/env python3
"""
Short Borrow Rate Squeeze Detection
===================================
Auto-generated from: Claude Code + Public's API: Short Borrow Rates, Retail Sentiment & Edges Nobody's Trading
Category: momentum
Confidence: 80%

Monitor real-time hard-to-borrow rates via API. Spikes in borrow rates serve as leading indicators for impending long and short squeezes. Scan the full instrument universe frequently to detect rate anomalies before they fully price in.
...
class ShortBorrowRateSqueezeDetection(BaseStrategy):
    name = "short_borrow_rate_squeeze_detection"
    version = "0.1"
    ...
    def on_candle(self, candle: CandleData) -> Signal:
        ...
        if cascade_active:
            ...
            return Signal(
                ...
                tag=f"short_borrow_rate_squeeze_detection_{'bull' if direction == 1 else 'bear'}",
            )
