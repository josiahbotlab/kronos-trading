#!/usr/bin/env python3
"""
Sellers Exhaustion Volume-Wick
==============================
Research ID: 343
Category: reversal
Confidence: 70%

A reversal strategy that identifies seller exhaustion through volume analysis and price wicks. Detects potential bottoms when volume spikes occur during consecutive down-closing sequences, indicating capitulation.
...
class Research343SellersExhaustionVolumeWick(BaseStrategy):
    name = "research_343_sellers_exhaustion_volume_wick"
    version = "0.1"
    ...
    def on_candle(self, candle: CandleData) -> Signal:
        ...
        if vol_ratio >= self.get_param('vol_mult'):
            ...
            tag = "research_343_sellers_exhaustion_volume_wick_bull" if direction == 1 else "research_343_sellers_exhaustion_volume_wick_bear"
            return Signal(
                direction=direction,
