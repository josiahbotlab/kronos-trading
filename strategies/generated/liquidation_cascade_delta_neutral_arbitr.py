#!/usr/bin/env python3
"""
Liquidation Cascade Delta-Neutral Arbitrage
===========================================
Auto-generated from: AI Agents Extracting On The Hyperliquid Data Layer
Category: arbitrage
Confidence: 75%

Use liquidation endpoints to detect large liquidations (e.g., $100K+) on Hyperliquid in real-time. Large liquidations trigger aggressive market sells causing momentary price dislocation. Execute delta-neutral trade by taking the liquidation side on Hyperliquid while simultaneously hedging on another exchange (e.g., Bybit, Binance) to capture the spread and earn points.
...
class LiquidationCascadeDeltaNeutralArbitr(BaseStrategy):
    name = "liquidation_cascade_delta_neutral_arbitr"
    version = "0.1"
    ...
    def on_candle(self, candle: CandleData) -> Signal:
        ...
        if cascade_active:
            ...
            return Signal(
                ...
                tag=f"liquidation_cascade_delta_neutral_arbitr_{'bull' if direction == 1 else 'bear'}",
            )
