#!/usr/bin/env python3
"""
Solana Trending Token Scanner
=============================
Auto-generated from: I Built 3 Trading Bots That Run 24/7 (Here's What They Made While I Slept)
Category: momentum
Confidence: 70%

A copy bot that scans the Solana market in real-time to identify trending tokens by monitoring recent trading activity and copying positions from a follow list of wallets. Uses small test trades to validate momentum before escalating to larger trending bots.
...
class SolanaTrendingTokenScanner(BaseStrategy):
    name = "solana_trending_token_scanner"
    version = "0.1"
    ...
    def on_candle(self, candle: CandleData) -> Signal:
        ...
        if ma_ready:
            ...
            return Signal(
                ...
                tag=f"solana_trending_token_scanner_{'bull' if direction == 1 else 'bear'}",
            )
