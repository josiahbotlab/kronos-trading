#!/usr/bin/env python3
"""
Volume-Based Dynamic Exit
=========================
Auto-generated from: Solana Onchain Trading Bot Course (Step by Step in 2025)
Category: scalping
Confidence: 85%

Positions are automatically closed when trading volume 'dies' or drops below a threshold, acting as a stop-loss mechanism to avoid holding through illiquidity or rug pulls. The system tracks volume metrics and exits positions if volume collapses, though the trader notes this sometimes causes premature exits before recoveries.
...
class VolumeBasedDynamicExit(BaseStrategy):
    name = "volume_based_dynamic_exit"
    version = "0.1"
    ...
    def on_candle(self, candle: CandleData) -> Signal:
        ...
        if ma_ready:
            ...
            return Signal(
                ...
                tag=f"volume_based_dynamic_exit_{'bull' if direction == 1 else 'bear'}",
            )
