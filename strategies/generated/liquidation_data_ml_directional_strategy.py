#!/usr/bin/env python3
"""
Liquidation Data ML Directional Strategy
========================================
Auto-generated from: How To Actually Build a Trading Bot in 2025
Category: other
Confidence: 70%

A machine learning approach using Random Forest and LSTM models trained on historical liquidation data to predict short-term price direction (up or down). The strategy involves collecting liquidation data over extended periods (1+ years) to forecast 5-minute, 1-hour, or 4-hour price movements, addressing class imbalance issues through techniques like Dynamic Weighted Focal Loss and SMOTE.
...
class LiquidationDataMlDirectionalStrategy(BaseStrategy):
    name = "liquidation_data_ml_directional_strategy"
    version = "0.1"
    ...
    def on_candle(self, candle: CandleData) -> Signal:
        ...
        if cascade_active:
            ...
            return Signal(
                ...
                tag=f"liquidation_data_ml_directional_strategy_{'bull' if direction == 1 else 'bear'}",
            )
