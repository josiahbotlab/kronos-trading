#!/usr/bin/env python3
"""
5-Minute Timeality Scalping (Long)
==================================
Auto-generated from: Trading Bots Predicting Price & New Polymarket Updates
Category: scalping
Confidence: 85%

Complementary long-only timeality strategy targeting specific accumulation windows. The primary edge occurs on Monday midday (10:21-13:40 UTC) across multiple cryptos and Tuesday afternoon 'power hour' (19:40 UTC) specifically for DOGE, capturing retail accumulation patterns.
...
class 5MinuteTimealityScalping(BaseStrategy):
    name = "5_minute_timeality_scalping"
    version = "0.1"
    ...
    def on_candle(self, candle: CandleData) -> Signal:
        ...
        if cascade_active:
            ...
            return Signal(
                ...
                tag=f"5_minute_timeality_scalping_{'bull' if direction == 1 else 'bear'}",
            )
