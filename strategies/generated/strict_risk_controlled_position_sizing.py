#!/usr/bin/env python3
"""
Strict Risk-Controlled Position Sizing
======================================
Auto-generated from: Quant App As An Always On Risk Manager
Category: other
Confidence: 95%

Systematic risk management framework with hard caps on exposure to prevent martingale-style doubling down. Automatically trims positions if margin exceeds account thresholds and enforces daily loss limits to preserve capital across thousands of trades.
...
class StrictRiskControlledPositionSizing(BaseStrategy):
    name = "strict_risk_controlled_position_sizing"
    version = "0.1"
    ...
    def on_candle(self, candle: CandleData) -> Signal:
        ...
        if ma_ready:
            ...
            return Signal(
                ...
                tag=f"strict_risk_controlled_position_sizing_{'bull' if direction == 1 else 'bear'}",
            )
