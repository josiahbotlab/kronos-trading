...
Adjust trend signal thresholds based on market volatility using ATR. Increase threshold percentage during high volatility to avoid noise.
...
class Research253VolatilityAdjustedSignalThresholds(BaseStrategy):
    name = "research_253_volatility_adjusted_signal_thresholds"
    version = "0.1"
    ...
    def on_candle(self, candle: CandleData) -> Signal:
        ...
        if True:
            ...
            tag = "research_253_volatility_adjusted_signal_thresholds_bull" if direction == 1 else "research_253_volatility_adjusted_signal_thresholds_bear"
            return Signal(
                direction=direction,
