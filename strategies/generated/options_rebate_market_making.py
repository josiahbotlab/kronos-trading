#!/usr/bin/env python3
"""
Options Rebate Market Making
============================
Auto-generated from: Claude Code + Public's API: Short Borrow Rates, Retail Sentiment & Edges Nobody's Trading
Category: scalping
Confidence: 90%

Execute high-frequency options strategies designed to run near break-even. Public pays a $0.65 rebate per contract for adding liquidity, which tips the expected value to positive even on flat trades. Essentially getting paid to provide liquidity.
...
class OptionsRebateMarketMaking(BaseStrategy):
    name = "options_rebate_market_making"
    version = "0.1"
    ...
    def on_candle(self, candle: CandleData) -> Signal:
        ...
        if cascade_active:
            ...
            return Signal(
                ...
                tag=f"options_rebate_market_making_{'bull' if direction == 1 else 'bear'}",
            )
