#!/usr/bin/env python3
"""
Tick-Optimized Limit Execution
==============================
Research ID: 267
Category: scalping
Confidence: 90%

Execute all entries and exits using limit orders only on specific tick levels to minimize fees. Using the 15th tick effectively eliminates fees, while the 1st tick provides faster fills. Market orders are explicitly prohibited.
...
class Research267TickOptimizedLimitExecution(BaseStrategy):
    name = "research_267_tick_optimized_limit_execution"
    version = "0.1"
    ...
    def on_candle(self, candle: CandleData) -> Signal:
        ...
        if True:
            ...
            tag = "research_267_tick_optimized_limit_execution_bull" if direction == 1 else "research_267_tick_optimized_limit_execution_bear"
            return Signal(
                direction=direction,
