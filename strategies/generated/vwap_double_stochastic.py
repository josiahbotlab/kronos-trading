#!/usr/bin/env python3
"""
VWAP + Double Stochastic
========================
Auto-generated from: Clawedbot Internal Quant Zoom Call (Deleting in 72 hours)
Category: mean_reversion
Confidence: 70%

Mean reversion/oversold bounce strategy combining Volume Weighted Average Price with Double Stochastic indicators. Noted as potentially overfit with extremely low trade frequency.
...
class VwapDoubleStochastic(BaseStrategy):
    name = "vwap_double_stochastic"
    version = "0.1"
    ...
    def on_candle(self, candle: CandleData) -> Signal:
        ...
        if rsi_ready and (current_rsi > 70 or current_rsi < 30):
            ...
            return Signal(
                ...
                tag=f"vwap_double_stochastic_{'bull' if direction == 1 else 'bear'}",
            )
