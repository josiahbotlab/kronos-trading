#!/usr/bin/env python3
"""
Edge Market Time Arbitrage
==========================
Auto-generated from: Polymarket Dashboard to See Whale's Trades
Category: other
Confidence: 70%

Trade markets that remain undecided (excluding settled probabilities of 97%/3%) with a focus on those closing within 24 hours. Targets inefficiencies in final price discovery before market resolution.
...
class EdgeMarketTimeArbitrage(BaseStrategy):
    name = "edge_market_time_arbitrage"
    version = "0.1"
    ...
    def on_candle(self, candle: CandleData) -> Signal:
        ...
        if ma_ready:
            ...
            return Signal(
                ...
                tag=f"edge_market_time_arbitrage_{'bull' if direction == 1 else 'bear'}",
            )
