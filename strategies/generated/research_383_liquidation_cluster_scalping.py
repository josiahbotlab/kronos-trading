#!/usr/bin/env python3
"""
Liquidation Cluster Scalping
============================
Research ID: 383
Category: scalping
Confidence: 60%

A short-term directional strategy that enters short positions based on liquidation clusters and 'liquidation bars,' essentially taking over positions from liquidated traders at key liquidation levels.
...
class Research383LiquidationClusterScalping(BaseStrategy):
    name = "research_383_liquidation_cluster_scalping"
    version = "0.1"
    ...
    def on_candle(self, candle: CandleData) -> Signal:
        ...
        if cascade_active:
            ...
            tag = "research_383_liquidation_cluster_scalping_bull" if direction == 1 else "research_383_liquidation_cluster_scalping_bear"
            return Signal(
                direction=direction,
