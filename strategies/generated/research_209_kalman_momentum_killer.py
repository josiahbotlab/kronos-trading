#!/usr/bin/env python3
"""
Kalman Momentum Killer
======================
Research ID: 209
Category: momentum
Confidence: 80%

Short-only strategy that applies Kalman filter to price and calculates the slope/rate of change of the filtered trend. Generates short signals when the Kalman slope turns negative while price remains elevated, catching trend reversals early.
...
class Research209KalmanMomentumKiller(BaseStrategy):
    name = "research_209_kalman_momentum_killer"
    version = "0.1"
    ...
    def on_candle(self, candle: CandleData) -> Signal:
        ...
        if True:
            ...
            tag = "research_209_kalman_momentum_killer_bull" if direction == 1 else "research_209_kalman_momentum_killer_bear"
            return Signal(
                direction=direction,
