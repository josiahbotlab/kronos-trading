#!/usr/bin/env python3
"""
Gradual Position Exit (Chunk Kill)
==================================
Auto-generated from: How To Build a Trading Bot in 2026 (Even If You Can't Code)
Category: other
Confidence: 80%

Close positions gradually over time rather than via single market order, using multiple smaller orders to reduce slippage and market impact.
...
class GradualPositionExit(BaseStrategy):
    name = "gradual_position_exit"
    version = "0.1"
    ...
    def on_candle(self, candle: CandleData) -> Signal:
        ...
        if ma_ready:
            ...
            return Signal(
                ...
                tag=f"gradual_position_exit_{'bull' if direction == 1 else 'bear'}",
            )
