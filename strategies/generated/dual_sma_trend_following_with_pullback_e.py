#!/usr/bin/env python3
"""
Dual SMA Trend Following with Pullback Entries
==============================================
Auto-generated from: i coded a trading bot live.. (293%+ roi)
Category: momentum
Confidence: 95%

A trend-following strategy that uses a 20-day SMA on daily charts to determine market direction (bullish/bearish), then enters trades on pullbacks to a 20-period SMA on the 15-minute chart. Places two limit orders at staggered distances from the 15-min SMA to capture entries on slight deviations. Designed to trade altcoins based on Bitcoin's daily trend, though demonstrated on BTC in the video.
...
class DualSmaTrendFollowingWithPullbackE(BaseStrategy):
    name = "dual_sma_trend_following_with_pullback_e"
    version = "0.1"
    ...
    def on_candle(self, candle: CandleData) -> Signal:
        ...
        if ma_ready:
            ...
            return Signal(
                ...
                tag=f"dual_sma_trend_following_with_pullback_e_{'bull' if direction == 1 else 'bear'}",
            )
