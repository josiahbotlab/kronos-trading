#!/usr/bin/env python3
"""
Adaptive Trend with Kaufman Moving Average
==========================================
Auto-generated from: AI Agents For Finding Winning Trading Strategies
Category: trend_following
Confidence: 70%

Trend following using Kaufman Adaptive Moving Average (KAMA) combined with ATR (Average True Range) for volatility-adjusted trend detection.
...
class AdaptiveTrendWithKaufmanMovingAvera(BaseStrategy):
    name = "adaptive_trend_with_kaufman_moving_avera"
    version = "0.1"
    ...
    def on_candle(self, candle: CandleData) -> Signal:
        ...
        if ma_ready:
            ...
            return Signal(
                ...
                tag=f"adaptive_trend_with_kaufman_moving_avera_{'bull' if direction == 1 else 'bear'}",
            )
