#!/usr/bin/env python3
"""
Liquidation Hunting (High Volume Reversal)
==========================================
Auto-generated from: Trading Bot Course 2025 | Everything You Need To Know
Category: reversal
Confidence: 85%

Mean reversion strategy that triggers entries when large liquidation events occur, indicating forced selling/buying that may create temporary price dislocations. Requires signal buffering/confirmation to avoid catching falling knives.
...
class LiquidationHunting(BaseStrategy):
    name = "liquidation_hunting"
    version = "0.1"
    ...
    def on_candle(self, candle: CandleData) -> Signal:
        ...
        if cascade_active and rsi_ready and (current_rsi > 70 or current_rsi < 30):
            ...
            return Signal(
                ...
                tag=f"liquidation_hunting_{'bull' if direction == 1 else 'bear'}",
            )
