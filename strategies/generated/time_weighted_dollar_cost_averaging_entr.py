#!/usr/bin/env python3
"""
Time-Weighted Dollar-Cost Averaging (DCA) Entry
===============================================
Auto-generated from: How To Build a Trading Bot in 2026 (Even If You Can't Code)
Category: other
Confidence: 80%

Enter positions gradually over a fixed time period in smaller chunks rather than all at once to minimize market impact and remove emotional timing decisions.
...
class TimeWeightedDollarCostAveragingEntr(BaseStrategy):
    name = "time_weighted_dollar_cost_averaging_entr"
    version = "0.1"
    ...
    def on_candle(self, candle: CandleData) -> Signal:
        ...
        if ma_ready:
            ...
            return Signal(
                ...
                tag=f"time_weighted_dollar_cost_averaging_entr_{'bull' if direction == 1 else 'bear'}",
            )
