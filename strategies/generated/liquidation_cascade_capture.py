#!/usr/bin/env python3
"""
Liquidation Cascade Capture
===========================
Auto-generated from: ngl gng quit trading manually after this one vid frfr
Category: momentum
Confidence: 80%

Monitoring real-time liquidation data for large forced liquidations (>$1M) on Hyperliquid and entering contrarian positions when whales are liquidated, assuming the price is 'wrong' due to forced deleveraging rather than organic movement.
...
class LiquidationCascadeCapture(BaseStrategy):
    name = "liquidation_cascade_capture"
    version = "0.1"
    ...
    def on_candle(self, candle: CandleData) -> Signal:
        ...
        if cascade_active:
            ...
            return Signal(
                ...
                tag=f"liquidation_cascade_capture_{'bull' if direction == 1 else 'bear'}",
            )
