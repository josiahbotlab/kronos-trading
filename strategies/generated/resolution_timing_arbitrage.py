...
Exploits price inefficiencies in markets approaching resolution dates. As markets near expiry, uncertainty decreases but emotional trading increases. Strategy buys undervalued outcomes 24-48 hours before resolution when panic selling occurs.
...
class ResolutionTimingArbitrage(BaseStrategy):
    name = "resolution_timing_arbitrage"
    version = "0.1"
    ...
    def on_candle(self, candle: CandleData) -> Signal:
        ...
        if cascade_active:
            ...
            return Signal(
                ...
                tag=f"resolution_timing_arbitrage_{'bull' if direction == 1 else 'bear'}",
            )
