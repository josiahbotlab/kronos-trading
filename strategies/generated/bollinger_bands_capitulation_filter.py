#!/usr/bin/env python3
"""
Bollinger Bands + Capitulation Filter
=====================================
Auto-generated from: Clawdbot For Trading is UNSTOPPABLE (71,057% ROI)
Category: reversal
Confidence: 75%

Combines Bollinger Band signals with volume capitulation filters to avoid catching falling knives. The capitulation filter was noted as potentially too restrictive, killing too many trades.
...
class BollingerBandsCapitulationFilter(BaseStrategy):
    name = "bollinger_bands_capitulation_filter"
    version = "0.1"
    ...
    def on_candle(self, candle: CandleData) -> Signal:
        ...
        # Entry condition
        if bb_ready and (candle.close > bb[0] or candle.close < bb[2]):
            ...
            return Signal(
                ...
                tag=f"bollinger_bands_capitulation_filter_{'bull' if direction == 1 else 'bear'}",
            )
