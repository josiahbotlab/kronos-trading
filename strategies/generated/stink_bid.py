#!/usr/bin/env python3
"""
Stink Bid (Deep Limit Order)
============================
Auto-generated from: ngl gng quit trading manually after this one vid frfr
Category: mean_reversion
Confidence: 90%

Placing limit orders at extreme discounts to current market price (e.g., 3 cents when market price is 50 cents) to catch wicks, flash crashes, or mispricings on prediction markets. On Polymarket, bids are placed at 1-3 cents on binary outcomes with a plan to exit 2 minutes before expiration.
    ...
    def on_candle(self, candle: CandleData) -> Signal:
        ...
        if cascade_active:
            ...
            return Signal(
                ...
                tag=f"stink_bid_{'bull' if direction == 1 else 'bear'}",
            )
