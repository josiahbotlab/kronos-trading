#!/usr/bin/env python3
"""
Liquidation Arbitrage / Liquidation Cascade Buying
==================================================
Auto-generated from: 4 OpenClaws Are Building My Trading Bots Right Now
Category: scalping
Confidence: 85%

Instead of predicting price direction, the strategy predicts which liquidation levels to trade. It monitors liquidation clusters across Hyperliquid, Binance, and OKX, and enters long positions specifically when liquidation cascades occur (when traders get liquidated). Uses high leverage (40x) with strict automated risk controls and tick data for precision entry.
...
class LiquidationArbitrageLiquidationCascad(BaseStrategy):
    name = "liquidation_arbitrage_liquidation_cascad"
    version = "0.1"
    ...
    def on_candle(self, candle: CandleData) -> Signal:
        ...
        if cascade_active:
            ...
            return Signal(
                ...
                tag=f"liquidation_arbitrage_liquidation_cascad_{'bull' if direction == 1 else 'bear'}",
            )
