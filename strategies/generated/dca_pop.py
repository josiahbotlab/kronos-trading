#!/usr/bin/env python3
"""
DCA Pop (SMA Mean Reversion)
============================
Auto-generated from: Claude Code For Aster Trading Bots
Category: mean_reversion
Confidence: 95%

A dollar-cost averaging strategy that layers in bids when price drops below a simple moving average by a specified percentage, operating on the hypothesis of an 'unlimited bid' where pullbacks eventually revert upward. Places multiple limit orders at staggered price levels below the SMA to average into positions during short-term downtrends.
    ...
    def on_candle(self, candle: CandleData) -> Signal:
        ...
        if ma_ready:
            ...
            return Signal(
                ...
                tag=f"dca_pop_{'bull' if direction == 1 else 'bear'}",
            )
