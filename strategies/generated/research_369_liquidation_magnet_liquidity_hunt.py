#!/usr/bin/env python3
"""
Liquidation Magnet/Liquidity Hunt
=================================
Research ID: 369
Category: breakout
Confidence: 90%

A breakout strategy based on the thesis that market makers push price toward large liquidation clusters to maximize liquidations. Enters long when price is 1-2% away from significant short liquidation levels (above price) while avoiding areas near long liquidation levels (below price). Uses liquidation data as 'magnets' and confirms entries with technical pullback.
...
class Research369LiquidationMagnetLiquidityHunt(BaseStrategy):
    name = "research_369_liquidation_magnet_liquidity_hunt"
    version = "0.1"
    ...
    def on_candle(self, candle: CandleData) -> Signal:
        ...
        if cascade_active:
            ...
            tag = "research_369_liquidation_magnet_liquidity_hunt_bull" if direction == 1 else "research_369_liquidation_magnet_liquidity_hunt_bear"
            return Signal(
                direction=direction,
