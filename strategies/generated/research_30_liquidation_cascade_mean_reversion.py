...
Enter or add to positions when significant liquidation events occur, betting that forced liquidations create local price extremes. The strategy involves waiting for large liquidation amounts (e.g., $2M) within short time windows to trigger entries, effectively taking the opposite side of liquidated traders.
...
class Research30LiquidationCascadeMeanReversion(BaseStrategy):
    name = "research_30_liquidation_cascade_mean_reversion"
    version = "0.1"
    ...
    def on_candle(self, candle: CandleData) -> Signal:
        ...
        if cascade_active:
            ...
            tag = "research_30_liquidation_cascade_mean_reversion_bull" if direction == 1 else "research_30_liquidation_cascade_mean_reversion_bear"
            return Signal(
                direction=direction,
