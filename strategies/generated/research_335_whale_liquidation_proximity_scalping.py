#!/usr/bin/env python3
"""
Whale Liquidation Proximity Scalping
====================================
Research ID: 335
Category: momentum
Confidence: 50%

Monitors high-leverage whale positions (top 20-25 largest positions) closest to their liquidation prices to anticipate forced liquidation cascades. Targets positions with liquidation distances as tight as 1.25% to identify imminent liquidation events that could cause rapid price movements.
...
class Research335WhaleLiquidationProximityScalping(BaseStrategy):
    name = "research_335_whale_liquidation_proximity_scalping"
    version = "0.1"
    ...
    def on_candle(self, candle: CandleData) -> Signal:
        ...
        if cascade_active:
            ...
            tag = "research_335_whale_liquidation_proximity_scalping_bull" if direction == 1 else "research_335_whale_liquidation_proximity_scalping_bear"
            return Signal(
                direction=direction,
