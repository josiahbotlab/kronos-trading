#!/usr/bin/env python3
"""
Options Asymmetric Risk (War Exposure)
======================================
Auto-generated from: Claude Chrome Built My WW3 Trading Bot
Category: breakout
Confidence: 75%

Use options instead of futures to capture upside with defined risk. Buy out-of-the-money calls 6-8 weeks out on oil and gold ETFs. Limited downside (premium paid) vs unlimited downside risk in futures, protecting against margin calls on volatile wicks even if ultimate thesis is correct.
...
class OptionsAsymmetricRisk(BaseStrategy):
    name = "options_asymmetric_risk"
    version = "0.1"
    ...
    def on_candle(self, candle: CandleData) -> Signal:
        ...
        if cascade_active:
            ...
            return Signal(
                ...
                tag=f"options_asymmetric_risk_{'bull' if direction == 1 else 'bear'}",
            )
