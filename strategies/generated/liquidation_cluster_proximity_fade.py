#!/usr/bin/env python3
"""
Liquidation Cluster Proximity Fade
==================================
Auto-generated from: Clawbot Trading Bot That Did 7,547%… What's the Catch?
Category: reversal
Confidence: 70%

Mean reversion strategy that fades price moves when liquidations cluster within tight proximity. Contrarian approach that bets on exhaustion after liquidation cascades, particularly effective on BTC 6-hour timeframe.
...
class LiquidationClusterProximityFade(BaseStrategy):
    name = "liquidation_cluster_proximity_fade"
    version = "0.1"
    ...
    def on_candle(self, candle: CandleData) -> Signal:
        ...
        if cascade_active and rsi_ready and (current_rsi > 70 or current_rsi < 30):
            ...
            return Signal(
                ...
                tag=f"liquidation_cluster_proximity_fade_{'bull' if direction == 1 else 'bear'}",
            )
