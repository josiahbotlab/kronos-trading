...
A trend-following strategy that enters long positions when a fast Simple Moving Average crosses above a slow Simple Moving Average. The creator specifically implements this for 4-hour timeframe data on altcoins like HYPE and Housecoin.
...
class Research359SmaCrossoverStrategy(BaseStrategy):
    name = "research_359_sma_crossover_strategy"
    version = "0.1"
    ...
    def on_candle(self, candle: CandleData) -> Signal:
        ...
        if True:
            ...
            tag = "research_359_sma_crossover_strategy_bull" if direction == 1 else "research_359_sma_crossover_strategy_bear"
            return Signal(
                direction=direction,
