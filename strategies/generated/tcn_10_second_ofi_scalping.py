#!/usr/bin/env python3
"""
TCN 10-Second OFI Scalping
==========================
Auto-generated from: how to actually use machine learning in trading bots
Category: scalping
Confidence: 85%

Uses a Temporal Convolutional Network (TCN) trained on Order Flow Imbalance (OFI) features to predict binary price direction (up/down) over a 10-second horizon. The model analyzes sequences of 100 ticks to learn patterns such as OFI rising for five ticks followed by quote churn spikes and depth imbalance shifts.
...
class Tcn10SecondOfiScalping(BaseStrategy):
    name = "tcn_10_second_ofi_scalping"
    version = "0.1"
    ...
    def on_candle(self, candle: CandleData) -> Signal:
        ...
        if cascade_active:
            ...
            return Signal(
                ...
                tag=f"tcn_10_second_ofi_scalping_{'bull' if direction == 1 else 'bear'}",
            )
