...
=====================================
Auto-generated from: OpenAI Trading Bots (Full Course)
Category: mean_reversion
Confidence: 95%

A market-neutral strategy that identifies two historically correlated assets, goes long the underperformer and short the outperformer when their price spread deviates from the historical norm (measured by Z-score), expecting mean reversion. Uses co-integration to validate pair selection and half-life to estimate holding duration.
...
class StatisticalArbitrage(BaseStrategy):
    ...
    def default_params(self) -> dict:
        return {
            ...
            "exit_threshold_zscore": -2.0,
            "max_history": 300,
            "max_hold_bars": 20,
            "mean_reversion_target": 0,
            "rsi_period": 14,
            "take_profit_pct": 5.0,
    ...
    def on_candle(self, candle: CandleData) -> Signal:
        ...
        if rsi_ready and (current_rsi > 70 or current_rsi < 30):
            ...
            return Signal(
                ...
                tag=f"statistical_arbitrage_{'bull' if direction == 1 else 'bear'}",
            )
...
PARAM_RANGES = {
    "entry_threshold_zscore": [
        1.0,
        2.0,
        3.0,
        4.0
    ],
    "exit_threshold_zscore": [
        -1.0,
        -2.0,
        -3.0,
        -4.0
