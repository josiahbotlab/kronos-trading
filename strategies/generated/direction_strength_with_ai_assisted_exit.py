#!/usr/bin/env python3
"""
Direction Strength with AI-Assisted Exit
========================================
Auto-generated from: Claude Sonnet 4.5 But In Charge of 2 Trading Bots (you get the code)
Category: momentum
Confidence: 85%

Entry based on measuring the speed of fill from bid/ask sides to determine market direction strength. When take profit threshold is hit, instead of closing immediately, the bot queries Claude 4.5 with 20 bars of 1-minute data to decide whether to hold for more profit or close. Includes a safety mechanism to force-close if profits drop below a threshold after AI decides to hold.
...
class DirectionStrengthWithAiAssistedExit(BaseStrategy):
    name = "direction_strength_with_ai_assisted_exit"
    version = "0.1"
    ...
    def on_candle(self, candle: CandleData) -> Signal:
        ...
        if cascade_active:
            ...
            return Signal(
                ...
                tag=f"direction_strength_with_ai_assisted_exit_{'bull' if direction == 1 else 'bear'}",
            )
