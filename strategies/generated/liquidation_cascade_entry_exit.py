#!/usr/bin/env python3
"""
Liquidation Cascade Entry/Exit
==============================
Auto-generated from: Everyone wants to Trade with 40x Leverage So i Automated it
Category: scalping
Confidence: 95%

Enter positions when opposing traders get liquidated, taking over their positions at better prices. Scale into trades at specific liquidation volume thresholds rather than entering immediately on directional bias.
...
class LiquidationCascadeEntryExit(BaseStrategy):
    name = "liquidation_cascade_entry_exit"
    version = "0.1"
    ...
    def on_candle(self, candle: CandleData) -> Signal:
        ...
        if cascade_active:
            ...
            return Signal(
                ...
                tag=f"liquidation_cascade_entry_exit_{'bull' if direction == 1 else 'bear'}",
            )
