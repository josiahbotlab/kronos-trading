#!/usr/bin/env python3
"""
Hyperliquid HFT Single-Sided Market Making
==========================================
Auto-generated from: Prediction Market Trading Bot in Python (Polymarket API step by step)
Category: scalping
Confidence: 90%

High-frequency market making strategy using single-sided quoting (bid OR ask, never both simultaneously) to minimize inventory risk. Places orders at top of book and cancels instantly if price moves against position, focusing on capturing maker rebates and half-tick spreads.
...
class HyperliquidHftSingleSidedMarketMaki(BaseStrategy):
    name = "hyperliquid_hft_single_sided_market_maki"
    version = "0.1"
    ...
    def on_candle(self, candle: CandleData) -> Signal:
        ...
        if cascade_active:
            ...
            return Signal(
                ...
                tag=f"hyperliquid_hft_single_sided_market_maki_{'bull' if direction == 1 else 'bear'}",
            )
