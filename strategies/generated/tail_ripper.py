...
An intraday momentum strategy implemented using stock index futures that generates returns during extreme market moves (tail events/crisis periods). It exhibits a convex payoff profile (long volatility) and never holds positions overnight.
    ...
    def on_candle(self, candle: CandleData) -> Signal:
        ...
        if cascade_active:
            ...
            return Signal(
                ...
                tag=f"tail_ripper_{'bull' if direction == 1 else 'bear'}",
            )
