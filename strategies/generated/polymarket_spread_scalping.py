#!/usr/bin/env python3
"""
Polymarket Spread Scalping (Bid-Ask Capture)
============================================
Auto-generated from: Prediction Market Trading Bot in Python (Polymarket API step by step)
Category: scalping
Confidence: 95%

Automated market making strategy that scans for wide bid-ask spreads on Polymarket prediction markets. Places limit buy orders at the best bid price and sets limit sell orders at a fixed percentage above entry to capture the spread, while earning additional CLOB liquidity rewards.
...
class PolymarketSpreadScalping(BaseStrategy):
    name = "polymarket_spread_scalping"
    version = "0.1"
    ...
    def on_candle(self, candle: CandleData) -> Signal:
        ...
        if cascade_active:
            ...
            return Signal(
                ...
                tag=f"polymarket_spread_scalping_{'bull' if direction == 1 else 'bear'}",
            )
