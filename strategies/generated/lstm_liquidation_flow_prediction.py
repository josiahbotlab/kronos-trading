#!/usr/bin/env python3
"""
LSTM Liquidation Flow Prediction
================================
Auto-generated from: Beginner’s ML 4 Trading Guide (Better than AI)
Category: scalping
Confidence: 85%

Uses LSTM neural networks trained on tick-level liquidation data to forecast very short-term BTC price moves. The model processes sequential patterns in liquidation volume, buy/sell imbalances, and velocity to predict directional moves with a specific lookback window, requiring entry confirmation signals and accounting for slippage costs.
...
class LstmLiquidationFlowPrediction(BaseStrategy):
    name = "lstm_liquidation_flow_prediction"
    version = "0.1"
    ...
    def on_candle(self, candle: CandleData) -> Signal:
        ...
        if cascade_active:
            ...
            return Signal(
                ...
                tag=f"lstm_liquidation_flow_prediction_{'bull' if direction == 1 else 'bear'}",
            )
