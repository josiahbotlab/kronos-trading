...
Use adaptive moving average filters that adjust based on market efficiency. Calculate Efficiency Ratio (ER) to measure trend strength and adjust signals accordingly.
...
class Research254KaufmanAdaptiveMovingAverage(BaseStrategy):
    name = "research_254_kaufman_adaptive_moving_average"
    version = "0.1"
    ...
    def on_candle(self, candle: CandleData) -> Signal:
        ...
        if True:
            ...
            tag = "research_254_kaufman_adaptive_moving_average_bull" if direction == 1 else "research_254_kaufman_adaptive_moving_average_bear"
            return Signal(
                direction=direction,
