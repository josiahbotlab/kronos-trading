...
Trend-following strategy using Parabolic SAR signals. Long-only variations showed significantly better performance than long/short combinations in crypto markets.
...
class ParabolicSarTrendFollowing(BaseStrategy):
    ...
    def on_candle(self, candle: CandleData) -> Signal:
        ...
        if cascade_active:
            ...
            return Signal(
                ...
                tag=f"parabolic_sar_trend_following_{'bull' if direction == 1 else 'bear'}",
            )
