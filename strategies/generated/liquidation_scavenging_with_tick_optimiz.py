#!/usr/bin/env python3
"""
Liquidation Scavenging with Tick Optimization
=============================================
Auto-generated from: Hyperliquid's Trillion Dollar Problem? I Built the Fix.
Category: scalping
Confidence: 90%

An automated scalping strategy that enters positions when liquidation events occur (taking over liquidated positions), using 40x leverage without predicting price direction. Entries use limit orders at specific tick levels rather than market orders to minimize fees.
...
class LiquidationScavengingWithTickOptimiz(BaseStrategy):
    name = "liquidation_scavenging_with_tick_optimiz"
    version = "0.1"
    ...
    def on_candle(self, candle: CandleData) -> Signal:
        ...
        if cascade_active:
            ...
            return Signal(
                ...
                tag=f"liquidation_scavenging_with_tick_optimiz_{'bull' if direction == 1 else 'bear'}",
            )
