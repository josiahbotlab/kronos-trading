#!/usr/bin/env python3
"""
Pure Liquidation Momentum (Continuation)
========================================
Auto-generated from: $1.7 Billion Liquidated So I'm Building A Liquidation Bot
Category: momentum
Confidence: 85%

Trade in the direction of liquidation pressure - sell when large long liquidations occur and buy when large short liquidations occur, assuming momentum continuation after the initial cascade.
...
class PureLiquidationMomentum(BaseStrategy):
    name = "pure_liquidation_momentum"
    version = "0.1"
    ...
    def default_params(self) -> dict:
        return {
            ...
            "max_history": 300,
            "max_hold_bars": 20,
            "minimum_liquidation_size": 500000,
            "take_profit": 0.01,
            "take_profit_pct": 5.0,
    ...
    def on_candle(self, candle: CandleData) -> Signal:
        ...
        if cascade_active:
            ...
            return Signal(
                ...
                tag=f"pure_liquidation_momentum_{'bull' if direction == 1 else 'bear'}",
            )
