#!/usr/bin/env python3
"""
HLP Sentiment Z-Score Reversal
==============================
Auto-generated from: Clawdbot For Trading is UNSTOPPABLE (71,057% ROI)
Category: reversal
Confidence: 95%

A reversal strategy using Hyperliquid (HLP) sentiment data with Z-score calculations to identify extreme retail positioning. When retail is heavily long (Z-score < -2), it signals potential short squeeze conditions; when heavily short (Z-score > +2), it signals potential long squeeze conditions.
...
class HlpSentimentZScoreReversal(BaseStrategy):
    name = "hlp_sentiment_z_score_reversal"
    version = "0.1"
    ...
    def default_params(self) -> dict:
        return {
            ...
            "z_score_long_threshold": -2,
            "z_score_short_threshold": 2,
        }
    ...
    def on_candle(self, candle: CandleData) -> Signal:
        ...
        if cascade_active:
            ...
            return Signal(
                ...
                tag=f"hlp_sentiment_z_score_reversal_{'bull' if direction == 1 else 'bear'}",
            )
