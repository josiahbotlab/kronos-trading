#!/usr/bin/env python3
"""
Supply and Demand Zones (1-Minute)
==================================
Research ID: 310
Category: scalping
Confidence: 90%

Scalping strategy based on 1-minute demand zones for long entries and supply zones for exits. Uses fair value gaps on 1-minute charts with specific lookback periods and buffer zones to determine entry/exit points.
...
class Research310SupplyAndDemandZones(BaseStrategy):
    name = "research_310_supply_and_demand_zones"
    version = "0.1"
    ...
    def on_candle(self, candle: CandleData) -> Signal:
        ...
        if True:
            ...
            tag = "research_310_supply_and_demand_zones_bull" if direction == 1 else "research_310_supply_and_demand_zones_bear"
            return Signal(
                direction=direction,
