#!/usr/bin/env python3
"""
Liquidation-Based Reversal Scalping
===================================
Auto-generated from: How To Actually Automate Your Trading in 2026 (WATCH BEFORE ZOOM)
Category: scalping
Confidence: 70%

A scalping approach that monitors real-time liquidation data to identify when traders are 0.3% away from liquidation levels. Strategy anticipates that Wall Street/market makers target these liquidation clusters in low liquidity environments, allowing quant traders to position accordingly.
...
class LiquidationBasedReversalScalping(BaseStrategy):
    name = "liquidation_based_reversal_scalping"
    version = "0.1"
    ...
    def on_candle(self, candle: CandleData) -> Signal:
        ...
        if cascade_active:
            ...
            return Signal(
                ...
                tag=f"liquidation_based_reversal_scalping_{'bull' if direction == 1 else 'bear'}",
            )
