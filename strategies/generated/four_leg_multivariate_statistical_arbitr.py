#!/usr/bin/env python3
"""
Four-Leg Multivariate Statistical Arbitrage
===========================================
Auto-generated from: I Let 3x OpenAI Codex Build 4 Arbitrage Bots Live
Category: mean_reversion
Confidence: 75%

Multivariate arbitrage using two partner assets to price a single target asset's mispricing. Instead of trading both sides of a pair, it models the target asset's fair value based on two correlated partners and trades only the target asset when mispricing occurs.
...
class FourLegMultivariateStatisticalArbitr(BaseStrategy):
    name = "four_leg_multivariate_statistical_arbitr"
    version = "0.1"
    ...
    def on_candle(self, candle: CandleData) -> Signal:
        ...
        if cascade_active:
            ...
            return Signal(
                ...
                tag=f"four_leg_multivariate_statistical_arbitr_{'bull' if direction == 1 else 'bear'}",
            )
