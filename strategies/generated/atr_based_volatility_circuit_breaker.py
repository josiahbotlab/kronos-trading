#!/usr/bin/env python3
"""
ATR-Based Volatility Circuit Breaker
====================================
Auto-generated from: Claude Code Just Changed Algorithmic Trading Forever
Category: other
Confidence: 95%

A risk management overlay that calculates the Average True Range (ATR) over a 120-minute baseline period and compares it to the recent 5-minute ATR. If recent volatility exceeds 2x the baseline ATR, the bot cancels all open orders, closes all positions at market, and enters a sleep period to avoid trading during volatile events like news releases or strong trending moves.
...
class AtrBasedVolatilityCircuitBreaker(BaseStrategy):
    name = "atr_based_volatility_circuit_breaker"
    version = "0.1"

    def default_params(self) -> dict:
        return {
            "atr_long_term_lookback_minutes": 120,
            "atr_multiplier_threshold": 2.0,
            "atr_short_term_lookback_minutes": 5,
            "cooldown_bars": 5,
            "entry_strength": 0.8,
            "liq_percentile": 85,
            "max_history": 300,
            ...
            "volatility_check_interval_seconds": 60,
        }
    ...
    def on_candle(self, candle: CandleData) -> Signal:
        ...
        if cascade_active:
            ...
            return Signal(
                ...
                tag=f"atr_based_volatility_circuit_breaker_{'bull' if direction == 1 else 'bear'}",
            )
...
PARAM_RANGES = {
    "atr_long_term_lookback_minutes": [
        60,
        120,
        240
    ],
    "atr_short_term_lookback_minutes": [
        2,
        5,
        10
    ],
