#!/usr/bin/env python3
"""
Time-Based Scaled Entry (Liquidation Scale-In)
==============================================
Research ID: 394
Category: scalping
Confidence: 75%

A scaling strategy that enters liquidation-based positions gradually over time rather than all at once. After a liquidation trigger, it distributes entries evenly across 1-4 hour windows and closes positions after specified hold periods.
...
class Research394TimeBasedScaledEntry(BaseStrategy):
    name = "research_394_time_based_scaled_entry"
    version = "0.1"
    ...
    def on_candle(self, candle: CandleData) -> Signal:
        ...
        if cascade_active:
            ...
            tag = "research_394_time_based_scaled_entry_bull" if direction == 1 else "research_394_time_based_scaled_entry_bear"
            return Signal(
                direction=direction,
