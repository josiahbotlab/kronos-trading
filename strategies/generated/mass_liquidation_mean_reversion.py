#!/usr/bin/env python3
"""
Mass Liquidation Mean Reversion
===============================
Auto-generated from: The Market Isn't Crashing. You're Just Getting Harvested.
Category: mean_reversion
Confidence: 70%

Take contrarian positions after extreme liquidation events expecting price reversal. When mass liquidations occur (e.g., $10 million), trade against the liquidation direction anticipating that forced selling/buying pressure is exhausted and price will reverse.
...
class MassLiquidationMeanReversion(BaseStrategy):
    name = "mass_liquidation_mean_reversion"
    version = "0.1"
    ...
    def on_candle(self, candle: CandleData) -> Signal:
        ...
        if cascade_active:
            ...
            return Signal(
                ...
                tag=f"mass_liquidation_mean_reversion_{'bull' if direction == 1 else 'bear'}",
            )
