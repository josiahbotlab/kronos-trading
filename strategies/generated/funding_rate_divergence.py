...
A strategy that compares funding rates between Hyperliquid and Binance along with Open Interest changes. Negative funding on Binance indicates market asking for buyers, suggesting potential long entries, while monitoring OI for confirmation.
...
class FundingRateDivergence(BaseStrategy):
    ...
    def on_candle(self, candle: CandleData) -> Signal:
        ...
        if cascade_active:
            ...
            return Signal(
                ...
                tag=f"funding_rate_divergence_{'bull' if direction == 1 else 'bear'}",
            )
