#!/usr/bin/env python3
"""
Lick Stink OG (Liquidation Continuation)
========================================
Auto-generated from: Claude Opus Found a Polymarket Edge No One Is Talking About
Category: momentum
Confidence: 90%

A binary options strategy for Polymarket 5-minute markets that trades continuation after liquidation events. The bot monitors liquidation data from Hyperliquid, Binance, and Bybit to determine directional bias and enters positions based on liquidation cascades.
...
class LickStinkOg(BaseStrategy):
    name = "lick_stink_og"
    version = "0.1"
    ...
    def on_candle(self, candle: CandleData) -> Signal:
        ...
        if cascade_active:
            ...
            return Signal(
                ...
                tag=f"lick_stink_og_{'bull' if direction == 1 else 'bear'}",
            )
