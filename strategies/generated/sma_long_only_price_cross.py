#!/usr/bin/env python3
"""
SMA Long-Only Price Cross
=========================
Auto-generated from: AI Agents That Trade (open sourced)
Category: momentum
Confidence: 80%

Long-only variation where entries are triggered when price crosses above a specified SMA period, and exits occur when price crosses below the same SMA. The strategy specifically tested SMA periods of 10, 20, 30, and 40 on 4-hour and daily charts to find optimal parameters for trending assets.
...
class SmaLongOnlyPriceCross(BaseStrategy):
    name = "sma_long_only_price_cross"
    version = "0.1"
    ...
    def on_candle(self, candle: CandleData) -> Signal:
        ...
        if ma_ready:
            ...
            return Signal(
                ...
                tag=f"sma_long_only_price_cross_{'bull' if direction == 1 else 'bear'}",
            )
