#!/usr/bin/env python3
"""
Polymarket 5-Minute Scalping with Micro Sizing
==============================================
Auto-generated from: Claude + Polymarket = Free Money? (Full Bot Tutorial)
Category: scalping
Confidence: 80%

High-frequency approach to 5-minute binary option markets using minimum position sizes ($1 on Polymarket, $10 on Hyperliquid) for incubation before scaling. Emphasizes using limit orders exclusively to avoid fees (3x cheaper than market orders) and prevents liquidation risk present in traditional leverage trading.
...
class Polymarket5MinuteScalpingWithMicro(BaseStrategy):
    name = "polymarket_5_minute_scalping_with_micro_"
    version = "0.1"
    ...
    def on_candle(self, candle: CandleData) -> Signal:
        ...
        if cascade_active:
            ...
            return Signal(
                ...
                tag=f"polymarket_5_minute_scalping_with_micro__{'bull' if direction == 1 else 'bear'}",
            )
