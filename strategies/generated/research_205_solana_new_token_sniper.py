...
An automated scalping strategy that monitors Birdeye API for newly launched Solana meme tokens, filtering by market cap and liquidity metrics to buy immediately at launch with small position sizes and exit quickly on momentum.
...
class Research205SolanaNewTokenSniper(BaseStrategy):
    name = "research_205_solana_new_token_sniper"
    version = "0.1"
    ...
    def on_candle(self, candle: CandleData) -> Signal:
        ...
        if True:
            ...
            tag = "research_205_solana_new_token_sniper_bull" if direction == 1 else "research_205_solana_new_token_sniper_bear"
            return Signal(
                direction=direction,
