#!/usr/bin/env python3
"""
Scaled Position Building
========================
Auto-generated from: Everyone wants to Trade with 40x Leverage So i Automated it
Category: scalping
Confidence: 90%

Build positions incrementally rather than all at once to avoid buying/selling too early. Use percentage-based scaling to manage high leverage.
...
class ScaledPositionBuilding(BaseStrategy):
    name = "scaled_position_building"
    version = "0.1"
    ...
    def on_candle(self, candle: CandleData) -> Signal:
        ...
        if cascade_active:
            ...
            return Signal(
                ...
                tag=f"scaled_position_building_{'bull' if direction == 1 else 'bear'}",
            )
