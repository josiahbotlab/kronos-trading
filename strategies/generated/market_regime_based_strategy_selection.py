...
======================================
Auto-generated from: how to actually build a trading bot
Category: other
Confidence: 70%

A meta-strategy framework that identifies different market regimes (bull, bear, ranging, high/low volatility) and applies specific strategy types to each regime. Specifically mentions using breakout/trend-following strategies for bull markets and mean reversion for ranging markets.
...
class MarketRegimeBasedStrategySelection(BaseStrategy):
    name = "market_regime_based_strategy_selection"
    version = "0.1"
    ...
    def on_candle(self, candle: CandleData) -> Signal:
        ...
        if rsi_ready:
            ...
            return Signal(
                ...
                tag=f"market_regime_based_strategy_selection_{'bull' if direction == 1 else 'bear'}",
            )
