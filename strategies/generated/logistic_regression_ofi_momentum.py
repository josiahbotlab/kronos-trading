#!/usr/bin/env python3
"""
Logistic Regression OFI Momentum
================================
Auto-generated from: how to actually use machine learning in trading bots
Category: scalping
Confidence: 70%

Fast-training logistic regression model (2-3 minutes) using enhanced OFI V2 features to predict 5-second and 30-second price returns. Uses binary classification (up/down) rather than price regression.
...
class LogisticRegressionOfiMomentum(BaseStrategy):
    name = "logistic_regression_ofi_momentum"
    version = "0.1"
    ...
    def on_candle(self, candle: CandleData) -> Signal:
        ...
        if cascade_active:
            ...
            return Signal(
                ...
                tag=f"logistic_regression_ofi_momentum_{'bull' if direction == 1 else 'bear'}",
            )
