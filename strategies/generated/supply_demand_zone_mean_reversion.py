#!/usr/bin/env python3
"""
Supply/Demand Zone Mean Reversion
=================================
Auto-generated from: The $500,000,000 Trading Bot
Category: mean_reversion
Confidence: 75%

Strategy utilizing supply and demand zones calculated from recent price action. Enters trades when price reaches these zones expecting mean reversion. Showed profitability in backtests with specific risk parameters.
...
class SupplyDemandZoneMeanReversion(BaseStrategy):
    name = "supply_demand_zone_mean_reversion"
    version = "0.1"
    ...
    def on_candle(self, candle: CandleData) -> Signal:
        ...
        if rsi_ready and (current_rsi > 70 or current_rsi < 30) and ma_ready:
            ...
            return Signal(
                ...
                tag=f"supply_demand_zone_mean_reversion_{'bull' if direction == 1 else 'bear'}",
            )
