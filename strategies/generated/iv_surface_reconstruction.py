...
Reconstruct the full implied volatility surface by batching requests (250 contracts per call). Detect skew anomalies, term structure inversions, and unusual open interest build-up systematically using options Greeks data.
...
class IvSurfaceReconstruction(BaseStrategy):
    name = "iv_surface_reconstruction"
    version = "0.1"
    ...
    def on_candle(self, candle: CandleData) -> Signal:
        ...
        if rsi_ready and (current_rsi > 70 or current_rsi < 30) and ma_ready:
            ...
            return Signal(
                ...
                tag=f"iv_surface_reconstruction_{'bull' if direction == 1 else 'bear'}",
            )
