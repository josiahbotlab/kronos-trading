#!/usr/bin/env python3
"""
QQE RSI Multi-Indicator System
==============================
Auto-generated from: From ZERO to ALGO TRADER in 2024 - Step By Step (FULL COURSE)
Category: other
Confidence: 70%

Converted from Pine Script, this strategy uses RSI with Wilder's smoothing, ATR calculations, and QQE (Quantitative Qualitative Estimation) indicators. Sets trend based on RSI crossovers and calculates dynamic bands (long/short bands) based on ATR RSI values.
...
class QqeRsiMultiIndicatorSystem(BaseStrategy):
    name = "qqe_rsi_multi_indicator_system"
    version = "0.1"
    ...
    def on_candle(self, candle: CandleData) -> Signal:
        ...
        if rsi_ready:
            ...
            return Signal(
                ...
                tag=f"qqe_rsi_multi_indicator_system_{'bull' if direction == 1 else 'bear'}",
            )
