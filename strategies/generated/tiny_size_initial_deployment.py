#!/usr/bin/env python3
"""
Tiny Size Initial Deployment
============================
Auto-generated from: ai agents that actually find profitable trading strategies
Category: risk_management
Confidence: 80%

When implementing a new strategy that has shown profitability in backtests, deploy with minimal position sizing ('tiny size') for initial live testing rather than large capital allocation. Avoid deploying large amounts (e.g., $10K) on untested strategies.
...
class TinySizeInitialDeployment(BaseStrategy):
    name = "tiny_size_initial_deployment"
    version = "0.1"
    ...
    def on_candle(self, candle: CandleData) -> Signal:
        ...
        if cascade_active:
            ...
            return Signal(
                ...
                tag=f"tiny_size_initial_deployment_{'bull' if direction == 1 else 'bear'}",
            )
