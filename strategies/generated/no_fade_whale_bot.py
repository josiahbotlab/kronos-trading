#!/usr/bin/env python3
"""
No Fade Whale Bot (Polymarket Mean Reversion)
=============================================
Auto-generated from: claude opus 4.5 for polymarket is life changing
Category: mean_reversion
Confidence: 90%

Automated mean reversion strategy for Polymarket prediction markets that fades large YES price spikes. Based on the thesis that 80% of markets resolve to NO, the bot monitors for whale buying activity that spikes YES prices and enters NO positions to capture the statistical edge when irrational exuberance reverts.
...
class NoFadeWhaleBot(BaseStrategy):
    name = "no_fade_whale_bot"
    version = "0.1"
    ...
    def on_candle(self, candle: CandleData) -> Signal:
        ...
        if rsi_ready and (current_rsi > 70 or current_rsi < 30):
            ...
            return Signal(
                ...
                tag=f"no_fade_whale_bot_{'bull' if direction == 1 else 'bear'}",
            )
