#!/usr/bin/env python3
"""
Long-Only SMA Price Cross
=========================
Research ID: 360
Category: momentum
Confidence: 80%

A long-only variation where entries occur when price crosses above the 20-period SMA and positions are closed when price falls below the SMA. Designed for assets that cannot be shorted easily.
...
class Research360LongOnlySmaPriceCross(BaseStrategy):
    name = "research_360_long_only_sma_price_cross"
    version = "0.1"
    ...
    def on_candle(self, candle: CandleData) -> Signal:
        ...
        if True:
            ...
            tag = "research_360_long_only_sma_price_cross_bull" if direction == 1 else "research_360_long_only_sma_price_cross_bear"
            return Signal(
                direction=direction,
