#!/usr/bin/env python3
"""
Lick Momentum (Liquidation Momentum)
====================================
Auto-generated from: Clawedbot Internal Quant Zoom Call (Deleting in 72 hours)
Category: scalping
Confidence: 80%

Scalping/momentum strategy trading Solana based on liquidation data with reversal protection filters. Currently underperforming due to asymmetrical win/loss sizes.
...
class LickMomentum(BaseStrategy):
    name = "lick_momentum"
    version = "0.1"
    ...
    def on_candle(self, candle: CandleData) -> Signal:
        ...
        if cascade_active:
            ...
            return Signal(
                ...
                tag=f"lick_momentum_{'bull' if direction == 1 else 'bear'}",
            )
