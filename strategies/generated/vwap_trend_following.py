...
====================
Auto-generated from: MEXC Trading BOT (Step By Step Tutorial)
Category: momentum
Confidence: 85%

A trend-following algorithm that enters long positions when Ethereum price trades above the Volume Weighted Average Price (VWAP) indicator and exits positions when price falls below the VWAP. The strategy uses market orders for execution on the MEXC exchange.
...
class VwapTrendFollowing(BaseStrategy):
    name = "vwap_trend_following"
    version = "0.1"
    ...
    def on_candle(self, candle: CandleData) -> Signal:
        ...
        if cascade_active:
            ...
            return Signal(
                ...
                tag=f"vwap_trend_following_{'bull' if direction == 1 else 'bear'}",
            )
