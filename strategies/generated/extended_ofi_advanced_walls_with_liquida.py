#!/usr/bin/env python3
"""
Extended OFI Advanced Walls with Liquidation Filter
===================================================
Auto-generated from: everything a new algo trader wish they knew
Category: scalping
Confidence: 95%

High-frequency trading strategy that uses liquidation volume as a volatility filter. The bot monitors aggregate liquidations over a 10-minute window and only executes trades when liquidation volume is below $500K, avoiding high-volatility 'chop' periods. Position monitoring for existing trades (TP/SL) continues regardless of liquidation levels.
...
class ExtendedOfiAdvancedWallsWithLiquida(BaseStrategy):
    name = "extended_ofi_advanced_walls_with_liquida"
    version = "0.1"
    ...
    def default_params(self) -> dict:
        return {
            ...
            "liquidation_threshold_usd": 500000,
            "lookback_bars": 300,
            "lookback_period_minutes": 10,
            "max_history": 300,
            "max_hold_bars": 20,
            "take_profit_pct": 5.0,
            "trading_window_minutes": 5,
    ...
    def on_candle(self, candle: CandleData) -> Signal:
        ...
        if cascade_active:
            ...
            return Signal(
                ...
                tag=f"extended_ofi_advanced_walls_with_liquida_{'bull' if direction == 1 else 'bear'}",
            )
