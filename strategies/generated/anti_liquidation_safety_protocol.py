#!/usr/bin/env python3
"""
Anti-Liquidation Safety Protocol
================================
Auto-generated from: $20 Billion Liquidated So I Built Some HFT Trading Bots
Category: other
Confidence: 90%

Risk management overlay applied to all bots that monitors aggregate liquidation volume across the market. When liquidations exceed 250k threshold, all trading activity is suspended (kill switch) to prevent trading during extreme volatility and cascade liquidation events.
...
class AntiLiquidationSafetyProtocol(BaseStrategy):
    name = "anti_liquidation_safety_protocol"
    version = "0.1"
    ...
    def default_params(self) -> dict:
        return {
            ...
            "liquidation_trigger_threshold": 250000,
            "lookback_bars": 300,
            "max_history": 300,
            "max_hold_bars": 20,
            "take_profit_pct": 5.0,
    ...
    def on_candle(self, candle: CandleData) -> Signal:
        ...
        if cascade_active:
            ...
            return Signal(
                ...
                tag=f"anti_liquidation_safety_protocol_{'bull' if direction == 1 else 'bear'}",
            )
