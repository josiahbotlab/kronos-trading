#!/usr/bin/env python3
"""
Liquidation-Based Mean Reversion Entry
======================================
Research ID: 121
Category: mean_reversion
Confidence: 90%

Enter long positions when large short liquidations occur (forced selling) and enter short positions when large long liquidations occur. Instead of predicting price direction, the strategy waits for liquidation cascades to trigger entries at what are presumed to be local extremes. Uses real-time liquidation data from Hyperliquid nodes.
...
class Research121LiquidationBasedMeanReversionEntry(BaseStrategy):
    name = "research_121_liquidation_based_mean_reversion_entry"
    version = "0.1"
    ...
    def on_candle(self, candle: CandleData) -> Signal:
        ...
        if cascade_active:
            ...
            tag = "research_121_liquidation_based_mean_reversion_entry_bull" if direction == 1 else "research_121_liquidation_based_mean_reversion_entry_bear"
            return Signal(
                direction=direction,
