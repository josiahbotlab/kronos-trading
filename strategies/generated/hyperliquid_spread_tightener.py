#!/usr/bin/env python3
"""
Hyperliquid Spread Tightener
============================
Auto-generated from: I Ran 3 Claude Bots on Polymarket | Here's What They Are
Category: scalping
Confidence: 85%

Acts as a market maker on Hyperliquid 5-minute crypto up/down markets by placing simultaneous bids and asks to capture the bid-ask spread, with a specific time restriction to avoid end-of-period volatility.
...
class HyperliquidSpreadTightener(BaseStrategy):
    name = "hyperliquid_spread_tightener"
    version = "0.1"
    ...
    def on_candle(self, candle: CandleData) -> Signal:
        ...
        if cascade_active:
            ...
            return Signal(
                ...
                tag=f"hyperliquid_spread_tightener_{'bull' if direction == 1 else 'bear'}",
            )
