#!/usr/bin/env python3
"""
Solana Micro-Cap New Token Sniper
=================================
Research ID: 96
Category: scalping
Confidence: 85%

Automated filtering strategy that scans the Solana blockchain for newly launched meme coins with market caps under $20K. Identifies brand new tokens by filtering for null/empty 24-hour price change data, indicating a launch within the last 24 hours. Uses extremely small position sizes ($5-10) to mitigate the high risk of rugs while attempting to enter before the initial pump occurs.
...
class Research96SolanaMicroCapNewTokenSniper(BaseStrategy):
    name = "research_96_solana_micro_cap_new_token_sniper"
    version = "0.1"
    ...
    def default_params(self) -> dict:
        return {
            "cooldown_bars": 12,
            "entry_strength": 0.8,
            "initial_scan_count": 15000,
            "market_cap_threshold_usd": 20000,
            "max_history": 500,
            "max_hold_bars": 60,
            "sma_fast": 10,
            "sma_slow": 30,
    ...
    def on_candle(self, candle: CandleData) -> Signal:
        ...
        if True:
            ...
            tag = "research_96_solana_micro_cap_new_token_sniper_bull" if direction == 1 else "research_96_solana_micro_cap_new_token_sniper_bear"
            return Signal(
                direction=direction,
