#!/usr/bin/env python3
"""
Bid-Ask Pressure Testing
========================
Auto-generated from: Sonnet 4.5 DOUBLED my trading bot's performance
Category: momentum
Confidence: 85%

Pre-trade validation mechanism that places small test orders on both sides of the order book to determine directional bias before committing full capital. If test bid fills, indicates selling pressure; if test ask fills, indicates buying pressure. Includes range filtering to avoid low-probability setups.
...
class BidAskPressureTesting(BaseStrategy):
    name = "bid_ask_pressure_testing"
    version = "0.1"
    ...
    def on_candle(self, candle: CandleData) -> Signal:
        ...
        if ma_ready:
            ...
            return Signal(
                ...
                tag=f"bid_ask_pressure_testing_{'bull' if direction == 1 else 'bear'}",
            )
