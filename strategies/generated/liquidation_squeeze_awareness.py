#!/usr/bin/env python3
"""
Liquidation Squeeze Awareness
=============================
Auto-generated from: we can now short meme coins to 0..
Category: momentum
Confidence: 75%

Risk management and opportunity identification based on monitoring liquidation cascades. Recognizes that shorting creates liquidation levels that, when triggered, cause forced buying pressure and rapid price increases (short squeezes), particularly relevant when shorting low-liquidity meme coins.
...
class LiquidationSqueezeAwareness(BaseStrategy):
    name = "liquidation_squeeze_awareness"
    version = "0.1"
    ...
    def on_candle(self, candle: CandleData) -> Signal:
        ...
        if cascade_active:
            ...
            return Signal(
                ...
                tag=f"liquidation_squeeze_awareness_{'bull' if direction == 1 else 'bear'}",
            )
