#!/usr/bin/env python3
"""
AI Swarm Long-Only Dip Entry
============================
Auto-generated from: i gave ai $10,000 to trade for me...
Category: mean_reversion
Confidence: 85%

A long-only mean reversion strategy that enters pullbacks only after technical conditions align and a committee of 6 AI agents provides consensus approval. The strategy filters for oversold conditions within the recent price range before requesting AI validation.
...
class AiSwarmLongOnlyDipEntry(BaseStrategy):
    name = "ai_swarm_long_only_dip_entry"
    version = "0.1"
    ...
    def on_candle(self, candle: CandleData) -> Signal:
        ...
        if rsi_ready and (current_rsi > 70 or current_rsi < 30):
            ...
            return Signal(
                ...
                tag=f"ai_swarm_long_only_dip_entry_{'bull' if direction == 1 else 'bear'}",
            )
