#!/usr/bin/env python3
"""
20/40 SMA Momentum Strategy with 5-Day Hold
===========================================
Auto-generated from: How To Use OpenAI to build a Trading Bot (ChatGPT ai)
Category: momentum
Confidence: 85%

A trend-following strategy that buys Bitcoin when price crosses above the 20-period Simple Moving Average (SMA), holds the position for a mandatory 5-day period, and exits when price drops below the 40-period SMA. The strategy enforces a single open position at a time by checking account balance before entering new trades.
...
class 2040SmaMomentumStrategyWith5DayH(BaseStrategy):
    name = "20_40_sma_momentum_strategy_with_5_day_h"
    version = "0.1"
    ...
    def on_candle(self, candle: CandleData) -> Signal:
        ...
        if ma_ready:
            ...
            return Signal(
                ...
                tag=f"20_40_sma_momentum_strategy_with_5_day_h_{'bull' if direction == 1 else 'bear'}",
            )
