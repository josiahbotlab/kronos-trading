#!/usr/bin/env python3
"""
Extended SDZ 5-Second No Licks
==============================
Auto-generated from: High Frequency Trading with OFI & Liquidations
Category: scalping
Confidence: 90%

Supply Demand Zone (SDZ) scalping strategy operating on 5-second timeframe with liquidation filtering. Inherits the 'no licks' logic from the OFI strategy to avoid trading during high liquidation periods (> $250k in 10 minutes).
...
class ExtendedSdz5SecondNoLicks(BaseStrategy):
    name = "extended_sdz_5_second_no_licks"
    version = "0.1"
    ...
    def on_candle(self, candle: CandleData) -> Signal:
        ...
        if cascade_active and ma_ready:
            ...
            return Signal(
                ...
                tag=f"extended_sdz_5_second_no_licks_{'bull' if direction == 1 else 'bear'}",
            )
