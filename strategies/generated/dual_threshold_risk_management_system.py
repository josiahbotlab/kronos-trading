#!/usr/bin/env python3
"""
Dual-Threshold Risk Management System
=====================================
Auto-generated from: The $500,000,000 Trading Bot
Category: other
Confidence: 85%

Risk management overlay using two sets of stops: 'Regular' exits as maker (bid/ask) for normal stop losses, and 'Emergency' exits as taker (crossing spread) when losses exceed a higher threshold to prevent liquidation. Also includes trailing take-profit variant that activates after hitting profit target.
...
class DualThresholdRiskManagementSystem(BaseStrategy):
    name = "dual_threshold_risk_management_system"
    version = "0.1"
    ...
    def on_candle(self, candle: CandleData) -> Signal:
        ...
        if cascade_active:
            ...
            return Signal(
                ...
                tag=f"dual_threshold_risk_management_system_{'bull' if direction == 1 else 'bear'}",
            )
