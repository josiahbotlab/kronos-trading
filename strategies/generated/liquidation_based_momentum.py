#!/usr/bin/env python3
"""
Liquidation-Based Momentum
==========================
Auto-generated from: The $500,000,000 Trading Bot
Category: momentum
Confidence: 80%

Momentum strategy triggered by large liquidation events. When significant liquidations occur (> $100,000 to avoid noise), the bot trades in the direction of the momentum (e.g., long liquidations signal short entry, short liquidations signal long entry). Backtests showed 340% returns with thresholds between 100k-1M.
...
class LiquidationBasedMomentum(BaseStrategy):
    name = "liquidation_based_momentum"
    version = "0.1"
    ...
    def on_candle(self, candle: CandleData) -> Signal:
        ...
        if cascade_active:
            ...
            return Signal(
                ...
                tag=f"liquidation_based_momentum_{'bull' if direction == 1 else 'bear'}",
            )
