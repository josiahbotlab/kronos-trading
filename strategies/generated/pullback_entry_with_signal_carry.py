#!/usr/bin/env python3
"""
Pullback Entry with Signal Carry
================================
Auto-generated from: Claude Opus Found a Polymarket Edge No One Is Talking About
Category: momentum
Confidence: 80%

An entry timing optimization that waits for a 3-minute pullback after a liquidation signal before entering. If the pullback occurs too late in the current 5-minute window (e.g., last 30 seconds), the signal carries over to the next 5-minute market.
...
class PullbackEntryWithSignalCarry(BaseStrategy):
    name = "pullback_entry_with_signal_carry"
    version = "0.1"
    ...
    def on_candle(self, candle: CandleData) -> Signal:
        ...
        if cascade_active:
            ...
            return Signal(
                ...
                tag=f"pullback_entry_with_signal_carry_{'bull' if direction == 1 else 'bear'}",
            )
