#!/usr/bin/env python3
"""
Supply and Demand Zone Bot
==========================
Auto-generated from: Everything You Need To Start Making AI Trading Bots (As A Beginner)
Category: mean_reversion
Confidence: 75%

A mean-reversion strategy that identifies supply and demand zones to buy where institutional money enters (demand zones) and sell where they exit (supply zones). Uses trend confirmation from major cryptocurrencies to filter entries, with dynamic position sizing based on trend direction.
...
class SupplyAndDemandZoneBot(BaseStrategy):
    name = "supply_and_demand_zone_bot"
    version = "0.1"
    ...
    def default_params(self) -> dict:
        return {
            ...
            "max_history": 300,
            "max_hold_bars": 20,
            "position_sell_percentage_downtrend": 95,
            "position_sell_percentage_uptrend": 50,
            "rsi_period": 14,
            "slow_period": 30,
            "take_profit_pct": 5.0,
    ...
    def on_candle(self, candle: CandleData) -> Signal:
        ...
        # Entry condition
        if rsi_ready and (current_rsi > 70 or current_rsi < 30) and ma_ready:
            ...
            return Signal(
                ...
                tag=f"supply_and_demand_zone_bot_{'bull' if direction == 1 else 'bear'}",
            )
...
PARAM_RANGES = {
    "position_sell_percentage_uptrend": [
        25,
        50,
        100
    ],
    "position_sell_percentage_downtrend": [
        47,
        95,
        190
    ],
