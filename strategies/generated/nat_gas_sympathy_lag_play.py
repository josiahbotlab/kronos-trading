#!/usr/bin/env python3
"""
Nat Gas Sympathy Lag Play
=========================
Auto-generated from: Claude Chrome Built My WW3 Trading Bot
Category: momentum
Confidence: 85%

Long natural gas as a sympathy play to oil that hasn't moved yet. Oil rallied 40% (55→78) on geopolitical tensions while nat gas remains at lows ($2.93). Same energy complex drivers (Middle East tensions, supply chain) but UK nat gas already moving 70% while US nat gas lagging. Crowd is heavily short (63%) with no liquidation activity yet.
...
class NatGasSympathyLagPlay(BaseStrategy):
    name = "nat_gas_sympathy_lag_play"
    version = "0.1"
    ...
    def on_candle(self, candle: CandleData) -> Signal:
        ...
        if cascade_active and ma_ready:
            ...
            return Signal(
                ...
                tag=f"nat_gas_sympathy_lag_play_{'bull' if direction == 1 else 'bear'}",
            )
