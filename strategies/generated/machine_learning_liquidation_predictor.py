#!/usr/bin/env python3
"""
Machine Learning Liquidation Predictor
======================================
Auto-generated from: Trading Bot Course 2025 | Everything You Need To Know
Category: momentum
Confidence: 75%

Uses tick-level liquidation data to forecast short-term price direction via LSTM, CNN, or Gradient Boosting models. Features include liquidation counts, volumes, buy/sell ratios, and time since last spike aggregated into 5-minute windows.
...
class MachineLearningLiquidationPredictor(BaseStrategy):
    name = "machine_learning_liquidation_predictor"
    version = "0.1"
    ...
    def on_candle(self, candle: CandleData) -> Signal:
        ...
        if cascade_active:
            ...
            return Signal(
                ...
                tag=f"machine_learning_liquidation_predictor_{'bull' if direction == 1 else 'bear'}",
            )
