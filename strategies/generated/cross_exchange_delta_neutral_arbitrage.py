#!/usr/bin/env python3
"""
Cross-Exchange Delta Neutral Arbitrage (Habachi-Pacifica)
=========================================================
Auto-generated from: i built a crypto arbitrage bot with AI (+ give you all code)
Category: other
Confidence: 75%

A delta-neutral arbitrage strategy that takes opposite positions (long/short) across two perpetual exchanges (Habachi and Pacifica) to capture price discrepancies while maintaining market neutrality. The bot compares available capital across exchanges and sizes positions based on the exchange with smaller balance to manage risk.
...
class CrossExchangeDeltaNeutralArbitrage(BaseStrategy):
    name = "cross_exchange_delta_neutral_arbitrage"
    version = "0.1"
    ...
    def on_candle(self, candle: CandleData) -> Signal:
        ...
        if ma_ready:
            ...
            return Signal(
                ...
                tag=f"cross_exchange_delta_neutral_arbitrage_{'bull' if direction == 1 else 'bear'}",
            )
