#!/usr/bin/env python3
"""
Liquidation SMA Target
======================
Auto-generated from: I Found a Strategy That Makes Buy & Hold Look Like a Joke (14x Better)
Category: mean_reversion
Confidence: 75%

Enters long when large liquidations occur and holds until price rebounds to within a specific percentage of the 1-hour 40-period SMA, at which point it closes the position. Uses a maximum hold time as a hard exit.
...
class LiquidationSmaTarget(BaseStrategy):
    name = "liquidation_sma_target"
    version = "0.1"
    ...
    def on_candle(self, candle: CandleData) -> Signal:
        ...
        if cascade_active and ma_ready:
            ...
            return Signal(
                ...
                tag=f"liquidation_sma_target_{'bull' if direction == 1 else 'bear'}",
            )
