#!/usr/bin/env python3
"""
OBV Capitulation Divergence
===========================
Auto-generated from: Clawdbot For Trading is UNSTOPPABLE (71,057% ROI)
Category: reversal
Confidence: 70%

Uses On Balance Volume (OBV) combined with capitulation divergence to identify smart money vs weak hand positioning. Part of a 'smart money, weak hands' thesis.
...
class ObvCapitulationDivergence(BaseStrategy):
    name = "obv_capitulation_divergence"
    version = "0.1"
    ...
    def on_candle(self, candle: CandleData) -> Signal:
        ...
        if ma_ready:
            ...
            return Signal(
                ...
                tag=f"obv_capitulation_divergence_{'bull' if direction == 1 else 'bear'}",
            )
