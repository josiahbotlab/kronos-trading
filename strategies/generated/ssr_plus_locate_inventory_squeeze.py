#!/usr/bin/env python3
"""
SSR Plus Locate Inventory Squeeze
=================================
Auto-generated from: Claude Code + Public's API: Short Borrow Rates, Retail Sentiment & Edges Nobody's Trading
Category: momentum
Confidence: 70%

Use the preflight endpoint to monitor uptick rule status, short sale restriction (SSR) activation, and locate inventory availability. The combination of active SSR plus limited client locate inventory indicates short squeeze potential.
...
class SsrPlusLocateInventorySqueeze(BaseStrategy):
    name = "ssr_plus_locate_inventory_squeeze"
    version = "0.1"
    ...
    def on_candle(self, candle: CandleData) -> Signal:
        ...
        if cascade_active:
            ...
            return Signal(
                ...
                tag=f"ssr_plus_locate_inventory_squeeze_{'bull' if direction == 1 else 'bear'}",
            )
