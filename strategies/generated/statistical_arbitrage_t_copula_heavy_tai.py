#!/usr/bin/env python3
"""
Statistical Arbitrage - T-Copula Heavy Tail
===========================================
Auto-generated from: Jan 15 Live: This is Why You CAN NOT trade by hand in 2026 ($4.5M trade)
Category: mean_reversion
Confidence: 80%

Heavy-tail aware statistical arbitrage strategy using t-copula modeling specifically designed for volatile crypto assets to handle extreme price movements better than normal distribution models.
...
class StatisticalArbitrageTCopulaHeavyTai(BaseStrategy):
    name = "statistical_arbitrage_t_copula_heavy_tai"
    version = "0.1"
    ...
    def on_candle(self, candle: CandleData) -> Signal:
        ...
        if cascade_active:
            ...
            return Signal(
                ...
                tag=f"statistical_arbitrage_t_copula_heavy_tai_{'bull' if direction == 1 else 'bear'}",
            )
