...
Logistic regression model with isotonic calibration for probability accuracy and class weights to handle imbalanced data. Uses same OFI feature set as other models but focuses on interpretability and fast training. Implements EV-based trading gate to filter low-confidence predictions.
...
class CalibratedLogisticRegression(BaseStrategy):
    ...
    def on_candle(self, candle: CandleData) -> Signal:
        ...
        if cascade_active:
            ...
            return Signal(
                ...
                tag=f"calibrated_logistic_regression_{'bull' if direction == 1 else 'bear'}",
            )
