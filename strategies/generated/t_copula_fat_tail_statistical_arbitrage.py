#!/usr/bin/env python3
"""
T-Copula Fat Tail Statistical Arbitrage
=======================================
Auto-generated from: I Let 3x OpenAI Codex Build 4 Arbitrage Bots Live
Category: mean_reversion
Confidence: 80%

Extreme move version of two-leg statistical arbitrage with fat tail awareness. Designed for noisier, more violent pairs using T-copula to better model tail risk and extreme deviations from equilibrium.
...
class TCopulaFatTailStatisticalArbitrage(BaseStrategy):
    name = "t_copula_fat_tail_statistical_arbitrage"
    version = "0.1"
    ...
    def on_candle(self, candle: CandleData) -> Signal:
        ...
        if rsi_ready and (current_rsi > 70 or current_rsi < 30):
            ...
            return Signal(
                ...
                tag=f"t_copula_fat_tail_statistical_arbitrage_{'bull' if direction == 1 else 'bear'}",
            )
