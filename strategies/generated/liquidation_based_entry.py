#!/usr/bin/env python3
"""
Liquidation-Based Entry (Liquidity Hunting)
===========================================
Auto-generated from: Prop Firms Charge You to Fail. I'll Pay You to Trade.
Category: scalping
Confidence: 70%

Entering positions when other traders are near their liquidation levels on Hyperliquid, capitalizing on forced liquidations and stop cascades. The strategy involves monitoring the Hyperliquid data layer to identify when traders are within specific proximity to liquidation (e.g., 1.1%) and timing entries during these liquidity events.
...
class LiquidationBasedEntry(BaseStrategy):
    name = "liquidation_based_entry"
    version = "0.1"
    ...
    def on_candle(self, candle: CandleData) -> Signal:
        ...
        if cascade_active:
            ...
            return Signal(
                ...
                tag=f"liquidation_based_entry_{'bull' if direction == 1 else 'bear'}",
            )
