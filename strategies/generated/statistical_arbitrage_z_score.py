...
High-frequency statistical arbitrage bot using Z-score normalization with multi-timeframe Z-score confirmation, Bollinger Band width filters, and supply/demand zone analysis. Designed for high trade frequency (4000+ trades/month) with tight profit targets.
...
class StatisticalArbitrageZScore(BaseStrategy):
    name = "statistical_arbitrage_z_score"
    version = "0.1"
    ...
    def on_candle(self, candle: CandleData) -> Signal:
        ...
        # Entry condition
        if bb_ready and (candle.close > bb[0] or candle.close < bb[2]) and ma_ready:
            ...
            return Signal(
                ...
                tag=f"statistical_arbitrage_z_score_{'bull' if direction == 1 else 'bear'}",
            )
