#!/usr/bin/env python3
"""
Whale Position Replication
==========================
Auto-generated from: ngl gng quit trading manually after this one vid frfr
Category: momentum
Confidence: 70%

Tracking the top 5,000 Hyperliquid depositor wallets to view their open positions, leverage, unrealized P&L, and liquidation levels, then entering trades in the same direction as profitable whales or fading losing positions.
...
class WhalePositionReplication(BaseStrategy):
    name = "whale_position_replication"
    version = "0.1"
    ...
    def on_candle(self, candle: CandleData) -> Signal:
        ...
        if cascade_active:
            ...
            return Signal(
                ...
                tag=f"whale_position_replication_{'bull' if direction == 1 else 'bear'}",
            )
