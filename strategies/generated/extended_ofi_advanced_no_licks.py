#!/usr/bin/env python3
"""
Extended OFI Advanced No Licks (15M)
====================================
Auto-generated from: High Frequency Trading with OFI & Liquidations
Category: momentum
Confidence: 90%

Variant of the OFI strategy with extended hold times. Uses the same liquidation filter (no trade if >$250k liquidations in 10 minutes) but allows positions to remain open for up to 15 minutes instead of the standard 5 minutes.
...
class ExtendedOfiAdvancedNoLicks(BaseStrategy):
    name = "extended_ofi_advanced_no_licks"
    version = "0.1"
    ...
    def on_candle(self, candle: CandleData) -> Signal:
        ...
        if cascade_active and ma_ready:
            ...
            return Signal(
                ...
                tag=f"extended_ofi_advanced_no_licks_{'bull' if direction == 1 else 'bear'}",
            )
