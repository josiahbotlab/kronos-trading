#!/usr/bin/env python3
"""
Liquidation Momentum (Continuation)
===================================
Research ID: 397
Category: momentum
Confidence: 70%

A momentum strategy that shorts/sells when large liquidations occur, betting on trend continuation rather than reversal. Inverse of the contrarian approach, looking to 'sell the rip' during liquidation cascades.
...
class Research397LiquidationMomentum(BaseStrategy):
    name = "research_397_liquidation_momentum"
    version = "0.1"
    ...
    def on_candle(self, candle: CandleData) -> Signal:
        ...
        if cascade_active:
            ...
            tag = "research_397_liquidation_momentum_bull" if direction == 1 else "research_397_liquidation_momentum_bear"
            return Signal(
                direction=direction,
