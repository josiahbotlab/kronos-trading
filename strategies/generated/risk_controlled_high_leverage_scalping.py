#!/usr/bin/env python3
"""
Risk-Controlled High Leverage Scalping
======================================
Auto-generated from: Prop Firms Charge You to Fail. I'll Pay You to Trade.
Category: scalping
Confidence: 80%

Trading Bitcoin with up to 40x leverage using the Quant app as automated 'bumpers'—algorithmic risk controls designed to prevent account liquidation and extend trading lifespan. The strategy requires complete transparency via live streaming and uses position visibility data to inform entries while maintaining strict risk management.
...
class RiskControlledHighLeverageScalping(BaseStrategy):
    name = "risk_controlled_high_leverage_scalping"
    version = "0.1"
    ...
    def on_candle(self, candle: CandleData) -> Signal:
        ...
        if cascade_active:
            ...
            return Signal(
                ...
                tag=f"risk_controlled_high_leverage_scalping_{'bull' if direction == 1 else 'bear'}",
            )
