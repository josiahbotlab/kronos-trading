#!/usr/bin/env python3
"""
Whale Sweep Following with Quality Filter
=========================================
Auto-generated from: AI Agents For Polymarket (Free & Open Source)
Category: momentum
Confidence: 70%

Monitors large trades ('sweeps') on Polymarket and copies positions from high-performing wallets only. Filters out noise by clustering related sweeps and scoring wallet quality based on historical win rate, volume, and market diversity.
...
class WhaleSweepFollowingWithQualityFilte(BaseStrategy):
    name = "whale_sweep_following_with_quality_filte"
    version = "0.1"
    ...
    def on_candle(self, candle: CandleData) -> Signal:
        ...
        if rsi_ready:
            ...
            return Signal(
                ...
                tag=f"whale_sweep_following_with_quality_filte_{'bull' if direction == 1 else 'bear'}",
            )
