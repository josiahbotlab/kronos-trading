#!/usr/bin/env python3
"""
Cross-Exchange Liquidation Lead
===============================
Auto-generated from: Claude Opus Found a Polymarket Edge No One Is Talking About
Category: momentum
Confidence: 75%

A strategy that exploits the difference in liquidation thresholds between exchanges. Hyperliquid liquidates at 50% margin vs 100% on Binance/Bybit. When Hyperliquid shows liquidations, expect Binance and Bybit liquidations to follow, creating a predictable cascade.
...
class CrossExchangeLiquidationLead(BaseStrategy):
    name = "cross_exchange_liquidation_lead"
    version = "0.1"
    ...
    def on_candle(self, candle: CandleData) -> Signal:
        ...
        if cascade_active:
            ...
            return Signal(
                ...
                tag=f"cross_exchange_liquidation_lead_{'bull' if direction == 1 else 'bear'}",
            )
