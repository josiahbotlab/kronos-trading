...
A contrarian strategy designed to exploit exhaustion gaps that occur at the end of trends, indicating potential reversal points. Uses price and volume analysis to identify overbought or oversold conditions before entering.
...
class Research141ExhaustionGapStrategy(BaseStrategy):
    name = "research_141_exhaustion_gap_strategy"
    version = "0.1"
    ...
    def on_candle(self, candle: CandleData) -> Signal:
        ...
        if (current_rsi > self.get_param('rsi_ob') or current_rsi < self.get_param('rsi_os')) and vol_ratio >= self.get_param('vol_mult'):
            ...
            tag = "research_141_exhaustion_gap_strategy_bull" if direction == 1 else "research_141_exhaustion_gap_strategy_bear"
            return Signal(
                direction=direction,
