#!/usr/bin/env python3
"""
ADX Trend vs Chop Classification
================================
Auto-generated from: Jim Simons' Regime Secret Exposed
Category: other
Confidence: 95%

Uses Average Directional Index (ADX) to classify markets as trending or ranging/choppy. Deploy breakout strategies when ADX > 25 (trending) and mean reversion strategies when ADX < 20 (choppy). Uses dual periods (14 and 25) for confirmation.
...
class AdxTrendVsChopClassification(BaseStrategy):
    name = "adx_trend_vs_chop_classification"
    version = "0.1"
    ...
    def on_candle(self, candle: CandleData) -> Signal:
        ...
        if rsi_ready:
            ...
            return Signal(
                ...
                tag=f"adx_trend_vs_chop_classification_{'bull' if direction == 1 else 'bear'}",
            )
