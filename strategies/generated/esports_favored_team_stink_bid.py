#!/usr/bin/env python3
"""
eSports Favored Team Stink Bid
==============================
Auto-generated from: I Let 6 Claude Codes LOOSE on Polymarket eSports
Category: mean_reversion
Confidence: 80%

An automated strategy that places limit orders ('stink bids') on the favored team in live eSports prediction markets at a discount to current market price. The strategy targets the first half of the match duration only, aiming to catch whale dumps or panic selling into low bids, effectively buying the favorite at favorable odds.
...
class EsportsFavoredTeamStinkBid(BaseStrategy):
    name = "esports_favored_team_stink_bid"
    version = "0.1"
    ...
    def on_candle(self, candle: CandleData) -> Signal:
        ...
        if cascade_active:
            ...
            return Signal(
                ...
                tag=f"esports_favored_team_stink_bid_{'bull' if direction == 1 else 'bear'}",
            )
