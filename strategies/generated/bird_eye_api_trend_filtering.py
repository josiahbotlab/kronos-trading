#!/usr/bin/env python3
"""
Bird Eye API Trend Filtering
============================
Auto-generated from: Beginners Guide To Solana Trading Bots in 2025
Category: momentum
Confidence: 75%

A data-driven filtering approach using the Bird Eye API to rank tokens by momentum indicators. Sorts by 24h volume, price change percent, and market cap to identify trending micro-caps before they appear on trending lists.
...
class BirdEyeApiTrendFiltering(BaseStrategy):
    name = "bird_eye_api_trend_filtering"
    version = "0.1"
    ...
    def on_candle(self, candle: CandleData) -> Signal:
        ...
        if cascade_active:
            ...
            return Signal(
                ...
                tag=f"bird_eye_api_trend_filtering_{'bull' if direction == 1 else 'bear'}",
            )
