#!/usr/bin/env python3
"""
5-Second Supply and Demand Zone (SDZ)
=====================================
Auto-generated from: Claude Code Made High Frequency Trading Possible For Retail
Category: mean_reversion
Confidence: 80%

Mean reversion strategy constructing custom 5-second OHLCV bars from Binance websocket data to identify supply and demand zones over a 50-bar lookback. Enters long positions when price enters demand zones (average of lowest close and lowest low) and short positions when price enters supply zones (average of highest close and highest high).
...
class 5SecondSupplyAndDemandZone(BaseStrategy):
    name = "5_second_supply_and_demand_zone"
    version = "0.1"
    ...
    def on_candle(self, candle: CandleData) -> Signal:
        ...
        if rsi_ready and (current_rsi > 70 or current_rsi < 30) and ma_ready:
            ...
            return Signal(
                ...
                tag=f"5_second_supply_and_demand_zone_{'bull' if direction == 1 else 'bear'}",
            )
