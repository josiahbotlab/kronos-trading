#!/usr/bin/env python3
"""
Quick Buy with P&L Risk Management
==================================
Auto-generated from: i cracked the code to PREDICTION markets with CLAUDE code
Category: scalping
Confidence: 90%

Hybrid manual-automated strategy allowing manual entry of asset IDs for immediate execution while running automated risk management. Continuously monitors open positions every 30 seconds to enforce take-profit and stop-loss rules.
...
class QuickBuyWithPLRiskManagement(BaseStrategy):
    name = "quick_buy_with_p_l_risk_management"
    version = "0.1"
    ...
    def on_candle(self, candle: CandleData) -> Signal:
        ...
        if cascade_active:
            ...
            return Signal(
                ...
                tag=f"quick_buy_with_p_l_risk_management_{'bull' if direction == 1 else 'bear'}",
            )
