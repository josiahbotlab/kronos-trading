#!/usr/bin/env python3
"""
Consecutive Bars Reversal
=========================
Auto-generated from: The $500,000,000 Trading Bot
Category: reversal
Confidence: 70%

Mean reversion strategy that enters when price extends consecutively in one direction. Enters long after N consecutive down bars or short after N consecutive up bars, betting on statistical reversion.
...
class ConsecutiveBarsReversal(BaseStrategy):
    name = "consecutive_bars_reversal"
    version = "0.1"
    ...
    def on_candle(self, candle: CandleData) -> Signal:
        ...
        if rsi_ready and (current_rsi > 70 or current_rsi < 30):
            ...
            return Signal(
                ...
                tag=f"consecutive_bars_reversal_{'bull' if direction == 1 else 'bear'}",
            )
