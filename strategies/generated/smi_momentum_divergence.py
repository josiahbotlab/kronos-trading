#!/usr/bin/env python3
"""
SMI Momentum Divergence
=======================
Auto-generated from: OpenAI Trading Bots (Full Course)
Category: momentum
Confidence: 85%

Uses the Stochastic Momentum Index (SMI) to identify overbought/oversold conditions combined with divergence signals. Enters long when SMI hits -40 or below with bullish divergence, shorts when SMI hits +40 or above with bearish divergence.
...
class SmiMomentumDivergence(BaseStrategy):
    name = "smi_momentum_divergence"
    version = "0.1"
    ...
    def on_candle(self, candle: CandleData) -> Signal:
        ...
        if rsi_ready:
            ...
            return Signal(
                ...
                tag=f"smi_momentum_divergence_{'bull' if direction == 1 else 'bear'}",
            )
