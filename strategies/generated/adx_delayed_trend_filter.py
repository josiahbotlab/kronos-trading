#!/usr/bin/env python3
"""
ADX Delayed Trend Filter
========================
Auto-generated from: How To Actually Use AI To Automate Your Trading
Category: momentum
Confidence: 80%

Uses ADX indicator with calibrated universal parameters across sectors to identify trend strength above 20, with intentional delayed entry to avoid chasing momentum highs. Exits positions at end of day.
...
class AdxDelayedTrendFilter(BaseStrategy):
    name = "adx_delayed_trend_filter"
    version = "0.1"
    ...
    def on_candle(self, candle: CandleData) -> Signal:
        ...
        if cascade_active:
            ...
            return Signal(
                ...
                tag=f"adx_delayed_trend_filter_{'bull' if direction == 1 else 'bear'}",
            )
