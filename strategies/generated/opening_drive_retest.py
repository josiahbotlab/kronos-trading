#!/usr/bin/env python3
"""
Opening Drive Retest
====================
Auto-generated from: How I Turned This Book into GREAT Trading Bot Ideas
Category: breakout
Confidence: 75%

Wait for price to break through a significant resistance level (requiring two touches to mark the level valid), make an initial run, then retest the broken level. Enter long on successful retest of broken resistance as support (inverse for breakdowns).
...
class OpeningDriveRetest(BaseStrategy):
    name = "opening_drive_retest"
    version = "0.1"
    ...
    def on_candle(self, candle: CandleData) -> Signal:
        ...
        if cascade_active:
            ...
            return Signal(
                ...
                tag=f"opening_drive_retest_{'bull' if direction == 1 else 'bear'}",
            )
