#!/usr/bin/env python3
"""
Random Forest Liquidation Predictor
===================================
Auto-generated from: AI in Trading for Beginners Guide  - No More Paid Courses!
Category: other
Confidence: 85%

A baseline ensemble model using Random Forest algorithm to predict Bitcoin price moves from liquidation data. Uses flattened 60-minute look-back features instead of sequences for faster training and feature importance analysis.
...
class RandomForestLiquidationPredictor(BaseStrategy):
    name = "random_forest_liquidation_predictor"
    version = "0.1"
    ...
    def default_params(self) -> dict:
        return {
            "cooldown_bars": 5,
            "entry_strength": 0.8,
            "estimators_cloud": 500,
            "estimators_local": 100,
            "liq_percentile": 85,
            ...
            "max_history": 300,
            "max_hold_bars": 20,
            "min_samples_split_cloud": 2,
            "min_samples_split_local": 5,
            "take_profit_pct": 5.0,
    ...
    def on_candle(self, candle: CandleData) -> Signal:
        ...
        if cascade_active:
            ...
            return Signal(
                ...
                tag=f"random_forest_liquidation_predictor_{'bull' if direction == 1 else 'bear'}",
            )
...
PARAM_RANGES = {
    ...
    "min_samples_split_local": [
        2,
        5,
        10
    ],
    "min_samples_split_cloud": [
        1,
        2,
        4
    ],
