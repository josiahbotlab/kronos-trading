#!/usr/bin/env python3
"""
RSI Enhanced Bollinger Bands
============================
Auto-generated from: AI Agents For Finding Winning Trading Strategies
Category: other
Confidence: 70%

Combines RSI (Relative Strength Index) with Bollinger Bands to create enhanced signals, using RSI for confirmation of Bollinger Band signals.
...
class RsiEnhancedBollingerBands(BaseStrategy):
    name = "rsi_enhanced_bollinger_bands"
    version = "0.1"
    ...
    def on_candle(self, candle: CandleData) -> Signal:
        ...
        if rsi_ready and bb_ready and (candle.close > bb[0] or candle.close < bb[2]):
            ...
            return Signal(
                ...
                tag=f"rsi_enhanced_bollinger_bands_{'bull' if direction == 1 else 'bear'}",
            )
