#!/usr/bin/env python3
"""
NBA Stink Bid (Lowball Limit Order) Strategy
============================================
Auto-generated from: Claude Code Built Me a Polymarket Bot That Trades NBA Games Live
Category: mean_reversion
Confidence: 90%

Automated system that places limit orders 30% below current market price (or at a $0.30 discount) on the favorite side of NBA games exclusively during the first half (Q1-Q2). Orders are cancelled at the start of the second half (Q3). If filled due to panic selling when the favorite falls behind early, positions are held to expiration to collect the $1 per share binary payout when the favorite typically recovers and wins.
...
class NbaStinkBidStrategy(BaseStrategy):
    name = "nba_stink_bid_strategy"
    version = "0.1"
    ...
    def on_candle(self, candle: CandleData) -> Signal:
        ...
        if cascade_active:
            ...
            return Signal(
                ...
                tag=f"nba_stink_bid_strategy_{'bull' if direction == 1 else 'bear'}",
            )
