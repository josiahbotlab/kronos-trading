#!/usr/bin/env python3
"""
Liquidation Data Direction Prediction (Random Forest)
=====================================================
Auto-generated from: Use AI in Trading (The Easy Way)
Category: momentum
Confidence: 90%

A machine learning strategy using Random Forest classification on liquidation data features to predict binary price direction (up/down) rather than exact price magnitude. Based on the premise that liquidation cascades predict directional momentum but not precise price targets. When short liquidations dominate, price likely goes up; when long liquidations dominate, price likely goes down.
...
class LiquidationDataDirectionPrediction(BaseStrategy):
    name = "liquidation_data_direction_prediction"
    version = "0.1"
    ...
    def default_params(self) -> dict:
        return {
            ...
            "max_history": 300,
            "max_hold_bars": 20,
            "probability_threshold_for_entry": 0.35,
    ...
    def on_candle(self, candle: CandleData) -> Signal:
        ...
        if cascade_active:
            ...
            return Signal(
                ...
                tag=f"liquidation_data_direction_prediction_{'bull' if direction == 1 else 'bear'}",
            )
...
PARAM_RANGES = {
    ...
    "probability_threshold_for_entry": [
        0.175,
        0.35,
        0.5249999999999999,
        0.7
