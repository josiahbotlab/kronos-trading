...
Monitors for sudden volume spikes indicating breaking news or viral events. Enters positions when volume increases 300% or more to capture momentum before mainstream awareness.
...
class VolumeSpikeScalper(BaseStrategy):
    name = "volume_spike_scalper"
    version = "0.1"
    ...
    def on_candle(self, candle: CandleData) -> Signal:
        ...
        if cascade_active:
            ...
            return Signal(
                ...
                tag=f"volume_spike_scalper_{'bull' if direction == 1 else 'bear'}",
            )
