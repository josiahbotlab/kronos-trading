...
Strategy utilizing price action by identifying supply zones (close to top of wick) and demand zones (close to bottom of wick), placing buy orders within these ranges based on recent candlestick wicks.
...
class SupplyAndDemandWickRange(BaseStrategy):
    name = "supply_and_demand_wick_range"
    version = "0.1"
    ...
    def on_candle(self, candle: CandleData) -> Signal:
        ...
        if ma_ready:
            ...
            return Signal(
                ...
                tag=f"supply_and_demand_wick_range_{'bull' if direction == 1 else 'bear'}",
            )
