...
A momentum-based trading strategy identified during initial backtesting. Specific entry/exit rules not detailed but showed strong risk-adjusted returns.
...
class Research22MdMomentum(BaseStrategy):
    name = "research_22_md_momentum"
    version = "0.1"
    ...
    def on_candle(self, candle: CandleData) -> Signal:
        ...
        if True:
            ...
            tag = "research_22_md_momentum_bull" if direction == 1 else "research_22_md_momentum_bear"
            return Signal(
                direction=direction,
