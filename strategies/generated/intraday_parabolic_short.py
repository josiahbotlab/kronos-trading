#!/usr/bin/env python3
"""
Intraday Parabolic Short (Mean Reversion)
=========================================
Auto-generated from: No Bullsh*t Guide to Making Trading Bots (Full Stack Revealed)
Category: mean_reversion
Confidence: 90%

A short-only mean reversion strategy targeting intraday parabolic moves to the upside. It enters short positions when price breaks above a rolling mean plus standard deviations (identifying statistically overextended moves), then uses fixed percentage take-profit and stop-loss exits. The strategy aims to capture reversals after extreme upward momentum.
...
class IntradayParabolicShort(BaseStrategy):
    name = "intraday_parabolic_short"
    version = "0.1"
    ...
    def on_candle(self, candle: CandleData) -> Signal:
        ...
        if rsi_ready and (current_rsi > 70 or current_rsi < 30):
            ...
            return Signal(
                ...
                tag=f"intraday_parabolic_short_{'bull' if direction == 1 else 'bear'}",
            )
