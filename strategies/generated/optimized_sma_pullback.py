#!/usr/bin/env python3
"""
Optimized SMA Pullback
======================
Auto-generated from: How to Backtest ANY Trading Strategy with Backtesting.py (TRADERS CHEAT CODE)
Category: momentum
Confidence: 70%

Variation of the SMA pullback strategy that optimizes the moving average period (N1) to maximize final equity. Uses previous day's low as stop loss and appears to use a 2.5x risk multiplier for take profit targets.
...
class OptimizedSmaPullback(BaseStrategy):
    name = "optimized_sma_pullback"
    version = "0.1"
    ...
    def on_candle(self, candle: CandleData) -> Signal:
        ...
        if ma_ready:
            ...
            return Signal(
                ...
                tag=f"optimized_sma_pullback_{'bull' if direction == 1 else 'bear'}",
            )
