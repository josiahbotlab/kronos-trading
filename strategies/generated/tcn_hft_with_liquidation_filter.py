#!/usr/bin/env python3
"""
TCN HFT with Liquidation Filter
===============================
Auto-generated from: i built an HFT trading bot from home with ai
Category: scalping
Confidence: 85%

Variant of the TCN scalping strategy that incorporates a liquidation filter to avoid trading during high liquidation events. Uses identical entry/exit parameters and TCN model (73.3% AU) but monitors liquidation data via Binance websocket to disable trading when liquidations exceed threshold levels.
...
class TcnHftWithLiquidationFilter(BaseStrategy):
    name = "tcn_hft_with_liquidation_filter"
    version = "0.1"
    ...
    def on_candle(self, candle: CandleData) -> Signal:
        ...
        if cascade_active:
            ...
            return Signal(
                ...
                tag=f"tcn_hft_with_liquidation_filter_{'bull' if direction == 1 else 'bear'}",
            )
