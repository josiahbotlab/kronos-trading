#!/usr/bin/env python3
"""
Multi-Exchange Lagger Detection (Lead-Lag)
==========================================
Auto-generated from: this bot arbitrages 7 exchanges (they wont believe it though)
Category: momentum
Confidence: 90%

Monitors 7 perpetual exchanges via WebSocket to detect price leadership patterns in real-time. When liquid 'leader' exchanges make significant percentage moves, the bot enters market orders on 'laggard' exchanges that haven't moved yet, betting they will follow the price action. Uses a 15-bar range filter to avoid buying at range tops and selling at bottoms.
...
class MultiExchangeLaggerDetection(BaseStrategy):
    name = "multi_exchange_lagger_detection"
    version = "0.1"
    ...
    def on_candle(self, candle: CandleData) -> Signal:
        ...
        if cascade_active:
            ...
            return Signal(
                ...
                tag=f"multi_exchange_lagger_detection_{'bull' if direction == 1 else 'bear'}",
            )
