#!/usr/bin/env python3
"""
Liquidation ADX Trend Filter
============================
Auto-generated from: $1.7 Billion Liquidated So I'm Building A Liquidation Bot
Category: momentum
Confidence: 70%

Combines liquidation spike detection with ADX (Average Directional Index) trend strength indicator to filter entries, requiring confirmation from both liquidation events and trend strength.
...
class LiquidationAdxTrendFilter(BaseStrategy):
    name = "liquidation_adx_trend_filter"
    version = "0.1"
    ...
    def on_candle(self, candle: CandleData) -> Signal:
        ...
        if cascade_active:
            ...
            return Signal(
                ...
                tag=f"liquidation_adx_trend_filter_{'bull' if direction == 1 else 'bear'}",
            )
