#!/usr/bin/env python3
"""
Liquidation Momentum Arbitrage (Polymarket-Hyperliquid)
=======================================================
Auto-generated from: This Arbitrage Bot Finds Free Money 24/7 (Polymarket to Hyperliquid)
Category: momentum
Confidence: 75%

A statistical arbitrage strategy that trades momentum following liquidation cascades on Polymarket's 5-minute binary markets while partially hedging on Hyperliquid. When large liquidations occur in one direction on futures markets (e.g., $25,000+ in short liquidations), the bot assumes continued price momentum and takes a directional position on Polymarket (long/up for short liquidations, short/down for long liquidations), simultaneously taking a smaller opposite position on Hyperliquid as an asymmetric hedge.
...
class LiquidationMomentumArbitrage(BaseStrategy):
    name = "liquidation_momentum_arbitrage"
    version = "0.1"
    ...
    def on_candle(self, candle: CandleData) -> Signal:
        ...
        if cascade_active and ma_ready:
            ...
            return Signal(
                ...
                tag=f"liquidation_momentum_arbitrage_{'bull' if direction == 1 else 'bear'}",
            )
