#!/usr/bin/env python3
"""
Polymarket 5-Minute Liquidation Scalping
========================================
Auto-generated from: Claude Code 6x Made a Wild Polymarket Trading Bot | Behind the Scenes
Category: scalping
Confidence: 85%

A high-frequency scalping strategy for Polymarket's 5-minute binary prediction markets that uses liquidation proximity data and Cumulative Volume Delta (CVD) to predict short-term momentum. The strategy enters positions at a discount using limit orders and holds for exactly one 5-minute candle duration.
...
class Polymarket5MinuteLiquidationScalping(BaseStrategy):
    name = "polymarket_5_minute_liquidation_scalping"
    version = "0.1"
    ...
    def on_candle(self, candle: CandleData) -> Signal:
        ...
        if cascade_active:
            ...
            return Signal(
                ...
                tag=f"polymarket_5_minute_liquidation_scalping_{'bull' if direction == 1 else 'bear'}",
            )
