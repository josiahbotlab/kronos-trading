#!/usr/bin/env python3
"""
Liquidation Spike Exit Strategy
===============================
Auto-generated from: ai agents that actually find profitable trading strategies
Category: other
Confidence: 70%

Monitor market-wide liquidation data and execute a full market exit (close all positions) when liquidation volumes uptick too rapidly or spike, indicating high-risk market conditions or potential black swan events.
...
class LiquidationSpikeExitStrategy(BaseStrategy):
    name = "liquidation_spike_exit_strategy"
    version = "0.1"
    ...
    def on_candle(self, candle: CandleData) -> Signal:
        ...
        if cascade_active:
            ...
            return Signal(
                ...
                tag=f"liquidation_spike_exit_strategy_{'bull' if direction == 1 else 'bear'}",
            )
