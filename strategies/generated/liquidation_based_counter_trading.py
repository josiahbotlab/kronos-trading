#!/usr/bin/env python3
"""
Liquidation-Based Counter-Trading (Open at Licks)
=================================================
Auto-generated from: Quant App Full Step By Step Training
Category: reversal
Confidence: 90%

Instead of predicting price direction, entries are triggered by forced liquidations of other traders. The strategy involves scheduling long entries when large short positions get liquidated (and vice versa), effectively buying the 'blood' from forced sellers. Exits can be triggered by opposing liquidation events or specific liquidation price levels of tracked wallets.
...
class LiquidationBasedCounterTrading(BaseStrategy):
    name = "liquidation_based_counter_trading"
    version = "0.1"
    ...
    def on_candle(self, candle: CandleData) -> Signal:
        ...
        if cascade_active:
            ...
            return Signal(
                ...
                tag=f"liquidation_based_counter_trading_{'bull' if direction == 1 else 'bear'}",
            )
