#!/usr/bin/env python3
"""
Time-Boxed Risk-Limited Scalping
================================
Auto-generated from: Quant App Explained: Risk & Liquidation Trading App
Category: scalping
Confidence: 90%

High-leverage scalping framework constrained by strict time windows and risk guards. Trading is restricted to specific hours (e.g., 8am-4pm) to prevent overnight/weekend emotional trading, combined with hard stops on daily drawdown and margin utilization.
...
class TimeBoxedRiskLimitedScalping(BaseStrategy):
    name = "time_boxed_risk_limited_scalping"
    version = "0.1"
    ...
    def on_candle(self, candle: CandleData) -> Signal:
        ...
        if cascade_active:
            ...
            return Signal(
                ...
                tag=f"time_boxed_risk_limited_scalping_{'bull' if direction == 1 else 'bear'}",
            )
