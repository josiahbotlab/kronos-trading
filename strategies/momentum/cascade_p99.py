...
class CascadeP99(BaseStrategy):
    ...
    def default_params(self) -> dict:
        return {
            # P99 detection
            "percentile": 85,                # only trade top 1% events
            "lookback_bars": 500,            # bars to calculate percentile over
            "min_history": 60,              # need at least this many bars before trading
            "liq_ratio_threshold": 0.55,      # 60%+ one-sided to determine direction
