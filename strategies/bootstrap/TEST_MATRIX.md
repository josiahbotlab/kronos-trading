...
## ORB  (⭐ Stage-2 VALIDATED: **15m + trail-after-3R** 2026-07-02 · reproducible PF 4.46 / net$ 23489 / n=672 / WR 52.2% / avgR +2.26 (committed backtest_orb_15m_trail_oos.py; was PF 6.04/WR 69% from uncommitted orb_oos.py, superseded 2026-07-03) · vs 15m-4R PF 3.61/$8653 · vs 1m PF 1.32/$2459.  NOTE: other axis rows were tested at the 1m/4R baseline — re-sweep at 15m+trail pending.)
...
|8|Take-profit|fixedR/ATR/tiered/runner/**trail**|**pass**|**trail-after-3R**|4.46|23489|✓|**Stage-2 PASS all gates**: drop-top-5 holds $10666 (still > 4R-full $8653), bootstrap 100%>$8653, WF 12/13, worst-regime PF 2.78, 1.5pt slip 5.33. Realistic 1m-walk trail. +37% net vs 4R-fixed. [SUPERSEDED 2026-07-03: headline PF/net & the drop-top-5/bootstrap sub-figures here were from the uncommitted orb_oos.py run (PF 6.04/WR 69%); committed backtest = PF 4.46/WR 52.2%/avgR +2.26/n=672] Also swept: TP 2/3/5/6R (4-5R best fixed), ATR stops = risk-inflation (PF~1.6, maxDD 10-17× — reject), tiered = less net|
...
- **ORB = 15m + trail-after-3R (VALIDATED 2026-07-02).** 1m→15m tripled the edge (PF 1.32→3.61); trail-after-3R lifted it further to reproducible PF 4.46 / net $23489 / WR 52.2% (committed backtest; was PF 6.04/WR 69% from uncommitted orb_oos.py — superseded 2026-07-03). **KZ-free ORB-15m-trail2 + Don3 = 58.58% any-of-5** — best lineup found (vs 47.70% with 15m-4R, 30.75% with ORB-1m). Correct $12 Don slip.
- **ORB-15m-trail OOS ROBUSTNESS (2026-07-03):** holds ALL 5 years **2022-2026** — PF **4.37 / 3.81 / 4.63 / 4.76 / 5.14** (2026 partial), positive net every year, WR 50-56% (full-sample 52.2%, avgR +2.26, n=672). **2022-2023 = genuine OOS** (built only on 2024-2026); **2022 bear holds (PF 4.37, +$5,223)**. _SUPERSEDED: 6.04/69% from uncommitted orb_oos.py run, not reproducible; corrected to committed backtest_orb_15m_trail_oos.py, 2026-07-03._ **Paper's 2024-only-regime warning REFUTED** for the 15m-trail variant. OOS data `data/nq_1m_2022_2023_front.parquet` (707,510 bars, continuous front-month, saved uncommitted).
...
- **ORB-15m-trail PYRAMID (add 1 unit at 3R) = Stage-2 FAIL (2026-07-03).** Passed WF majority (26/37 windows) and drop-top-5 (pyr $21,733 > base $19,267); blowup-safe (add fires only on +3R winners, its stop ~+2R while base already locked ≥+2R → the add NEVER opens a loser; MLL-safe at 1/2/3 MNQ, maxDD $116/$231/$347 vs −$2,000). **FAILED worst-regime gate:** in the worst 20d and 60d stretches the pyramid nets LESS (−$18, −$31) while drawing down MORE (+$18, +$13) — the add is a coin-flip past 3R and bleeds in chop; risk-adjusted wash, no edge added. **DO-NOT-RETEST.**
- **NQ GAP-CONTINUATION (2R fixed, combined long+short, gap ≥0.5×daily ATR, trigger by 10:30, flat 11:30) = Stage-2 FAIL (2026-07-03).** Decorrelated from fleet (−0.05/−0.02 vs ORB-15m-trail/Donchian) with a tempting **+16.21pp any-of-5 fleet-add** — BUT **FAILED drop-top-5** (PF 1.25→1.06, 5 trades = 74% of profit), **directional split** (long = coin-flip forward 12/24 windows; short decays to 0.98 OOS — each side only works in its own regime and fails forward), and **2026 decaying** (−$1,384 and −$440 forward windows). Carried by outliers, not a durable edge; the fleet-add lift is the combine rewarding a decorrelated variance series, not a real edge. **DO-NOT-RETEST.**
...
_Last updated: 2026-07-03 (NQ seasonality = NO edge, nothing clears |t|>3; influencer batch ALL FAIL JJ/ALN/Kane [Kane PF-3.40 = approximation artifact, faithful = 0.68]; regime classifier CLEAN but NO edge; ORB-15m-trail OOS-ROBUST 2022-2026 — figures CORRECTED 2026-07-03 to committed PF 4.46/WR 52.2%/avgR +2.26/n=672, was 6.04/69% from uncommitted orb_oos.py). Deployable set unchanged: ORB-15m-trail + Don-long, KZ-free fleet 58.58% (pass-rate pending honest-pool rebuild)._
